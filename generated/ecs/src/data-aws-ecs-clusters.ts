...
export interface TfDataClustersConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecs_clusters#region TfDataClusters#region}
  */
...
export class TfDataClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing TfDataClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecs_clusters#import import section} in the documentation of this resource for the id to use
