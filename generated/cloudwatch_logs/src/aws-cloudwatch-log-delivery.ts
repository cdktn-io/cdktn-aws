...
export interface AwsDeliveryConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly s3DeliveryConfiguration?: AwsDelivery.S3DeliveryConfigurationProperty[] | cdktn.IResolvable;
  /**
...
*/
export class AwsDelivery extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsDelivery resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsDelivery to import
  * @param importFromId The id of the existing AwsDelivery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudwatch_log_delivery#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDelivery to import is found
  */
  ...
  * @param options AwsDeliveryConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDeliveryConfig) {
    super(scope, id, {
  ...
  private _s3DeliveryConfiguration = new AwsDelivery.S3DeliveryConfigurationPropertyList(this, "s3_delivery_configuration", false);
  public get s3DeliveryConfiguration() {
    return this._s3DeliveryConfiguration;
  }
  public putS3DeliveryConfiguration(value: AwsDelivery.S3DeliveryConfigurationProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      s3_delivery_configuration: cdktn.listMapper(awsDeliveryS3DeliveryConfigurationPropertyToTerraform, false)(this._s3DeliveryConfiguration.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      s3_delivery_configuration: {
        value: cdktn.listMapperHcl(awsDeliveryS3DeliveryConfigurationPropertyToHclTerraform, false)(this._s3DeliveryConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsDelivery.S3DeliveryConfigurationPropertyList",
      },
      tags: {
...
export function awsDeliveryS3DeliveryConfigurationPropertyToTerraform(struct?: AwsDelivery.S3DeliveryConfigurationProperty | cdktn.IResolvable): any {
...
export function awsDeliveryS3DeliveryConfigurationPropertyToHclTerraform(struct?: AwsDelivery.S3DeliveryConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
