...
export interface AwsCloudwatchLogGroupConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsCloudwatchLogGroup extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsCloudwatchLogGroup resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsCloudwatchLogGroup to import
  * @param importFromId The id of the existing AwsCloudwatchLogGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudwatch_log_group#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCloudwatchLogGroup to import is found
  */
  ...
  * @param options AwsCloudwatchLogGroupConfig = {}
  */
  public constructor(scope: Construct, id: string, config: AwsCloudwatchLogGroupConfig = {}) {
    super(scope, id, {
