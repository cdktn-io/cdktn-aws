...
*/
export class AwsCloudwatchLogSubscriptionFilter extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsCloudwatchLogSubscriptionFilterConfig) {
    super(scope, id, {
