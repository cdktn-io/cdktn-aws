...
export interface TfSubscriptionFilterConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfSubscriptionFilter extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfSubscriptionFilter resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfSubscriptionFilter to import
  * @param importFromId The id of the existing TfSubscriptionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudwatch_log_subscription_filter#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfSubscriptionFilter to import is found
  */
  ...
  * @param options TfSubscriptionFilterConfig
  */
  public constructor(scope: Construct, id: string, config: TfSubscriptionFilterConfig) {
    super(scope, id, {
