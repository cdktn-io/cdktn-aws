...
export interface TfVocabularyFilterConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfVocabularyFilter extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfVocabularyFilter resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfVocabularyFilter to import
  * @param importFromId The id of the existing TfVocabularyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/transcribe_vocabulary_filter#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfVocabularyFilter to import is found
  */
  ...
  * @param options TfVocabularyFilterConfig
  */
  public constructor(scope: Construct, id: string, config: TfVocabularyFilterConfig) {
    super(scope, id, {
