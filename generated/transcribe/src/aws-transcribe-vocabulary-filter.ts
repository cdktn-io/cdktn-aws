...
*/
export class AwsTranscribeVocabularyFilter extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsTranscribeVocabularyFilterConfig) {
    super(scope, id, {
