...
export interface AwsApplicationVersionConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsApplicationVersion extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsApplicationVersion resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsApplicationVersion to import
  * @param importFromId The id of the existing AwsApplicationVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/elastic_beanstalk_application_version#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsApplicationVersion to import is found
  */
  ...
  * @param options AwsApplicationVersionConfig
  */
  public constructor(scope: Construct, id: string, config: AwsApplicationVersionConfig) {
    super(scope, id, {
