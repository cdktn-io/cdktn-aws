...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/elastic_beanstalk_application
...
export class AwsApplication extends cdktn.TerraformResource {
  ...
  */
  ...
  private _appversionLifecycle = new AwsApplication.AppversionLifecyclePropertyOutputReference(this, "appversion_lifecycle");
  public get appversionLifecycle() {
    return this._appversionLifecycle;
  }
  public putAppversionLifecycle(value: AwsApplication.AppversionLifecycleProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      appversion_lifecycle: awsApplicationAppversionLifecyclePropertyToTerraform(this._appversionLifecycle.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      appversion_lifecycle: {
        value: awsApplicationAppversionLifecyclePropertyToHclTerraform(this._appversionLifecycle.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsApplication.AppversionLifecyclePropertyList",
      },
    };
...
export function awsApplicationAppversionLifecyclePropertyToTerraform(struct?: AwsApplication.AppversionLifecyclePropertyOutputReference | AwsApplication.AppversionLifecycleProperty): any {
...
export function awsApplicationAppversionLifecyclePropertyToHclTerraform(struct?: AwsApplication.AppversionLifecyclePropertyOutputReference | AwsApplication.AppversionLifecycleProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
