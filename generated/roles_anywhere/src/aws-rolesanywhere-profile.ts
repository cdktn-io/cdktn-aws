...
export class AwsProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rolesanywhere_profile#import import section} in the documentation of this resource for the id to use
