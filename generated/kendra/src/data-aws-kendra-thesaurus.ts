...
*/
export class DataAwsKendraThesaurus extends cdktn.TerraformDataSource {
  ...
  */
  ...
  private _sourceS3Path = new DataAwsKendraThesaurus.SourceS3PathPropertyList(this, "source_s3_path", false);
...
export function dataAwsKendraThesaurusSourceS3PathPropertyToTerraform(struct?: DataAwsKendraThesaurus.SourceS3PathProperty): any {
...
export function dataAwsKendraThesaurusSourceS3PathPropertyToHclTerraform(struct?: DataAwsKendraThesaurus.SourceS3PathProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsKendraThesaurus {
