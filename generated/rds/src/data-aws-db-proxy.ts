...
*/
export class DataTfDbProxy extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataTfDbProxyConfig) {
    super(scope, id, {
  ...
  private _auth = new DataTfDbProxy.AuthPropertyList(this, "auth", true);
  public get auth() {
    return this._auth;
  }
...
export function dataTfDbProxyAuthPropertyToTerraform(struct?: DataTfDbProxy.AuthProperty): any {
...
export function dataTfDbProxyAuthPropertyToHclTerraform(struct?: DataTfDbProxy.AuthProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataTfDbProxy {
