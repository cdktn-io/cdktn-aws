...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rds_cluster_snapshot_copy
...
*/
export class AwsRdsClusterSnapshotCopy extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsRdsClusterSnapshotCopyConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsRdsClusterSnapshotCopy.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsRdsClusterSnapshotCopy.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsRdsClusterSnapshotCopyTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsRdsClusterSnapshotCopyTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsRdsClusterSnapshotCopy.TimeoutsProperty",
      },
    };
...
export function awsRdsClusterSnapshotCopyTimeoutsPropertyToTerraform(struct?: AwsRdsClusterSnapshotCopy.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsRdsClusterSnapshotCopyTimeoutsPropertyToHclTerraform(struct?: AwsRdsClusterSnapshotCopy.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsRdsClusterSnapshotCopy {
