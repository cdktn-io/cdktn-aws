...
export interface DataAwsRdsClusterConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsRdsCluster extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsRdsCluster resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsRdsCluster to import
  * @param importFromId The id of the existing DataAwsRdsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _masterUserSecret = new DataAwsRdsCluster.MasterUserSecretPropertyList(this, "master_user_secret", false);
...
export function dataAwsRdsClusterMasterUserSecretPropertyToTerraform(struct?: DataAwsRdsCluster.MasterUserSecretProperty): any {
...
export function dataAwsRdsClusterMasterUserSecretPropertyToHclTerraform(struct?: DataAwsRdsCluster.MasterUserSecretProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsRdsCluster {
