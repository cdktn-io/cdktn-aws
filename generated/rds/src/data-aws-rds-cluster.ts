...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster
...
export interface DataAwsClusterConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster#cluster_identifier DataAwsCluster#cluster_identifier}
  */
  readonly clusterIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster#id DataAwsCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster#region DataAwsCluster#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster#tags DataAwsCluster#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster aws_rds_cluster}
*/
export class DataAwsCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_cluster aws_rds_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _masterUserSecret = new DataAwsCluster.MasterUserSecretPropertyList(this, "master_user_secret", false);
...
export function dataAwsClusterMasterUserSecretPropertyToTerraform(struct?: DataAwsCluster.MasterUserSecretProperty): any {
...
export function dataAwsClusterMasterUserSecretPropertyToHclTerraform(struct?: DataAwsCluster.MasterUserSecretProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
