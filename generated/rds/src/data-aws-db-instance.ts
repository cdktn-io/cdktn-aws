...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/db_instance
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface TfDataDbInstanceConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/db_instance#db_instance_identifier TfDataDbInstance#db_instance_identifier}
  */
  readonly dbInstanceIdentifier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/db_instance#id TfDataDbInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/db_instance#region TfDataDbInstance#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/db_instance#tags TfDataDbInstance#tags}
  */
...
*/
export class TfDataDbInstance extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataDbInstance resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataDbInstance to import
  * @param importFromId The id of the existing TfDataDbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/db_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataDbInstance to import is found
  */
  ...
  * @param options TfDataDbInstanceConfig = {}
  */
  public constructor(scope: Construct, id: string, config: TfDataDbInstanceConfig = {}) {
    super(scope, id, {
  ...
  private _masterUserSecret = new TfDataDbInstance.MasterUserSecretPropertyList(this, "master_user_secret", false);
...
export function tfDataDbInstanceMasterUserSecretPropertyToTerraform(struct?: TfDataDbInstance.MasterUserSecretProperty): any {
...
export function tfDataDbInstanceMasterUserSecretPropertyToHclTerraform(struct?: TfDataDbInstance.MasterUserSecretProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfDataDbInstance {
