...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/db_proxy_default_target_group
...
export class ConnectionPoolConfigPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ConnectionPoolConfigProperty | undefined {
  ...
  public set internalValue(value: ConnectionPoolConfigProperty | undefined) {
    if (value === undefined) {
