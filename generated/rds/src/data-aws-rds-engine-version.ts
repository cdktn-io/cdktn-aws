...
export interface DataAwsRdsEngineVersionConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly filter?: DataAwsRdsEngineVersion.FilterProperty[] | cdktn.IResolvable;
}
...
export class DataAwsRdsEngineVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRdsEngineVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_engine_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _filter = new DataAwsRdsEngineVersion.FilterPropertyList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataAwsRdsEngineVersion.FilterProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktn.listMapper(dataAwsRdsEngineVersionFilterPropertyToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktn.listMapperHcl(dataAwsRdsEngineVersionFilterPropertyToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataAwsRdsEngineVersion.FilterPropertyList",
      },
    };
...
export function dataAwsRdsEngineVersionFilterPropertyToTerraform(struct?: DataAwsRdsEngineVersion.FilterProperty | cdktn.IResolvable): any {
...
export function dataAwsRdsEngineVersionFilterPropertyToHclTerraform(struct?: DataAwsRdsEngineVersion.FilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsRdsEngineVersion {
