...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/db_event_subscription
...
export class AwsDbEventSubscription extends cdktn.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/db_event_subscription aws_db_event_subscription} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sns_topic: cdktn.stringToTerraform(this._snsTopic),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sns_topic: {
        value: cdktn.stringToHclTerraform(this._snsTopic),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
