...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/db_option_group
...
export class OptionSettingsPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OptionSettingsProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: OptionSettingsProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class OptionSettingsPropertyList extends cdktn.ComplexList {
  public internalValue? : OptionSettingsProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): OptionSettingsPropertyOutputReference {
    return new OptionSettingsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class OptionPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): OptionProperty | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: OptionProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _optionSettings = new OptionSettingsPropertyList(this, "option_settings", true);
  public get optionSettings() {
    return this._optionSettings;
  }
  public putOptionSettings(value: OptionSettingsProperty[] | cdktn.IResolvable) {
...
export class OptionPropertyList extends cdktn.ComplexList {
  public internalValue? : OptionProperty[] | cdktn.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): OptionPropertyOutputReference {
    return new OptionPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
