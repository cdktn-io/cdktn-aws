...
export interface AwsDbProxyTargetConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsDbProxyTarget extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsDbProxyTarget resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsDbProxyTarget to import
  * @param importFromId The id of the existing AwsDbProxyTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/db_proxy_target#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDbProxyTarget to import is found
  */
  ...
  * @param options AwsDbProxyTargetConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDbProxyTargetConfig) {
    super(scope, id, {
