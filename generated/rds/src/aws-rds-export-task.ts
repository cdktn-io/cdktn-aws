...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rds_export_task
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsExportTaskConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsExportTask.TimeoutsProperty;
}
...
*/
export class AwsExportTask extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsExportTask resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsExportTask to import
  * @param importFromId The id of the existing AwsExportTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rds_export_task#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsExportTask to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rds_export_task aws_rds_export_task} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AwsExportTaskConfig
  */
  public constructor(scope: Construct, id: string, config: AwsExportTaskConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsExportTask.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsExportTask.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      export_only: cdktn.listMapper(cdktn.stringToTerraform, false)(this._exportOnly),
      export_task_identifier: cdktn.stringToTerraform(this._exportTaskIdentifier),
      ...
      timeouts: awsExportTaskTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      export_only: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._exportOnly),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      export_task_identifier: {
        value: cdktn.stringToHclTerraform(this._exportTaskIdentifier),
        isBlock: false,
        type: "simple",
      ...
      timeouts: {
        value: awsExportTaskTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsExportTask.TimeoutsProperty",
      },
    };
...
export function awsExportTaskTimeoutsPropertyToTerraform(struct?: AwsExportTask.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsExportTaskTimeoutsPropertyToHclTerraform(struct?: AwsExportTask.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsExportTask {
export interface TimeoutsProperty {
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rds_export_task#create AwsExportTask#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rds_export_task#delete AwsExportTask#delete}
  */
