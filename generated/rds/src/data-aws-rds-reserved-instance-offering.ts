...
export interface DataTfReservedInstanceOfferingConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#db_instance_class DataTfReservedInstanceOffering#db_instance_class}
  */
  readonly dbInstanceClass: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#duration DataTfReservedInstanceOffering#duration}
  */
  readonly duration: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#id DataTfReservedInstanceOffering#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#multi_az DataTfReservedInstanceOffering#multi_az}
  */
  readonly multiAz: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#offering_type DataTfReservedInstanceOffering#offering_type}
  */
  readonly offeringType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#product_description DataTfReservedInstanceOffering#product_description}
  */
  readonly productDescription: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#region DataTfReservedInstanceOffering#region}
  */
...
*/
export class DataTfReservedInstanceOffering extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataTfReservedInstanceOffering resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataTfReservedInstanceOffering to import
  * @param importFromId The id of the existing DataTfReservedInstanceOffering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/rds_reserved_instance_offering#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataTfReservedInstanceOffering to import is found
  */
  ...
  * @param options DataTfReservedInstanceOfferingConfig
  */
  public constructor(scope: Construct, id: string, config: DataTfReservedInstanceOfferingConfig) {
    super(scope, id, {
