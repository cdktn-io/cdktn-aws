...
*/
export class DataAwsReservedInstanceOffering extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsReservedInstanceOfferingConfig) {
    super(scope, id, {
