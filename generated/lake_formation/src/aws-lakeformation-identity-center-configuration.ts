...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lakeformation_identity_center_configuration
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsIdentityCenterConfigurationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsIdentityCenterConfiguration extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsIdentityCenterConfiguration resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsIdentityCenterConfiguration to import
  * @param importFromId The id of the existing AwsIdentityCenterConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lakeformation_identity_center_configuration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsIdentityCenterConfiguration to import is found
  */
  ...
  * @param options AwsIdentityCenterConfigurationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsIdentityCenterConfigurationConfig) {
    super(scope, id, {
