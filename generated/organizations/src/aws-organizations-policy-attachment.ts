...
export class AwsPolicyAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/organizations_policy_attachment#import import section} in the documentation of this resource for the id to use
