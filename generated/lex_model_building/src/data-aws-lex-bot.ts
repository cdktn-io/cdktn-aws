...
export interface DataAwsLexBotConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsLexBot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLexBot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/lex_bot#import import section} in the documentation of this resource for the id to use
