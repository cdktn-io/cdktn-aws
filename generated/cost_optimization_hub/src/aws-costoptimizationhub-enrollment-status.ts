...
export interface AwsCostoptimizationhubEnrollmentStatusConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/costoptimizationhub_enrollment_status#include_member_accounts AwsCostoptimizationhubEnrollmentStatus#include_member_accounts}
  */
...
*/
export class AwsCostoptimizationhubEnrollmentStatus extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsCostoptimizationhubEnrollmentStatus resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsCostoptimizationhubEnrollmentStatus to import
  * @param importFromId The id of the existing AwsCostoptimizationhubEnrollmentStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/costoptimizationhub_enrollment_status#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCostoptimizationhubEnrollmentStatus to import is found
  */
  ...
  * @param options AwsCostoptimizationhubEnrollmentStatusConfig = {}
  */
  public constructor(scope: Construct, id: string, config: AwsCostoptimizationhubEnrollmentStatusConfig = {}) {
    super(scope, id, {
