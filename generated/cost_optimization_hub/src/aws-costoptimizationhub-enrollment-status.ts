...
export class AwsEnrollmentStatus extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsEnrollmentStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/costoptimizationhub_enrollment_status#import import section} in the documentation of this resource for the id to use
