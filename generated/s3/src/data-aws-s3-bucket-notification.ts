...
export interface DataAwsBucketNotificationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_bucket_notification#bucket DataAwsBucketNotification#bucket}
  */
  readonly bucket: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_bucket_notification#region DataAwsBucketNotification#region}
  */
...
*/
export class DataAwsBucketNotification extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsBucketNotification resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsBucketNotification to import
  * @param importFromId The id of the existing DataAwsBucketNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_bucket_notification#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsBucketNotification to import is found
  */
  ...
  * @param options DataAwsBucketNotificationConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsBucketNotificationConfig) {
    super(scope, id, {
  ...
  private _lambdaFunction = new DataAwsBucketNotification.LambdaFunctionPropertyList(this, "lambda_function", false);
  public get lambdaFunction() {
    return this._lambdaFunction;
  }

  // queue - computed: true, optional: false, required: false
  private _queue = new DataAwsBucketNotification.QueuePropertyList(this, "queue", false);
  public get queue() {
    return this._queue;
  }
  ...
  private _topic = new DataAwsBucketNotification.TopicPropertyList(this, "topic", false);
  public get topic() {
    return this._topic;
  }
...
export function dataAwsBucketNotificationLambdaFunctionPropertyToTerraform(struct?: DataAwsBucketNotification.LambdaFunctionProperty): any {
...
export function dataAwsBucketNotificationLambdaFunctionPropertyToHclTerraform(struct?: DataAwsBucketNotification.LambdaFunctionProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsBucketNotificationQueuePropertyToTerraform(struct?: DataAwsBucketNotification.QueueProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsBucketNotificationQueuePropertyToHclTerraform(struct?: DataAwsBucketNotification.QueueProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsBucketNotificationTopicPropertyToTerraform(struct?: DataAwsBucketNotification.TopicProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsBucketNotificationTopicPropertyToHclTerraform(struct?: DataAwsBucketNotification.TopicProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsBucketNotification {
