...
export interface AwsS3BucketPublicAccessBlockConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsS3BucketPublicAccessBlock extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsS3BucketPublicAccessBlock resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsS3BucketPublicAccessBlock to import
  * @param importFromId The id of the existing AwsS3BucketPublicAccessBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3_bucket_public_access_block#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsS3BucketPublicAccessBlock to import is found
  */
  ...
  * @param options AwsS3BucketPublicAccessBlockConfig
  */
  public constructor(scope: Construct, id: string, config: AwsS3BucketPublicAccessBlockConfig) {
    super(scope, id, {
