...
*/
export class DataAwsDirectoryBuckets extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsDirectoryBucketsConfig = {}) {
    super(scope, id, {
