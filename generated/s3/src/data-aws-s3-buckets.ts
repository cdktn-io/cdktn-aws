...
export interface DataAwsBucketsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_buckets#bucket_region DataAwsBuckets#bucket_region}
  */
  readonly bucketRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_buckets#max_buckets DataAwsBuckets#max_buckets}
  */
  readonly maxBuckets?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_buckets#prefix DataAwsBuckets#prefix}
  */
  readonly prefix?: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_buckets#region DataAwsBuckets#region}
  */
...
*/
export class DataAwsBuckets extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsBuckets resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsBuckets to import
  * @param importFromId The id of the existing DataAwsBuckets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_buckets#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsBuckets to import is found
  */
  ...
  * @param options DataAwsBucketsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAwsBucketsConfig = {}) {
    super(scope, id, {
  ...
  private _buckets = new DataAwsBuckets.BucketsPropertyList(this, "buckets", false);
  public get buckets() {
...
export function dataAwsBucketsBucketsPropertyToTerraform(struct?: DataAwsBuckets.BucketsProperty): any {
...
export function dataAwsBucketsBucketsPropertyToHclTerraform(struct?: DataAwsBuckets.BucketsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsBuckets {
