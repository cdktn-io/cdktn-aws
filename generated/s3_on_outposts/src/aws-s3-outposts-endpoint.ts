...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint
...
export interface AwsEndpointConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#access_type AwsEndpoint#access_type}
  */
  readonly accessType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#customer_owned_ipv4_pool AwsEndpoint#customer_owned_ipv4_pool}
  */
  readonly customerOwnedIpv4Pool?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#id AwsEndpoint#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#outpost_id AwsEndpoint#outpost_id}
  */
  readonly outpostId: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#region AwsEndpoint#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#security_group_id AwsEndpoint#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#subnet_id AwsEndpoint#subnet_id}
  */
...
export class AwsEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/s3outposts_endpoint aws_s3outposts_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _networkInterfaces = new AwsEndpoint.NetworkInterfacesPropertyList(this, "network_interfaces", true);
...
export function awsEndpointNetworkInterfacesPropertyToTerraform(struct?: AwsEndpoint.NetworkInterfacesProperty): any {
...
export function awsEndpointNetworkInterfacesPropertyToHclTerraform(struct?: AwsEndpoint.NetworkInterfacesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
