...
export interface AwsApprovalRuleTemplateAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsApprovalRuleTemplateAssociation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsApprovalRuleTemplateAssociation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsApprovalRuleTemplateAssociation to import
  * @param importFromId The id of the existing AwsApprovalRuleTemplateAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/codecommit_approval_rule_template_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsApprovalRuleTemplateAssociation to import is found
  */
  ...
  * @param options AwsApprovalRuleTemplateAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsApprovalRuleTemplateAssociationConfig) {
    super(scope, id, {
