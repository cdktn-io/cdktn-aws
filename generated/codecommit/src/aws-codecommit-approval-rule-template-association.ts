...
*/
export class TfApprovalRuleTemplateAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfApprovalRuleTemplateAssociationConfig) {
    super(scope, id, {
