...
export interface AwsCodecommitRepositoryConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsCodecommitRepository extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsCodecommitRepository resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsCodecommitRepository to import
  * @param importFromId The id of the existing AwsCodecommitRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/codecommit_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCodecommitRepository to import is found
  */
  ...
  * @param options AwsCodecommitRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: AwsCodecommitRepositoryConfig) {
    super(scope, id, {
