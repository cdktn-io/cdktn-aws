...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_route
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsApigatewayv2RouteConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly requestParameter?: AwsApigatewayv2Route.RequestParameterProperty[] | cdktn.IResolvable;
}
...
*/
export class AwsApigatewayv2Route extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsApigatewayv2Route resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsApigatewayv2Route to import
  * @param importFromId The id of the existing AwsApigatewayv2Route that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_route#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsApigatewayv2Route to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_route aws_apigatewayv2_route} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AwsApigatewayv2RouteConfig
  */
  public constructor(scope: Construct, id: string, config: AwsApigatewayv2RouteConfig) {
    super(scope, id, {
  ...
  private _requestParameter = new AwsApigatewayv2Route.RequestParameterPropertyList(this, "request_parameter", true);
  public get requestParameter() {
    return this._requestParameter;
  }
  public putRequestParameter(value: AwsApigatewayv2Route.RequestParameterProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      request_parameter: cdktn.listMapper(awsApigatewayv2RouteRequestParameterPropertyToTerraform, true)(this._requestParameter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      request_parameter: {
        value: cdktn.listMapperHcl(awsApigatewayv2RouteRequestParameterPropertyToHclTerraform, true)(this._requestParameter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsApigatewayv2Route.RequestParameterPropertyList",
      },
    };
...
export function awsApigatewayv2RouteRequestParameterPropertyToTerraform(struct?: AwsApigatewayv2Route.RequestParameterProperty | cdktn.IResolvable): any {
...
export function awsApigatewayv2RouteRequestParameterPropertyToHclTerraform(struct?: AwsApigatewayv2Route.RequestParameterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsApigatewayv2Route {
export interface RequestParameterProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_route#request_parameter_key AwsApigatewayv2Route#request_parameter_key}
  */
  readonly requestParameterKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_route#required AwsApigatewayv2Route#required}
  */
  readonly required: boolean | cdktn.IResolvable;
}
export class RequestParameterPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RequestParameterProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: RequestParameterProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class RequestParameterPropertyList extends cdktn.ComplexList {
  public internalValue? : RequestParameterProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): RequestParameterPropertyOutputReference {
    return new RequestParameterPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
