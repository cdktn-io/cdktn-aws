...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_authorizer
...
*/
export class AwsApigatewayv2Authorizer extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsApigatewayv2AuthorizerConfig) {
    super(scope, id, {
  ...
  private _jwtConfiguration = new AwsApigatewayv2Authorizer.JwtConfigurationPropertyOutputReference(this, "jwt_configuration");
  public get jwtConfiguration() {
    return this._jwtConfiguration;
  }
  public putJwtConfiguration(value: AwsApigatewayv2Authorizer.JwtConfigurationProperty) {
  ...
  private _timeouts = new AwsApigatewayv2Authorizer.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsApigatewayv2Authorizer.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      jwt_configuration: awsApigatewayv2AuthorizerJwtConfigurationPropertyToTerraform(this._jwtConfiguration.internalValue),
      timeouts: awsApigatewayv2AuthorizerTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      jwt_configuration: {
        value: awsApigatewayv2AuthorizerJwtConfigurationPropertyToHclTerraform(this._jwtConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsApigatewayv2Authorizer.JwtConfigurationPropertyList",
      },
      timeouts: {
        value: awsApigatewayv2AuthorizerTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsApigatewayv2Authorizer.TimeoutsProperty",
      },
    };
...
export function awsApigatewayv2AuthorizerJwtConfigurationPropertyToTerraform(struct?: AwsApigatewayv2Authorizer.JwtConfigurationPropertyOutputReference | AwsApigatewayv2Authorizer.JwtConfigurationProperty): any {
...
export function awsApigatewayv2AuthorizerJwtConfigurationPropertyToHclTerraform(struct?: AwsApigatewayv2Authorizer.JwtConfigurationPropertyOutputReference | AwsApigatewayv2Authorizer.JwtConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsApigatewayv2AuthorizerTimeoutsPropertyToTerraform(struct?: AwsApigatewayv2Authorizer.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsApigatewayv2AuthorizerTimeoutsPropertyToHclTerraform(struct?: AwsApigatewayv2Authorizer.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsApigatewayv2Authorizer {
...
export class JwtConfigurationPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): JwtConfigurationProperty | undefined {
  ...
  public set internalValue(value: JwtConfigurationProperty | undefined) {
    if (value === undefined) {
