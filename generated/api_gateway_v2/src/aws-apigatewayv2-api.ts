...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_api
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsApigatewayv2ApiConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly corsConfiguration?: AwsApigatewayv2Api.CorsConfigurationProperty;
}
...
*/
export class AwsApigatewayv2Api extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsApigatewayv2Api resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsApigatewayv2Api to import
  * @param importFromId The id of the existing AwsApigatewayv2Api that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apigatewayv2_api#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsApigatewayv2Api to import is found
  */
  ...
  * @param options AwsApigatewayv2ApiConfig
  */
  public constructor(scope: Construct, id: string, config: AwsApigatewayv2ApiConfig) {
    super(scope, id, {
  ...
  private _corsConfiguration = new AwsApigatewayv2Api.CorsConfigurationPropertyOutputReference(this, "cors_configuration");
  public get corsConfiguration() {
    return this._corsConfiguration;
  }
  public putCorsConfiguration(value: AwsApigatewayv2Api.CorsConfigurationProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cors_configuration: awsApigatewayv2ApiCorsConfigurationPropertyToTerraform(this._corsConfiguration.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cors_configuration: {
        value: awsApigatewayv2ApiCorsConfigurationPropertyToHclTerraform(this._corsConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsApigatewayv2Api.CorsConfigurationPropertyList",
      },
    };
...
export function awsApigatewayv2ApiCorsConfigurationPropertyToTerraform(struct?: AwsApigatewayv2Api.CorsConfigurationPropertyOutputReference | AwsApigatewayv2Api.CorsConfigurationProperty): any {
...
export function awsApigatewayv2ApiCorsConfigurationPropertyToHclTerraform(struct?: AwsApigatewayv2Api.CorsConfigurationPropertyOutputReference | AwsApigatewayv2Api.CorsConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsApigatewayv2Api {
