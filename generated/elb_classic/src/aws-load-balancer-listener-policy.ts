...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/load_balancer_listener_policy
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      load_balancer_port: cdktn.numberToTerraform(this._loadBalancerPort),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      load_balancer_port: {
        value: cdktn.numberToHclTerraform(this._loadBalancerPort),
        isBlock: false,
        type: "simple",
