...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/load_balancer_policy
...
export class PolicyAttributePropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PolicyAttributeProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: PolicyAttributeProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class PolicyAttributePropertyList extends cdktn.ComplexList {
  public internalValue? : PolicyAttributeProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): PolicyAttributePropertyOutputReference {
    return new PolicyAttributePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
