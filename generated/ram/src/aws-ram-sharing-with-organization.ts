...
*/
export class TfSharingWithOrganization extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfSharingWithOrganizationConfig = {}) {
    super(scope, id, {
