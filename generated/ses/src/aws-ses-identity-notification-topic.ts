...
*/
export class AwsSesIdentityNotificationTopic extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsSesIdentityNotificationTopicConfig) {
    super(scope, id, {
