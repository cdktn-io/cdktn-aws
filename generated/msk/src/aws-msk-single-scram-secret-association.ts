...
*/
export class AwsSingleScramSecretAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsSingleScramSecretAssociationConfig) {
    super(scope, id, {
