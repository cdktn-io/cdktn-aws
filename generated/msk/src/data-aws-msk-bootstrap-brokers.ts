...
export interface TfDataBootstrapBrokersConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers#cluster_arn TfDataBootstrapBrokers#cluster_arn}
  */
  readonly clusterArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers#id TfDataBootstrapBrokers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers#region TfDataBootstrapBrokers#region}
  */
...
*/
export class TfDataBootstrapBrokers extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataBootstrapBrokers resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataBootstrapBrokers to import
  * @param importFromId The id of the existing TfDataBootstrapBrokers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataBootstrapBrokers to import is found
  */
  ...
  * @param options TfDataBootstrapBrokersConfig
  */
  public constructor(scope: Construct, id: string, config: TfDataBootstrapBrokersConfig) {
    super(scope, id, {
