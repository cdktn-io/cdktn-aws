...
export interface DataAwsMskBootstrapBrokersConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsMskBootstrapBrokers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMskBootstrapBrokers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers#import import section} in the documentation of this resource for the id to use
