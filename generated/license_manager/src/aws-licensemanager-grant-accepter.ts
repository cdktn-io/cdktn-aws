...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/licensemanager_grant_accepter
...
*/
export class AwsLicensemanagerGrantAccepter extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsLicensemanagerGrantAccepterConfig) {
    super(scope, id, {
