...
export class DataTfAccessPoint extends cdktn.TerraformDataSource {
  ...
  */
  ...
  private _publicAccessBlockConfiguration = new DataTfAccessPoint.PublicAccessBlockConfigurationPropertyList(this, "public_access_block_configuration", false);
  ...
  private _vpcConfiguration = new DataTfAccessPoint.VpcConfigurationPropertyList(this, "vpc_configuration", false);
...
export function dataTfAccessPointPublicAccessBlockConfigurationPropertyToTerraform(struct?: DataTfAccessPoint.PublicAccessBlockConfigurationProperty): any {
...
export function dataTfAccessPointPublicAccessBlockConfigurationPropertyToHclTerraform(struct?: DataTfAccessPoint.PublicAccessBlockConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfAccessPointVpcConfigurationPropertyToTerraform(struct?: DataTfAccessPoint.VpcConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfAccessPointVpcConfigurationPropertyToHclTerraform(struct?: DataTfAccessPoint.VpcConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
