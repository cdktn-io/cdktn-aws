...
export interface DataTfS3AccessPointConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_access_point#account_id DataTfS3AccessPoint#account_id}
  */
  readonly accountId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_access_point#name DataTfS3AccessPoint#name}
  */
  readonly name: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_access_point#region DataTfS3AccessPoint#region}
  */
...
*/
export class DataTfS3AccessPoint extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataTfS3AccessPoint resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataTfS3AccessPoint to import
  * @param importFromId The id of the existing DataTfS3AccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/s3_access_point#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataTfS3AccessPoint to import is found
  */
  ...
  * @param options DataTfS3AccessPointConfig
  */
  public constructor(scope: Construct, id: string, config: DataTfS3AccessPointConfig) {
    super(scope, id, {
  ...
  private _publicAccessBlockConfiguration = new DataTfS3AccessPoint.PublicAccessBlockConfigurationPropertyList(this, "public_access_block_configuration", false);
  ...
  private _vpcConfiguration = new DataTfS3AccessPoint.VpcConfigurationPropertyList(this, "vpc_configuration", false);
...
export function dataTfS3AccessPointPublicAccessBlockConfigurationPropertyToTerraform(struct?: DataTfS3AccessPoint.PublicAccessBlockConfigurationProperty): any {
...
export function dataTfS3AccessPointPublicAccessBlockConfigurationPropertyToHclTerraform(struct?: DataTfS3AccessPoint.PublicAccessBlockConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfS3AccessPointVpcConfigurationPropertyToTerraform(struct?: DataTfS3AccessPoint.VpcConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfS3AccessPointVpcConfigurationPropertyToHclTerraform(struct?: DataTfS3AccessPoint.VpcConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataTfS3AccessPoint {
