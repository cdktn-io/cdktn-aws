...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/opensearchserverless_collection
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsOpensearchserverlessCollectionConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly encryptionConfig?: AwsOpensearchserverlessCollection.EncryptionConfigProperty[] | cdktn.IResolvable;
  /**
  ...
  */
  readonly vectorOptions?: AwsOpensearchserverlessCollection.VectorOptionsProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: AwsOpensearchserverlessCollection.TimeoutsProperty;
}
...
*/
export class AwsOpensearchserverlessCollection extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsOpensearchserverlessCollection resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsOpensearchserverlessCollection to import
  * @param importFromId The id of the existing AwsOpensearchserverlessCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/opensearchserverless_collection#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsOpensearchserverlessCollection to import is found
  */
  ...
  * @param options AwsOpensearchserverlessCollectionConfig
  */
  public constructor(scope: Construct, id: string, config: AwsOpensearchserverlessCollectionConfig) {
    super(scope, id, {
  ...
  private _encryptionConfig = new AwsOpensearchserverlessCollection.EncryptionConfigPropertyList(this, "encryption_config", false);
  public get encryptionConfig() {
    return this._encryptionConfig;
  }
  public putEncryptionConfig(value: AwsOpensearchserverlessCollection.EncryptionConfigProperty[] | cdktn.IResolvable) {
  ...
  private _vectorOptions = new AwsOpensearchserverlessCollection.VectorOptionsPropertyList(this, "vector_options", false);
  public get vectorOptions() {
    return this._vectorOptions;
  }
  public putVectorOptions(value: AwsOpensearchserverlessCollection.VectorOptionsProperty[] | cdktn.IResolvable) {
  ...
  private _timeouts = new AwsOpensearchserverlessCollection.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsOpensearchserverlessCollection.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      encryption_config: cdktn.listMapper(awsOpensearchserverlessCollectionEncryptionConfigPropertyToTerraform, false)(this._encryptionConfig.internalValue),
      name: cdktn.stringToTerraform(this._name),
      region: cdktn.stringToTerraform(this._region),
      standby_replicas: cdktn.stringToTerraform(this._standbyReplicas),
      tags: cdktn.hashMapper(cdktn.stringToTerraform)(this._tags),
      type: cdktn.stringToTerraform(this._type),
      vector_options: cdktn.listMapper(awsOpensearchserverlessCollectionVectorOptionsPropertyToTerraform, false)(this._vectorOptions.internalValue),
      timeouts: awsOpensearchserverlessCollectionTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      encryption_config: {
        value: cdktn.listMapperHcl(awsOpensearchserverlessCollectionEncryptionConfigPropertyToHclTerraform, false)(this._encryptionConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsOpensearchserverlessCollection.EncryptionConfigPropertyList",
      },
      name: {
      ...
      vector_options: {
        value: cdktn.listMapperHcl(awsOpensearchserverlessCollectionVectorOptionsPropertyToHclTerraform, false)(this._vectorOptions.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsOpensearchserverlessCollection.VectorOptionsPropertyList",
      },
      timeouts: {
        value: awsOpensearchserverlessCollectionTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsOpensearchserverlessCollection.TimeoutsProperty",
      },
    };
...
export function awsOpensearchserverlessCollectionEncryptionConfigPropertyToTerraform(struct?: AwsOpensearchserverlessCollection.EncryptionConfigProperty | cdktn.IResolvable): any {
...
export function awsOpensearchserverlessCollectionEncryptionConfigPropertyToHclTerraform(struct?: AwsOpensearchserverlessCollection.EncryptionConfigProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsOpensearchserverlessCollectionVectorOptionsPropertyToTerraform(struct?: AwsOpensearchserverlessCollection.VectorOptionsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsOpensearchserverlessCollectionVectorOptionsPropertyToHclTerraform(struct?: AwsOpensearchserverlessCollection.VectorOptionsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsOpensearchserverlessCollectionTimeoutsPropertyToTerraform(struct?: AwsOpensearchserverlessCollection.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsOpensearchserverlessCollectionTimeoutsPropertyToHclTerraform(struct?: AwsOpensearchserverlessCollection.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsOpensearchserverlessCollection {
...
export interface VectorOptionsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/opensearchserverless_collection#serverless_vector_acceleration AwsOpensearchserverlessCollection#serverless_vector_acceleration}
  */
  readonly serverlessVectorAcceleration?: string;
}
export class VectorOptionsPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): VectorOptionsProperty | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: VectorOptionsProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class VectorOptionsPropertyList extends cdktn.ComplexList {
  public internalValue? : VectorOptionsProperty[] | cdktn.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): VectorOptionsPropertyOutputReference {
    return new VectorOptionsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface TimeoutsProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/opensearchserverless_collection#create AwsOpensearchserverlessCollection#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/opensearchserverless_collection#delete AwsOpensearchserverlessCollection#delete}
  */
