...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/opensearchserverless_security_policy
...
*/
export class AwsOpensearchserverlessSecurityPolicy extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsOpensearchserverlessSecurityPolicyConfig) {
    super(scope, id, {
