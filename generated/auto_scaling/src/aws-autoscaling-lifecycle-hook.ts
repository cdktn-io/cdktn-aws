...
export interface AwsAutoscalingLifecycleHookConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsAutoscalingLifecycleHook extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsAutoscalingLifecycleHook resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsAutoscalingLifecycleHook to import
  * @param importFromId The id of the existing AwsAutoscalingLifecycleHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/autoscaling_lifecycle_hook#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsAutoscalingLifecycleHook to import is found
  */
  ...
  * @param options AwsAutoscalingLifecycleHookConfig
  */
  public constructor(scope: Construct, id: string, config: AwsAutoscalingLifecycleHookConfig) {
    super(scope, id, {
