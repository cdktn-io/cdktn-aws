...
export interface AwsNotificationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsNotification extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsNotification resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsNotification to import
  * @param importFromId The id of the existing AwsNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/autoscaling_notification#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsNotification to import is found
  */
  ...
  * @param options AwsNotificationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsNotificationConfig) {
    super(scope, id, {
