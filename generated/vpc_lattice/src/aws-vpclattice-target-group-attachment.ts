...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpclattice_target_group_attachment
...
export class AwsTargetGroupAttachment extends cdktn.TerraformResource {
  ...
  */
  ...
  private _target = new AwsTargetGroupAttachment.TargetPropertyOutputReference(this, "target");
  public get target() {
    return this._target;
  }
  public putTarget(value: AwsTargetGroupAttachment.TargetProperty) {
  ...
  private _timeouts = new AwsTargetGroupAttachment.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsTargetGroupAttachment.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      target: awsTargetGroupAttachmentTargetPropertyToTerraform(this._target.internalValue),
      timeouts: awsTargetGroupAttachmentTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      target: {
        value: awsTargetGroupAttachmentTargetPropertyToHclTerraform(this._target.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsTargetGroupAttachment.TargetPropertyList",
      },
      timeouts: {
        value: awsTargetGroupAttachmentTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsTargetGroupAttachment.TimeoutsProperty",
      },
    };
...
export function awsTargetGroupAttachmentTargetPropertyToTerraform(struct?: AwsTargetGroupAttachment.TargetPropertyOutputReference | AwsTargetGroupAttachment.TargetProperty): any {
...
export function awsTargetGroupAttachmentTargetPropertyToHclTerraform(struct?: AwsTargetGroupAttachment.TargetPropertyOutputReference | AwsTargetGroupAttachment.TargetProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTargetGroupAttachmentTimeoutsPropertyToTerraform(struct?: AwsTargetGroupAttachment.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTargetGroupAttachmentTimeoutsPropertyToHclTerraform(struct?: AwsTargetGroupAttachment.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsTargetGroupAttachment {
