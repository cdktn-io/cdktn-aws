...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/storagegateway_gateway
...
export class AwsGateway extends cdktn.TerraformResource {
  ...
  */
  ...
  private _gatewayNetworkInterface = new AwsGateway.GatewayNetworkInterfacePropertyList(this, "gateway_network_interface", false);
  ...
  public set smbFileShareVisibility(value: boolean | cdktn.IResolvable) {
  ...
  private _maintenanceStartTime = new AwsGateway.MaintenanceStartTimePropertyOutputReference(this, "maintenance_start_time");
  public get maintenanceStartTime() {
    return this._maintenanceStartTime;
  }
  public putMaintenanceStartTime(value: AwsGateway.MaintenanceStartTimeProperty) {
  ...
  private _smbActiveDirectorySettings = new AwsGateway.SmbActiveDirectorySettingsPropertyOutputReference(this, "smb_active_directory_settings");
  public get smbActiveDirectorySettings() {
    return this._smbActiveDirectorySettings;
  }
  public putSmbActiveDirectorySettings(value: AwsGateway.SmbActiveDirectorySettingsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      average_download_rate_limit_in_bits_per_sec: cdktn.numberToTerraform(this._averageDownloadRateLimitInBitsPerSec),
      average_upload_rate_limit_in_bits_per_sec: cdktn.numberToTerraform(this._averageUploadRateLimitInBitsPerSec),
      cloudwatch_log_group_arn: cdktn.stringToTerraform(this._cloudwatchLogGroupArn),
      gateway_ip_address: cdktn.stringToTerraform(this._gatewayIpAddress),
      gateway_name: cdktn.stringToTerraform(this._gatewayName),
      gateway_timezone: cdktn.stringToTerraform(this._gatewayTimezone),
      gateway_type: cdktn.stringToTerraform(this._gatewayType),
      gateway_vpc_endpoint: cdktn.stringToTerraform(this._gatewayVpcEndpoint),
      id: cdktn.stringToTerraform(this._id),
      medium_changer_type: cdktn.stringToTerraform(this._mediumChangerType),
      region: cdktn.stringToTerraform(this._region),
      smb_file_share_visibility: cdktn.booleanToTerraform(this._smbFileShareVisibility),
      smb_guest_password: cdktn.stringToTerraform(this._smbGuestPassword),
      smb_security_strategy: cdktn.stringToTerraform(this._smbSecurityStrategy),
      tags: cdktn.hashMapper(cdktn.stringToTerraform)(this._tags),
      tags_all: cdktn.hashMapper(cdktn.stringToTerraform)(this._tagsAll),
      tape_drive_type: cdktn.stringToTerraform(this._tapeDriveType),
      maintenance_start_time: awsGatewayMaintenanceStartTimePropertyToTerraform(this._maintenanceStartTime.internalValue),
      smb_active_directory_settings: awsGatewaySmbActiveDirectorySettingsPropertyToTerraform(this._smbActiveDirectorySettings.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      average_download_rate_limit_in_bits_per_sec: {
        value: cdktn.numberToHclTerraform(this._averageDownloadRateLimitInBitsPerSec),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      average_upload_rate_limit_in_bits_per_sec: {
        value: cdktn.numberToHclTerraform(this._averageUploadRateLimitInBitsPerSec),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      gateway_ip_address: {
        value: cdktn.stringToHclTerraform(this._gatewayIpAddress),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      gateway_timezone: {
        value: cdktn.stringToHclTerraform(this._gatewayTimezone),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      gateway_vpc_endpoint: {
        value: cdktn.stringToHclTerraform(this._gatewayVpcEndpoint),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      medium_changer_type: {
        value: cdktn.stringToHclTerraform(this._mediumChangerType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      smb_file_share_visibility: {
        value: cdktn.booleanToHclTerraform(this._smbFileShareVisibility),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      smb_guest_password: {
        value: cdktn.stringToHclTerraform(this._smbGuestPassword),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      smb_security_strategy: {
        value: cdktn.stringToHclTerraform(this._smbSecurityStrategy),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      tape_drive_type: {
        value: cdktn.stringToHclTerraform(this._tapeDriveType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      maintenance_start_time: {
        value: awsGatewayMaintenanceStartTimePropertyToHclTerraform(this._maintenanceStartTime.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsGateway.MaintenanceStartTimePropertyList",
      },
      smb_active_directory_settings: {
        value: awsGatewaySmbActiveDirectorySettingsPropertyToHclTerraform(this._smbActiveDirectorySettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsGateway.SmbActiveDirectorySettingsPropertyList",
      },
      timeouts: {
...
export function awsGatewayGatewayNetworkInterfacePropertyToTerraform(struct?: AwsGateway.GatewayNetworkInterfaceProperty): any {
...
export function awsGatewayGatewayNetworkInterfacePropertyToHclTerraform(struct?: AwsGateway.GatewayNetworkInterfaceProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsGatewayMaintenanceStartTimePropertyToTerraform(struct?: AwsGateway.MaintenanceStartTimePropertyOutputReference | AwsGateway.MaintenanceStartTimeProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsGatewayMaintenanceStartTimePropertyToHclTerraform(struct?: AwsGateway.MaintenanceStartTimePropertyOutputReference | AwsGateway.MaintenanceStartTimeProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsGatewaySmbActiveDirectorySettingsPropertyToTerraform(struct?: AwsGateway.SmbActiveDirectorySettingsPropertyOutputReference | AwsGateway.SmbActiveDirectorySettingsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    domain_controllers: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.domainControllers),
...
export function awsGatewaySmbActiveDirectorySettingsPropertyToHclTerraform(struct?: AwsGateway.SmbActiveDirectorySettingsPropertyOutputReference | AwsGateway.SmbActiveDirectorySettingsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    domain_controllers: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.domainControllers),
      isBlock: false,
      type: "set",
...
export class GatewayNetworkInterfacePropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GatewayNetworkInterfaceProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GatewayNetworkInterfaceProperty | undefined) {
    if (value === undefined) {
...
export class GatewayNetworkInterfacePropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): GatewayNetworkInterfacePropertyOutputReference {
    return new GatewayNetworkInterfacePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class MaintenanceStartTimePropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): MaintenanceStartTimeProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: MaintenanceStartTimeProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class SmbActiveDirectorySettingsPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): SmbActiveDirectorySettingsProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: SmbActiveDirectorySettingsProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
