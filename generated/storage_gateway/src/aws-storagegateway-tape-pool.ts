...
export interface TfTapePoolConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfTapePool extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfTapePool resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfTapePool to import
  * @param importFromId The id of the existing TfTapePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/storagegateway_tape_pool#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfTapePool to import is found
  */
  ...
  * @param options TfTapePoolConfig
  */
  public constructor(scope: Construct, id: string, config: TfTapePoolConfig) {
    super(scope, id, {
