...
export interface AwsStoragegatewayTapePoolConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsStoragegatewayTapePool extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsStoragegatewayTapePool resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsStoragegatewayTapePool to import
  * @param importFromId The id of the existing AwsStoragegatewayTapePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/storagegateway_tape_pool#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsStoragegatewayTapePool to import is found
  */
  ...
  * @param options AwsStoragegatewayTapePoolConfig
  */
  public constructor(scope: Construct, id: string, config: AwsStoragegatewayTapePoolConfig) {
    super(scope, id, {
