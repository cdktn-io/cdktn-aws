...
export interface AwsQuicksightUserConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsQuicksightUser extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsQuicksightUser resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsQuicksightUser to import
  * @param importFromId The id of the existing AwsQuicksightUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/quicksight_user#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsQuicksightUser to import is found
  */
  ...
  * @param options AwsQuicksightUserConfig
  */
  public constructor(scope: Construct, id: string, config: AwsQuicksightUserConfig) {
    super(scope, id, {
