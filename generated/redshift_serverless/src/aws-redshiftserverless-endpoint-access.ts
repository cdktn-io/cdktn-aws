...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshiftserverless_endpoint_access
...
*/
export class AwsRedshiftserverlessEndpointAccess extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsRedshiftserverlessEndpointAccessConfig) {
    super(scope, id, {
  ...
  private _vpcEndpoint = new AwsRedshiftserverlessEndpointAccess.VpcEndpointPropertyList(this, "vpc_endpoint", false);
...
export function awsRedshiftserverlessEndpointAccessNetworkInterfacePropertyToTerraform(struct?: AwsRedshiftserverlessEndpointAccess.NetworkInterfaceProperty): any {
...
export function awsRedshiftserverlessEndpointAccessNetworkInterfacePropertyToHclTerraform(struct?: AwsRedshiftserverlessEndpointAccess.NetworkInterfaceProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsRedshiftserverlessEndpointAccessVpcEndpointPropertyToTerraform(struct?: AwsRedshiftserverlessEndpointAccess.VpcEndpointProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsRedshiftserverlessEndpointAccessVpcEndpointPropertyToHclTerraform(struct?: AwsRedshiftserverlessEndpointAccess.VpcEndpointProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsRedshiftserverlessEndpointAccess {
