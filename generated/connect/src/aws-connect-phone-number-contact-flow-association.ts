...
export interface TfPhoneNumberContactFlowAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/connect_phone_number_contact_flow_association#contact_flow_id TfPhoneNumberContactFlowAssociation#contact_flow_id}
  */
  readonly contactFlowId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/connect_phone_number_contact_flow_association#instance_id TfPhoneNumberContactFlowAssociation#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/connect_phone_number_contact_flow_association#phone_number_id TfPhoneNumberContactFlowAssociation#phone_number_id}
  */
  readonly phoneNumberId: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/connect_phone_number_contact_flow_association#region TfPhoneNumberContactFlowAssociation#region}
  */
...
*/
export class TfPhoneNumberContactFlowAssociation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfPhoneNumberContactFlowAssociation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfPhoneNumberContactFlowAssociation to import
  * @param importFromId The id of the existing TfPhoneNumberContactFlowAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/connect_phone_number_contact_flow_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfPhoneNumberContactFlowAssociation to import is found
  */
  ...
  * @param options TfPhoneNumberContactFlowAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: TfPhoneNumberContactFlowAssociationConfig) {
    super(scope, id, {
