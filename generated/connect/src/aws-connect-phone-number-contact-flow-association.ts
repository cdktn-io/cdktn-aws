...
*/
export class AwsPhoneNumberContactFlowAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsPhoneNumberContactFlowAssociationConfig) {
    super(scope, id, {
