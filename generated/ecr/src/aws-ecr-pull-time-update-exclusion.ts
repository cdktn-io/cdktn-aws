...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_pull_time_update_exclusion
...
*/
export class AwsEcrPullTimeUpdateExclusion extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsEcrPullTimeUpdateExclusionConfig) {
    super(scope, id, {
