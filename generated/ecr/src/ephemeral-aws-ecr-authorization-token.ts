...
export interface EphemeralAwsEcrAuthorizationTokenConfig extends cdktn.TerraformEphemeralMetaArguments {
  /**
...
*/
export class EphemeralAwsEcrAuthorizationToken extends cdktn.TerraformEphemeralResource {
  ...
  * @param options EphemeralAwsEcrAuthorizationTokenConfig = {}
  */
  public constructor(scope: Construct, id: string, config: EphemeralAwsEcrAuthorizationTokenConfig = {}) {
    super(scope, id, {
