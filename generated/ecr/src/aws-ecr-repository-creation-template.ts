...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsEcrRepositoryCreationTemplateConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#applied_for AwsEcrRepositoryCreationTemplate#applied_for}
  */
  readonly appliedFor: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#custom_role_arn AwsEcrRepositoryCreationTemplate#custom_role_arn}
  */
  readonly customRoleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#description AwsEcrRepositoryCreationTemplate#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#id AwsEcrRepositoryCreationTemplate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#image_tag_mutability AwsEcrRepositoryCreationTemplate#image_tag_mutability}
  */
  readonly imageTagMutability?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#lifecycle_policy AwsEcrRepositoryCreationTemplate#lifecycle_policy}
  */
  readonly lifecyclePolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#prefix AwsEcrRepositoryCreationTemplate#prefix}
  */
  readonly prefix: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#region AwsEcrRepositoryCreationTemplate#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#repository_policy AwsEcrRepositoryCreationTemplate#repository_policy}
  */
  readonly repositoryPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#resource_tags AwsEcrRepositoryCreationTemplate#resource_tags}
  */
  readonly resourceTags?: { [key: string]: string };
  /**
  * encryption_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#encryption_configuration AwsEcrRepositoryCreationTemplate#encryption_configuration}
  */
  readonly encryptionConfiguration?: AwsEcrRepositoryCreationTemplate.EncryptionConfigurationProperty[] | cdktn.IResolvable;
  /**
  * image_tag_mutability_exclusion_filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#image_tag_mutability_exclusion_filter AwsEcrRepositoryCreationTemplate#image_tag_mutability_exclusion_filter}
  */
  readonly imageTagMutabilityExclusionFilter?: AwsEcrRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty[] | cdktn.IResolvable;
}
...
*/
export class AwsEcrRepositoryCreationTemplate extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the AwsEcrRepositoryCreationTemplate to import
  * @param importFromId The id of the existing AwsEcrRepositoryCreationTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ecr_repository_creation_template#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsEcrRepositoryCreationTemplate to import is found
  */
  ...
  * @param options AwsEcrRepositoryCreationTemplateConfig
  */
  public constructor(scope: Construct, id: string, config: AwsEcrRepositoryCreationTemplateConfig) {
    super(scope, id, {
  ...
  private _encryptionConfiguration = new AwsEcrRepositoryCreationTemplate.EncryptionConfigurationPropertyList(this, "encryption_configuration", false);
  public get encryptionConfiguration() {
    return this._encryptionConfiguration;
  }
  public putEncryptionConfiguration(value: AwsEcrRepositoryCreationTemplate.EncryptionConfigurationProperty[] | cdktn.IResolvable) {
  ...
  private _imageTagMutabilityExclusionFilter = new AwsEcrRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterPropertyList(this, "image_tag_mutability_exclusion_filter", false);
  public get imageTagMutabilityExclusionFilter() {
    return this._imageTagMutabilityExclusionFilter;
  }
  public putImageTagMutabilityExclusionFilter(value: AwsEcrRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      encryption_configuration: cdktn.listMapper(awsEcrRepositoryCreationTemplateEncryptionConfigurationPropertyToTerraform, true)(this._encryptionConfiguration.internalValue),
      image_tag_mutability_exclusion_filter: cdktn.listMapper(awsEcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToTerraform, true)(this._imageTagMutabilityExclusionFilter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      encryption_configuration: {
        value: cdktn.listMapperHcl(awsEcrRepositoryCreationTemplateEncryptionConfigurationPropertyToHclTerraform, true)(this._encryptionConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsEcrRepositoryCreationTemplate.EncryptionConfigurationPropertyList",
      },
      image_tag_mutability_exclusion_filter: {
        value: cdktn.listMapperHcl(awsEcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToHclTerraform, true)(this._imageTagMutabilityExclusionFilter.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsEcrRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterPropertyList",
      },
    };
...
export function awsEcrRepositoryCreationTemplateEncryptionConfigurationPropertyToTerraform(struct?: AwsEcrRepositoryCreationTemplate.EncryptionConfigurationProperty | cdktn.IResolvable): any {
...
export function awsEcrRepositoryCreationTemplateEncryptionConfigurationPropertyToHclTerraform(struct?: AwsEcrRepositoryCreationTemplate.EncryptionConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsEcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToTerraform(struct?: AwsEcrRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsEcrRepositoryCreationTemplateImageTagMutabilityExclusionFilterPropertyToHclTerraform(struct?: AwsEcrRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsEcrRepositoryCreationTemplate {
