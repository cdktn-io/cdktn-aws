...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_pull_through_cache_rule
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataAwsPullThroughCacheRuleConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_pull_through_cache_rule#ecr_repository_prefix DataAwsPullThroughCacheRule#ecr_repository_prefix}
  */
  readonly ecrRepositoryPrefix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_pull_through_cache_rule#id DataAwsPullThroughCacheRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_pull_through_cache_rule#region DataAwsPullThroughCacheRule#region}
  */
...
*/
export class DataAwsPullThroughCacheRule extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsPullThroughCacheRule resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsPullThroughCacheRule to import
  * @param importFromId The id of the existing DataAwsPullThroughCacheRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_pull_through_cache_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsPullThroughCacheRule to import is found
  */
  ...
  * @param options DataAwsPullThroughCacheRuleConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsPullThroughCacheRuleConfig) {
    super(scope, id, {
