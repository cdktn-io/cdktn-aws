...
*/
export class DataTfPullThroughCacheRule extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataTfPullThroughCacheRuleConfig) {
    super(scope, id, {
