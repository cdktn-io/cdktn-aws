...
export interface DataAwsRepositoryConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_repository#id DataAwsRepository#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_repository#name DataAwsRepository#name}
  */
  readonly name: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_repository#region DataAwsRepository#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_repository#registry_id DataAwsRepository#registry_id}
  */
  readonly registryId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_repository#tags DataAwsRepository#tags}
  */
...
*/
export class DataAwsRepository extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsRepository resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsRepository to import
  * @param importFromId The id of the existing DataAwsRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ecr_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsRepository to import is found
  */
  ...
  * @param options DataAwsRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsRepositoryConfig) {
    super(scope, id, {
  ...
  private _encryptionConfiguration = new DataAwsRepository.EncryptionConfigurationPropertyList(this, "encryption_configuration", false);
  ...
  private _imageScanningConfiguration = new DataAwsRepository.ImageScanningConfigurationPropertyList(this, "image_scanning_configuration", false);
  ...
  private _imageTagMutabilityExclusionFilter = new DataAwsRepository.ImageTagMutabilityExclusionFilterPropertyList(this, "image_tag_mutability_exclusion_filter", false);
...
export function dataAwsRepositoryEncryptionConfigurationPropertyToTerraform(struct?: DataAwsRepository.EncryptionConfigurationProperty): any {
...
export function dataAwsRepositoryEncryptionConfigurationPropertyToHclTerraform(struct?: DataAwsRepository.EncryptionConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsRepositoryImageScanningConfigurationPropertyToTerraform(struct?: DataAwsRepository.ImageScanningConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsRepositoryImageScanningConfigurationPropertyToHclTerraform(struct?: DataAwsRepository.ImageScanningConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsRepositoryImageTagMutabilityExclusionFilterPropertyToTerraform(struct?: DataAwsRepository.ImageTagMutabilityExclusionFilterProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsRepositoryImageTagMutabilityExclusionFilterPropertyToHclTerraform(struct?: DataAwsRepository.ImageTagMutabilityExclusionFilterProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsRepository {
...
export class ImageTagMutabilityExclusionFilterPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ImageTagMutabilityExclusionFilterProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ImageTagMutabilityExclusionFilterProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
