...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/ephemeral-resources/kms_secrets
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface EphemeralAwsSecretsConfig extends cdktn.TerraformEphemeralMetaArguments {
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/ephemeral-resources/kms_secrets#region EphemeralAwsSecrets#region}
  */
  readonly region?: string;
  /**
  * secret block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/ephemeral-resources/kms_secrets#secret EphemeralAwsSecrets#secret}
  */
  readonly secret?: EphemeralAwsSecrets.SecretProperty[] | cdktn.IResolvable;
}
...
*/
export class EphemeralAwsSecrets extends cdktn.TerraformEphemeralResource {
  ...
  * @param options EphemeralAwsSecretsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: EphemeralAwsSecretsConfig = {}) {
    super(scope, id, {
  ...
  private _secret = new EphemeralAwsSecrets.SecretPropertyList(this, "secret", true);
  public get secret() {
    return this._secret;
  }
  public putSecret(value: EphemeralAwsSecrets.SecretProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      secret: cdktn.listMapper(ephemeralAwsSecretsSecretPropertyToTerraform, true)(this._secret.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      secret: {
        value: cdktn.listMapperHcl(ephemeralAwsSecretsSecretPropertyToHclTerraform, true)(this._secret.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "EphemeralAwsSecrets.SecretPropertyList",
      },
    };
...
export function ephemeralAwsSecretsSecretPropertyToTerraform(struct?: EphemeralAwsSecrets.SecretProperty | cdktn.IResolvable): any {
...
export function ephemeralAwsSecretsSecretPropertyToHclTerraform(struct?: EphemeralAwsSecrets.SecretProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace EphemeralAwsSecrets {
