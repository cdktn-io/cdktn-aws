...
export interface DataAwsKmsCiphertextConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsKmsCiphertext extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKmsCiphertext that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_ciphertext#import import section} in the documentation of this resource for the id to use
