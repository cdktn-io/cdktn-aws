...
export interface DataAwsCustomKeyStoreConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_custom_key_store#custom_key_store_id DataAwsCustomKeyStore#custom_key_store_id}
  */
  readonly customKeyStoreId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_custom_key_store#custom_key_store_name DataAwsCustomKeyStore#custom_key_store_name}
  */
  readonly customKeyStoreName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_custom_key_store#id DataAwsCustomKeyStore#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_custom_key_store#region DataAwsCustomKeyStore#region}
  */
...
*/
export class DataAwsCustomKeyStore extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsCustomKeyStore resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsCustomKeyStore to import
  * @param importFromId The id of the existing DataAwsCustomKeyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_custom_key_store#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsCustomKeyStore to import is found
  */
  ...
  * @param options DataAwsCustomKeyStoreConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAwsCustomKeyStoreConfig = {}) {
    super(scope, id, {
