...
export interface DataAwsSecretConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_secret#id DataAwsSecret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_secret#region DataAwsSecret#region}
  */
  readonly region?: string;
  /**
  * secret block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_secret#secret DataAwsSecret#secret}
  */
  readonly secret: DataAwsSecret.SecretProperty[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_secret aws_kms_secret}
*/
export class DataAwsSecret extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsSecret resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsSecret to import
  * @param importFromId The id of the existing DataAwsSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kms_secret#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsSecret to import is found
  */
  ...
  * @param options DataAwsSecretConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsSecretConfig) {
    super(scope, id, {
  ...
  private _secret = new DataAwsSecret.SecretPropertyList(this, "secret", true);
  public get secret() {
    return this._secret;
  }
  public putSecret(value: DataAwsSecret.SecretProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      secret: cdktn.listMapper(dataAwsSecretSecretPropertyToTerraform, true)(this._secret.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      secret: {
        value: cdktn.listMapperHcl(dataAwsSecretSecretPropertyToHclTerraform, true)(this._secret.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataAwsSecret.SecretPropertyList",
      },
    };
...
export function dataAwsSecretSecretPropertyToTerraform(struct?: DataAwsSecret.SecretProperty | cdktn.IResolvable): any {
...
export function dataAwsSecretSecretPropertyToHclTerraform(struct?: DataAwsSecret.SecretProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsSecret {
