...
*/
export class AwsWafregionalByteMatchSet extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsWafregionalByteMatchSetConfig) {
    super(scope, id, {
  ...
  private _byteMatchTuples = new AwsWafregionalByteMatchSet.ByteMatchTuplesPropertyList(this, "byte_match_tuples", true);
  public get byteMatchTuples() {
    return this._byteMatchTuples;
  }
  public putByteMatchTuples(value: AwsWafregionalByteMatchSet.ByteMatchTuplesProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      byte_match_tuples: cdktn.listMapper(awsWafregionalByteMatchSetByteMatchTuplesPropertyToTerraform, true)(this._byteMatchTuples.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      byte_match_tuples: {
        value: cdktn.listMapperHcl(awsWafregionalByteMatchSetByteMatchTuplesPropertyToHclTerraform, true)(this._byteMatchTuples.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsWafregionalByteMatchSet.ByteMatchTuplesPropertyList",
      },
    };
...
export function awsWafregionalByteMatchSetFieldToMatchPropertyToTerraform(struct?: AwsWafregionalByteMatchSet.FieldToMatchPropertyOutputReference | AwsWafregionalByteMatchSet.FieldToMatchProperty): any {
...
export function awsWafregionalByteMatchSetFieldToMatchPropertyToHclTerraform(struct?: AwsWafregionalByteMatchSet.FieldToMatchPropertyOutputReference | AwsWafregionalByteMatchSet.FieldToMatchProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsWafregionalByteMatchSetByteMatchTuplesPropertyToTerraform(struct?: AwsWafregionalByteMatchSet.ByteMatchTuplesProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    field_to_match: awsWafregionalByteMatchSetFieldToMatchPropertyToTerraform(struct!.fieldToMatch),
  }
}


export function awsWafregionalByteMatchSetByteMatchTuplesPropertyToHclTerraform(struct?: AwsWafregionalByteMatchSet.ByteMatchTuplesProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    field_to_match: {
      value: awsWafregionalByteMatchSetFieldToMatchPropertyToHclTerraform(struct!.fieldToMatch),
      isBlock: true,
      type: "list",
...
export namespace AwsWafregionalByteMatchSet {
