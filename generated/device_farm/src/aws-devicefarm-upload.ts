...
export interface AwsUploadConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsUpload extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsUpload resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsUpload to import
  * @param importFromId The id of the existing AwsUpload that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/devicefarm_upload#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsUpload to import is found
  */
  ...
  * @param options AwsUploadConfig
  */
  public constructor(scope: Construct, id: string, config: AwsUploadConfig) {
    super(scope, id, {
