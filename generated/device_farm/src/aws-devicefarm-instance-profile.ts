...
*/
export class AwsDevicefarmInstanceProfile extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsDevicefarmInstanceProfileConfig) {
    super(scope, id, {
