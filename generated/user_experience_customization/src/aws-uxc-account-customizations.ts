...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/uxc_account_customizations
...
*/
export class AwsUxcAccountCustomizations extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aws_uxc_account_customizations";
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsUxcAccountCustomizationsConfig = {}) {
    super(scope, id, {
