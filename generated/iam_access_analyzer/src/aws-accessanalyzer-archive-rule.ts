...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/accessanalyzer_archive_rule
...
*/
export class AwsArchiveRule extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsArchiveRuleConfig) {
    super(scope, id, {
  ...
  private _filter = new AwsArchiveRule.FilterPropertyList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: AwsArchiveRule.FilterProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktn.listMapper(awsArchiveRuleFilterPropertyToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktn.listMapperHcl(awsArchiveRuleFilterPropertyToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsArchiveRule.FilterPropertyList",
      },
    };
...
export function awsArchiveRuleFilterPropertyToTerraform(struct?: AwsArchiveRule.FilterProperty | cdktn.IResolvable): any {
...
export function awsArchiveRuleFilterPropertyToHclTerraform(struct?: AwsArchiveRule.FilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsArchiveRule {
