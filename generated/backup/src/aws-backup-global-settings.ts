...
export interface TfGlobalSettingsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_global_settings#global_settings TfGlobalSettings#global_settings}
  */
  readonly globalSettings: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_global_settings#id TfGlobalSettings#id}
  *
...
export class TfGlobalSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TfGlobalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_global_settings#import import section} in the documentation of this resource for the id to use
