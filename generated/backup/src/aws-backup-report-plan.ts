...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsReportPlanConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#description AwsReportPlan#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#id AwsReportPlan#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#name AwsReportPlan#name}
  */
  readonly name: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#region AwsReportPlan#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#tags AwsReportPlan#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#tags_all AwsReportPlan#tags_all}
  */
  readonly tagsAll?: { [key: string]: string };
  /**
  * report_delivery_channel block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#report_delivery_channel AwsReportPlan#report_delivery_channel}
  */
  readonly reportDeliveryChannel: AwsReportPlan.ReportDeliveryChannelProperty;
  /**
  * report_setting block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#report_setting AwsReportPlan#report_setting}
  */
  readonly reportSetting: AwsReportPlan.ReportSettingProperty;
}
...
*/
export class AwsReportPlan extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsReportPlan resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsReportPlan to import
  * @param importFromId The id of the existing AwsReportPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/backup_report_plan#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsReportPlan to import is found
  */
  ...
  * @param options AwsReportPlanConfig
  */
  public constructor(scope: Construct, id: string, config: AwsReportPlanConfig) {
    super(scope, id, {
  ...
  private _reportDeliveryChannel = new AwsReportPlan.ReportDeliveryChannelPropertyOutputReference(this, "report_delivery_channel");
  public get reportDeliveryChannel() {
    return this._reportDeliveryChannel;
  }
  public putReportDeliveryChannel(value: AwsReportPlan.ReportDeliveryChannelProperty) {
  ...
  private _reportSetting = new AwsReportPlan.ReportSettingPropertyOutputReference(this, "report_setting");
  public get reportSetting() {
    return this._reportSetting;
  }
  public putReportSetting(value: AwsReportPlan.ReportSettingProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      report_delivery_channel: awsReportPlanReportDeliveryChannelPropertyToTerraform(this._reportDeliveryChannel.internalValue),
      report_setting: awsReportPlanReportSettingPropertyToTerraform(this._reportSetting.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      report_delivery_channel: {
        value: awsReportPlanReportDeliveryChannelPropertyToHclTerraform(this._reportDeliveryChannel.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsReportPlan.ReportDeliveryChannelPropertyList",
      },
      report_setting: {
        value: awsReportPlanReportSettingPropertyToHclTerraform(this._reportSetting.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsReportPlan.ReportSettingPropertyList",
      },
    };
...
export function awsReportPlanReportDeliveryChannelPropertyToTerraform(struct?: AwsReportPlan.ReportDeliveryChannelPropertyOutputReference | AwsReportPlan.ReportDeliveryChannelProperty): any {
...
export function awsReportPlanReportDeliveryChannelPropertyToHclTerraform(struct?: AwsReportPlan.ReportDeliveryChannelPropertyOutputReference | AwsReportPlan.ReportDeliveryChannelProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsReportPlanReportSettingPropertyToTerraform(struct?: AwsReportPlan.ReportSettingPropertyOutputReference | AwsReportPlan.ReportSettingProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    number_of_frameworks: cdktn.numberToTerraform(struct!.numberOfFrameworks),
...
export function awsReportPlanReportSettingPropertyToHclTerraform(struct?: AwsReportPlan.ReportSettingPropertyOutputReference | AwsReportPlan.ReportSettingProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    number_of_frameworks: {
      value: cdktn.numberToHclTerraform(struct!.numberOfFrameworks),
      isBlock: false,
      type: "simple",
...
export namespace AwsReportPlan {
...
export class ReportDeliveryChannelPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ReportDeliveryChannelProperty | undefined {
  ...
  public set internalValue(value: ReportDeliveryChannelProperty | undefined) {
    if (value === undefined) {
...
export class ReportSettingPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ReportSettingProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ReportSettingProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
