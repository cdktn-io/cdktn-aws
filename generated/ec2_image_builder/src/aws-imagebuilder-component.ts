...
export interface AwsComponentConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsComponent extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsComponent resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsComponent to import
  * @param importFromId The id of the existing AwsComponent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/imagebuilder_component#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsComponent to import is found
  */
  ...
  * @param options AwsComponentConfig
  */
  public constructor(scope: Construct, id: string, config: AwsComponentConfig) {
    super(scope, id, {
