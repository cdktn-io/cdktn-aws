...
export interface AwsUserStackAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsUserStackAssociation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsUserStackAssociation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsUserStackAssociation to import
  * @param importFromId The id of the existing AwsUserStackAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appstream_user_stack_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsUserStackAssociation to import is found
  */
  ...
  * @param options AwsUserStackAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsUserStackAssociationConfig) {
    super(scope, id, {
