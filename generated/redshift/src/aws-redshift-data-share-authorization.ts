...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_data_share_authorization
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsRedshiftDataShareAuthorizationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_data_share_authorization#allow_writes AwsRedshiftDataShareAuthorization#allow_writes}
  */
  readonly allowWrites?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_data_share_authorization#consumer_identifier AwsRedshiftDataShareAuthorization#consumer_identifier}
  */
  readonly consumerIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_data_share_authorization#data_share_arn AwsRedshiftDataShareAuthorization#data_share_arn}
  */
  readonly dataShareArn: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_data_share_authorization#region AwsRedshiftDataShareAuthorization#region}
  */
...
*/
export class AwsRedshiftDataShareAuthorization extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsRedshiftDataShareAuthorization resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsRedshiftDataShareAuthorization to import
  * @param importFromId The id of the existing AwsRedshiftDataShareAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_data_share_authorization#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsRedshiftDataShareAuthorization to import is found
  */
  ...
  * @param options AwsRedshiftDataShareAuthorizationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsRedshiftDataShareAuthorizationConfig) {
    super(scope, id, {
