...
*/
export class DataAwsDataShares extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsDataSharesConfig = {}) {
    super(scope, id, {
  ...
  private _dataShares = new DataAwsDataShares.DataSharesPropertyList(this, "data_shares", false);
...
export function dataAwsDataSharesDataSharesPropertyToTerraform(struct?: DataAwsDataShares.DataSharesProperty): any {
...
export function dataAwsDataSharesDataSharesPropertyToHclTerraform(struct?: DataAwsDataShares.DataSharesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsDataShares {
