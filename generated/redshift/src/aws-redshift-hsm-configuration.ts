...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsRedshiftHsmConfigurationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#description AwsRedshiftHsmConfiguration#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#hsm_configuration_identifier AwsRedshiftHsmConfiguration#hsm_configuration_identifier}
  */
  readonly hsmConfigurationIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#hsm_ip_address AwsRedshiftHsmConfiguration#hsm_ip_address}
  */
  readonly hsmIpAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#hsm_partition_name AwsRedshiftHsmConfiguration#hsm_partition_name}
  */
  readonly hsmPartitionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#hsm_partition_password AwsRedshiftHsmConfiguration#hsm_partition_password}
  */
  readonly hsmPartitionPassword: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#hsm_server_public_certificate AwsRedshiftHsmConfiguration#hsm_server_public_certificate}
  */
  readonly hsmServerPublicCertificate: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#id AwsRedshiftHsmConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#region AwsRedshiftHsmConfiguration#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#tags AwsRedshiftHsmConfiguration#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#tags_all AwsRedshiftHsmConfiguration#tags_all}
  */
...
*/
export class AwsRedshiftHsmConfiguration extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsRedshiftHsmConfiguration resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsRedshiftHsmConfiguration to import
  * @param importFromId The id of the existing AwsRedshiftHsmConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsRedshiftHsmConfiguration to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_hsm_configuration aws_redshift_hsm_configuration} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AwsRedshiftHsmConfigurationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsRedshiftHsmConfigurationConfig) {
    super(scope, id, {
