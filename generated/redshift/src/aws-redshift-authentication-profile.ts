...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_authentication_profile
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsRedshiftAuthenticationProfileConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_authentication_profile#authentication_profile_content AwsRedshiftAuthenticationProfile#authentication_profile_content}
  */
  readonly authenticationProfileContent: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_authentication_profile#authentication_profile_name AwsRedshiftAuthenticationProfile#authentication_profile_name}
  */
  readonly authenticationProfileName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_authentication_profile#id AwsRedshiftAuthenticationProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_authentication_profile#region AwsRedshiftAuthenticationProfile#region}
  */
...
*/
export class AwsRedshiftAuthenticationProfile extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsRedshiftAuthenticationProfile resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsRedshiftAuthenticationProfile to import
  * @param importFromId The id of the existing AwsRedshiftAuthenticationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_authentication_profile#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsRedshiftAuthenticationProfile to import is found
  */
  ...
  * @param options AwsRedshiftAuthenticationProfileConfig
  */
  public constructor(scope: Construct, id: string, config: AwsRedshiftAuthenticationProfileConfig) {
    super(scope, id, {
