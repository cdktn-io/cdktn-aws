...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/redshift_namespace_registration
...
*/
export class AwsNamespaceRegistration extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsNamespaceRegistrationConfig) {
    super(scope, id, {
