...
export interface TfDataClusterConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/redshift_cluster#cluster_identifier TfDataCluster#cluster_identifier}
  */
  readonly clusterIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/redshift_cluster#id TfDataCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/redshift_cluster#region TfDataCluster#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/redshift_cluster#tags TfDataCluster#tags}
  */
...
export class TfDataCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing TfDataCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/redshift_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _clusterNodes = new TfDataCluster.ClusterNodesPropertyList(this, "cluster_nodes", false);
...
export function tfDataClusterClusterNodesPropertyToTerraform(struct?: TfDataCluster.ClusterNodesProperty): any {
...
export function tfDataClusterClusterNodesPropertyToHclTerraform(struct?: TfDataCluster.ClusterNodesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
