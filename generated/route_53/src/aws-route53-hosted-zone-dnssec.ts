...
*/
export class AwsHostedZoneDnssec extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsHostedZoneDnssecConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsHostedZoneDnssec.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsHostedZoneDnssec.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsHostedZoneDnssecTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsHostedZoneDnssecTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsHostedZoneDnssec.TimeoutsProperty",
      },
    };
...
export function awsHostedZoneDnssecTimeoutsPropertyToTerraform(struct?: AwsHostedZoneDnssec.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsHostedZoneDnssecTimeoutsPropertyToHclTerraform(struct?: AwsHostedZoneDnssec.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsHostedZoneDnssec {
