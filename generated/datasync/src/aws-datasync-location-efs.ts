...
export interface AwsDatasyncLocationEfsConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly ec2Config: AwsDatasyncLocationEfs.Ec2ConfigProperty;
}
...
*/
export class AwsDatasyncLocationEfs extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsDatasyncLocationEfs resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsDatasyncLocationEfs to import
  * @param importFromId The id of the existing AwsDatasyncLocationEfs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDatasyncLocationEfs to import is found
  */
  ...
  * @param options AwsDatasyncLocationEfsConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDatasyncLocationEfsConfig) {
    super(scope, id, {
  ...
  private _ec2Config = new AwsDatasyncLocationEfs.Ec2ConfigPropertyOutputReference(this, "ec2_config");
  public get ec2Config() {
    return this._ec2Config;
  }
  public putEc2Config(value: AwsDatasyncLocationEfs.Ec2ConfigProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ec2_config: awsDatasyncLocationEfsEc2ConfigPropertyToTerraform(this._ec2Config.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ec2_config: {
        value: awsDatasyncLocationEfsEc2ConfigPropertyToHclTerraform(this._ec2Config.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsDatasyncLocationEfs.Ec2ConfigPropertyList",
      },
    };
...
export function awsDatasyncLocationEfsEc2ConfigPropertyToTerraform(struct?: AwsDatasyncLocationEfs.Ec2ConfigPropertyOutputReference | AwsDatasyncLocationEfs.Ec2ConfigProperty): any {
...
export function awsDatasyncLocationEfsEc2ConfigPropertyToHclTerraform(struct?: AwsDatasyncLocationEfs.Ec2ConfigPropertyOutputReference | AwsDatasyncLocationEfs.Ec2ConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsDatasyncLocationEfs {
export interface Ec2ConfigProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#security_group_arns AwsDatasyncLocationEfs#security_group_arns}
  */
  readonly securityGroupArns: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#subnet_arn AwsDatasyncLocationEfs#subnet_arn}
  */
