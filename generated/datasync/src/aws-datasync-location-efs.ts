...
*/
export class AwsLocationEfs extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsLocationEfsConfig) {
    super(scope, id, {
  ...
  private _ec2Config = new AwsLocationEfs.Ec2ConfigPropertyOutputReference(this, "ec2_config");
  public get ec2Config() {
    return this._ec2Config;
  }
  public putEc2Config(value: AwsLocationEfs.Ec2ConfigProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ec2_config: awsLocationEfsEc2ConfigPropertyToTerraform(this._ec2Config.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ec2_config: {
        value: awsLocationEfsEc2ConfigPropertyToHclTerraform(this._ec2Config.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsLocationEfs.Ec2ConfigPropertyList",
      },
    };
...
export function awsLocationEfsEc2ConfigPropertyToTerraform(struct?: AwsLocationEfs.Ec2ConfigPropertyOutputReference | AwsLocationEfs.Ec2ConfigProperty): any {
...
export function awsLocationEfsEc2ConfigPropertyToHclTerraform(struct?: AwsLocationEfs.Ec2ConfigPropertyOutputReference | AwsLocationEfs.Ec2ConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsLocationEfs {
