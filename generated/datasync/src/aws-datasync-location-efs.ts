...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface TfLocationEfsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#access_point_arn TfLocationEfs#access_point_arn}
  */
  readonly accessPointArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#efs_file_system_arn TfLocationEfs#efs_file_system_arn}
  */
  readonly efsFileSystemArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#file_system_access_role_arn TfLocationEfs#file_system_access_role_arn}
  */
  readonly fileSystemAccessRoleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#id TfLocationEfs#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#in_transit_encryption TfLocationEfs#in_transit_encryption}
  */
  readonly inTransitEncryption?: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#region TfLocationEfs#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#subdirectory TfLocationEfs#subdirectory}
  */
  readonly subdirectory?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#tags TfLocationEfs#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#tags_all TfLocationEfs#tags_all}
  */
  readonly tagsAll?: { [key: string]: string };
  /**
  * ec2_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#ec2_config TfLocationEfs#ec2_config}
  */
  readonly ec2Config: TfLocationEfs.Ec2ConfigProperty;
}
...
*/
export class TfLocationEfs extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfLocationEfs resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfLocationEfs to import
  * @param importFromId The id of the existing TfLocationEfs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datasync_location_efs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfLocationEfs to import is found
  */
  ...
  * @param options TfLocationEfsConfig
  */
  public constructor(scope: Construct, id: string, config: TfLocationEfsConfig) {
    super(scope, id, {
  ...
  private _ec2Config = new TfLocationEfs.Ec2ConfigPropertyOutputReference(this, "ec2_config");
  public get ec2Config() {
    return this._ec2Config;
  }
  public putEc2Config(value: TfLocationEfs.Ec2ConfigProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ec2_config: tfLocationEfsEc2ConfigPropertyToTerraform(this._ec2Config.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ec2_config: {
        value: tfLocationEfsEc2ConfigPropertyToHclTerraform(this._ec2Config.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "TfLocationEfs.Ec2ConfigPropertyList",
      },
    };
...
export function tfLocationEfsEc2ConfigPropertyToTerraform(struct?: TfLocationEfs.Ec2ConfigPropertyOutputReference | TfLocationEfs.Ec2ConfigProperty): any {
...
export function tfLocationEfsEc2ConfigPropertyToHclTerraform(struct?: TfLocationEfs.Ec2ConfigPropertyOutputReference | TfLocationEfs.Ec2ConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfLocationEfs {
...
export class Ec2ConfigPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Ec2ConfigProperty | undefined {
  ...
  public set internalValue(value: Ec2ConfigProperty | undefined) {
    if (value === undefined) {
