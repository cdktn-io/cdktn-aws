...
export interface AwsDocdbClusterInstanceConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsDocdbClusterInstance.TimeoutsProperty;
}
...
*/
export class AwsDocdbClusterInstance extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsDocdbClusterInstance resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsDocdbClusterInstance to import
  * @param importFromId The id of the existing AwsDocdbClusterInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/docdb_cluster_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDocdbClusterInstance to import is found
  */
  ...
  * @param options AwsDocdbClusterInstanceConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDocdbClusterInstanceConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsDocdbClusterInstance.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsDocdbClusterInstance.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsDocdbClusterInstanceTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsDocdbClusterInstanceTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsDocdbClusterInstance.TimeoutsProperty",
      },
    };
...
export function awsDocdbClusterInstanceTimeoutsPropertyToTerraform(struct?: AwsDocdbClusterInstance.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsDocdbClusterInstanceTimeoutsPropertyToHclTerraform(struct?: AwsDocdbClusterInstance.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsDocdbClusterInstance {
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/docdb_cluster_instance#create AwsDocdbClusterInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/docdb_cluster_instance#delete AwsDocdbClusterInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/docdb_cluster_instance#update AwsDocdbClusterInstance#update}
  */
