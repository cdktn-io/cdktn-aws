...
*/
export class EphemeralTfRandomPassword extends cdktn.TerraformEphemeralResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: EphemeralTfRandomPasswordConfig = {}) {
    super(scope, id, {
