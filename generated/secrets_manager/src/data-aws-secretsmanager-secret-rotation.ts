...
export interface DataAwsSecretsmanagerSecretRotationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/secretsmanager_secret_rotation#id DataAwsSecretsmanagerSecretRotation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/secretsmanager_secret_rotation#region DataAwsSecretsmanagerSecretRotation#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/secretsmanager_secret_rotation#secret_id DataAwsSecretsmanagerSecretRotation#secret_id}
  */
...
export class DataAwsSecretsmanagerSecretRotation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSecretsmanagerSecretRotation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/secretsmanager_secret_rotation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _externalSecretRotationMetadata = new DataAwsSecretsmanagerSecretRotation.ExternalSecretRotationMetadataPropertyList(this, "external_secret_rotation_metadata", false);
  ...
  private _rotationRules = new DataAwsSecretsmanagerSecretRotation.RotationRulesPropertyList(this, "rotation_rules", false);
...
export function dataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadataPropertyToTerraform(struct?: DataAwsSecretsmanagerSecretRotation.ExternalSecretRotationMetadataProperty): any {
...
export function dataAwsSecretsmanagerSecretRotationExternalSecretRotationMetadataPropertyToHclTerraform(struct?: DataAwsSecretsmanagerSecretRotation.ExternalSecretRotationMetadataProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsSecretsmanagerSecretRotationRotationRulesPropertyToTerraform(struct?: DataAwsSecretsmanagerSecretRotation.RotationRulesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsSecretsmanagerSecretRotationRotationRulesPropertyToHclTerraform(struct?: DataAwsSecretsmanagerSecretRotation.RotationRulesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsSecretsmanagerSecretRotation {
