...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/secretsmanager_secret_version
...
*/
export class AwsSecretsmanagerSecretVersion extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsSecretsmanagerSecretVersionConfig) {
    super(scope, id, {
