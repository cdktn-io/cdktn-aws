...
export interface AwsDefaultCreditSpecificationConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsDefaultCreditSpecification.TimeoutsProperty;
}
...
*/
export class AwsDefaultCreditSpecification extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsDefaultCreditSpecification resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsDefaultCreditSpecification to import
  * @param importFromId The id of the existing AwsDefaultCreditSpecification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_default_credit_specification#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDefaultCreditSpecification to import is found
  */
  ...
  * @param options AwsDefaultCreditSpecificationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDefaultCreditSpecificationConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsDefaultCreditSpecification.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsDefaultCreditSpecification.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsDefaultCreditSpecificationTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsDefaultCreditSpecificationTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsDefaultCreditSpecification.TimeoutsProperty",
      },
    };
...
export function awsDefaultCreditSpecificationTimeoutsPropertyToTerraform(struct?: AwsDefaultCreditSpecification.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsDefaultCreditSpecificationTimeoutsPropertyToHclTerraform(struct?: AwsDefaultCreditSpecification.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsDefaultCreditSpecification {
export interface TimeoutsProperty {
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_default_credit_specification#create AwsDefaultCreditSpecification#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_default_credit_specification#update AwsDefaultCreditSpecification#update}
  */
