...
export interface DataAwsEc2PublicIpv4PoolConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsEc2PublicIpv4Pool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2PublicIpv4Pool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ec2_public_ipv4_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _poolAddressRanges = new DataAwsEc2PublicIpv4Pool.PoolAddressRangesPropertyList(this, "pool_address_ranges", false);
...
export function dataAwsEc2PublicIpv4PoolPoolAddressRangesPropertyToTerraform(struct?: DataAwsEc2PublicIpv4Pool.PoolAddressRangesProperty): any {
...
export function dataAwsEc2PublicIpv4PoolPoolAddressRangesPropertyToHclTerraform(struct?: DataAwsEc2PublicIpv4Pool.PoolAddressRangesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsEc2PublicIpv4Pool {
