...
export interface AwsCapacityBlockReservationConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsCapacityBlockReservation.TimeoutsProperty;
}
...
*/
export class AwsCapacityBlockReservation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsCapacityBlockReservation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsCapacityBlockReservation to import
  * @param importFromId The id of the existing AwsCapacityBlockReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_capacity_block_reservation#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCapacityBlockReservation to import is found
  */
  ...
  * @param options AwsCapacityBlockReservationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsCapacityBlockReservationConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsCapacityBlockReservation.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsCapacityBlockReservation.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsCapacityBlockReservationTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsCapacityBlockReservationTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsCapacityBlockReservation.TimeoutsProperty",
      },
    };
...
export function awsCapacityBlockReservationTimeoutsPropertyToTerraform(struct?: AwsCapacityBlockReservation.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsCapacityBlockReservationTimeoutsPropertyToHclTerraform(struct?: AwsCapacityBlockReservation.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsCapacityBlockReservation {
export interface TimeoutsProperty {
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_capacity_block_reservation#create AwsCapacityBlockReservation#create}
  */
