...
*/
export class TfCapacityBlockReservation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfCapacityBlockReservationConfig) {
    super(scope, id, {
  ...
  private _timeouts = new TfCapacityBlockReservation.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: TfCapacityBlockReservation.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: tfCapacityBlockReservationTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: tfCapacityBlockReservationTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "TfCapacityBlockReservation.TimeoutsProperty",
      },
    };
...
export function tfCapacityBlockReservationTimeoutsPropertyToTerraform(struct?: TfCapacityBlockReservation.TimeoutsProperty | cdktn.IResolvable): any {
...
export function tfCapacityBlockReservationTimeoutsPropertyToHclTerraform(struct?: TfCapacityBlockReservation.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfCapacityBlockReservation {
