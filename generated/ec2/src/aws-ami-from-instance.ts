...
export interface TfAmiFromInstanceConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#deprecation_time TfAmiFromInstance#deprecation_time}
  */
  readonly deprecationTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#description TfAmiFromInstance#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#id TfAmiFromInstance#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#name TfAmiFromInstance#name}
  */
  readonly name: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#region TfAmiFromInstance#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#snapshot_without_reboot TfAmiFromInstance#snapshot_without_reboot}
  */
  readonly snapshotWithoutReboot?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#source_instance_id TfAmiFromInstance#source_instance_id}
  */
  readonly sourceInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#tags TfAmiFromInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#tags_all TfAmiFromInstance#tags_all}
  */
  readonly tagsAll?: { [key: string]: string };
  /**
  * ebs_block_device block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#ebs_block_device TfAmiFromInstance#ebs_block_device}
  */
  readonly ebsBlockDevice?: TfAmiFromInstance.EbsBlockDeviceProperty[] | cdktn.IResolvable;
  /**
  * ephemeral_block_device block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#ephemeral_block_device TfAmiFromInstance#ephemeral_block_device}
  */
  readonly ephemeralBlockDevice?: TfAmiFromInstance.EphemeralBlockDeviceProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#timeouts TfAmiFromInstance#timeouts}
  */
  readonly timeouts?: TfAmiFromInstance.TimeoutsProperty;
}
...
*/
export class TfAmiFromInstance extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfAmiFromInstance resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfAmiFromInstance to import
  * @param importFromId The id of the existing TfAmiFromInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfAmiFromInstance to import is found
  */
  ...
  * @param options TfAmiFromInstanceConfig
  */
  public constructor(scope: Construct, id: string, config: TfAmiFromInstanceConfig) {
    super(scope, id, {
  ...
  private _ebsBlockDevice = new TfAmiFromInstance.EbsBlockDevicePropertyList(this, "ebs_block_device", true);
  public get ebsBlockDevice() {
    return this._ebsBlockDevice;
  }
  public putEbsBlockDevice(value: TfAmiFromInstance.EbsBlockDeviceProperty[] | cdktn.IResolvable) {
  ...
  private _ephemeralBlockDevice = new TfAmiFromInstance.EphemeralBlockDevicePropertyList(this, "ephemeral_block_device", true);
  public get ephemeralBlockDevice() {
    return this._ephemeralBlockDevice;
  }
  public putEphemeralBlockDevice(value: TfAmiFromInstance.EphemeralBlockDeviceProperty[] | cdktn.IResolvable) {
  ...
  private _timeouts = new TfAmiFromInstance.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: TfAmiFromInstance.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ebs_block_device: cdktn.listMapper(tfAmiFromInstanceEbsBlockDevicePropertyToTerraform, true)(this._ebsBlockDevice.internalValue),
      ephemeral_block_device: cdktn.listMapper(tfAmiFromInstanceEphemeralBlockDevicePropertyToTerraform, true)(this._ephemeralBlockDevice.internalValue),
      timeouts: tfAmiFromInstanceTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ebs_block_device: {
        value: cdktn.listMapperHcl(tfAmiFromInstanceEbsBlockDevicePropertyToHclTerraform, true)(this._ebsBlockDevice.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "TfAmiFromInstance.EbsBlockDevicePropertyList",
      },
      ephemeral_block_device: {
        value: cdktn.listMapperHcl(tfAmiFromInstanceEphemeralBlockDevicePropertyToHclTerraform, true)(this._ephemeralBlockDevice.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "TfAmiFromInstance.EphemeralBlockDevicePropertyList",
      },
      timeouts: {
        value: tfAmiFromInstanceTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "TfAmiFromInstance.TimeoutsProperty",
      },
    };
...
export function tfAmiFromInstanceEbsBlockDevicePropertyToTerraform(struct?: TfAmiFromInstance.EbsBlockDeviceProperty | cdktn.IResolvable): any {
...
export function tfAmiFromInstanceEbsBlockDevicePropertyToHclTerraform(struct?: TfAmiFromInstance.EbsBlockDeviceProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfAmiFromInstanceEphemeralBlockDevicePropertyToTerraform(struct?: TfAmiFromInstance.EphemeralBlockDeviceProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfAmiFromInstanceEphemeralBlockDevicePropertyToHclTerraform(struct?: TfAmiFromInstance.EphemeralBlockDeviceProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfAmiFromInstanceTimeoutsPropertyToTerraform(struct?: TfAmiFromInstance.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfAmiFromInstanceTimeoutsPropertyToHclTerraform(struct?: TfAmiFromInstance.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfAmiFromInstance {
...
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#create TfAmiFromInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#delete TfAmiFromInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ami_from_instance#update TfAmiFromInstance#update}
  */
