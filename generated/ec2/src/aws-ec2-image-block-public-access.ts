...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_image_block_public_access
...
*/
export class AwsEc2ImageBlockPublicAccess extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsEc2ImageBlockPublicAccessConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsEc2ImageBlockPublicAccess.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsEc2ImageBlockPublicAccess.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsEc2ImageBlockPublicAccessTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsEc2ImageBlockPublicAccessTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsEc2ImageBlockPublicAccess.TimeoutsProperty",
      },
    };
...
export function awsEc2ImageBlockPublicAccessTimeoutsPropertyToTerraform(struct?: AwsEc2ImageBlockPublicAccess.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsEc2ImageBlockPublicAccessTimeoutsPropertyToHclTerraform(struct?: AwsEc2ImageBlockPublicAccess.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsEc2ImageBlockPublicAccess {
