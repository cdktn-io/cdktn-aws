...
*/
export class DataAwsCapacityBlockOffering extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsCapacityBlockOfferingConfig) {
    super(scope, id, {
