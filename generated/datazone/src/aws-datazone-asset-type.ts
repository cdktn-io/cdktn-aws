...
export interface AwsAssetTypeConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly formsInput?: AwsAssetType.FormsInputProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: AwsAssetType.TimeoutsProperty;
}
...
*/
export class AwsAssetType extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsAssetType resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsAssetType to import
  * @param importFromId The id of the existing AwsAssetType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datazone_asset_type#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsAssetType to import is found
  */
  ...
  * @param options AwsAssetTypeConfig
  */
  public constructor(scope: Construct, id: string, config: AwsAssetTypeConfig) {
    super(scope, id, {
  ...
  private _formsInput = new AwsAssetType.FormsInputPropertyList(this, "forms_input", true);
  public get formsInput() {
    return this._formsInput;
  }
  public putFormsInput(value: AwsAssetType.FormsInputProperty[] | cdktn.IResolvable) {
  ...
  private _timeouts = new AwsAssetType.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsAssetType.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      forms_input: cdktn.listMapper(awsAssetTypeFormsInputPropertyToTerraform, true)(this._formsInput.internalValue),
      timeouts: awsAssetTypeTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      forms_input: {
        value: cdktn.listMapperHcl(awsAssetTypeFormsInputPropertyToHclTerraform, true)(this._formsInput.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsAssetType.FormsInputPropertyList",
      },
      timeouts: {
        value: awsAssetTypeTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsAssetType.TimeoutsProperty",
      },
    };
...
export function awsAssetTypeFormsInputPropertyToTerraform(struct?: AwsAssetType.FormsInputProperty | cdktn.IResolvable): any {
...
export function awsAssetTypeFormsInputPropertyToHclTerraform(struct?: AwsAssetType.FormsInputProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsAssetTypeTimeoutsPropertyToTerraform(struct?: AwsAssetType.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsAssetTypeTimeoutsPropertyToHclTerraform(struct?: AwsAssetType.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FormsInputPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FormsInputProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FormsInputProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class FormsInputPropertyList extends cdktn.ComplexList {
  public internalValue? : FormsInputProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): FormsInputPropertyOutputReference {
    return new FormsInputPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface TimeoutsProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/datazone_asset_type#create AwsAssetType#create}
  */
