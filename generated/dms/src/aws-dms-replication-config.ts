...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsReplicationConfigConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly computeConfig: AwsReplicationConfig.ComputeConfigProperty;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: AwsReplicationConfig.TimeoutsProperty;
}
...
*/
export class AwsReplicationConfig extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsReplicationConfig resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsReplicationConfig to import
  * @param importFromId The id of the existing AwsReplicationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsReplicationConfig to import is found
  */
  ...
  * @param options AwsReplicationConfigConfig
  */
  public constructor(scope: Construct, id: string, config: AwsReplicationConfigConfig) {
    super(scope, id, {
  ...
  private _computeConfig = new AwsReplicationConfig.ComputeConfigPropertyOutputReference(this, "compute_config");
  public get computeConfig() {
    return this._computeConfig;
  }
  public putComputeConfig(value: AwsReplicationConfig.ComputeConfigProperty) {
  ...
  private _timeouts = new AwsReplicationConfig.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsReplicationConfig.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      compute_config: awsReplicationConfigComputeConfigPropertyToTerraform(this._computeConfig.internalValue),
      timeouts: awsReplicationConfigTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      compute_config: {
        value: awsReplicationConfigComputeConfigPropertyToHclTerraform(this._computeConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsReplicationConfig.ComputeConfigPropertyList",
      },
      timeouts: {
        value: awsReplicationConfigTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsReplicationConfig.TimeoutsProperty",
      },
    };
...
export function awsReplicationConfigComputeConfigPropertyToTerraform(struct?: AwsReplicationConfig.ComputeConfigPropertyOutputReference | AwsReplicationConfig.ComputeConfigProperty): any {
...
export function awsReplicationConfigComputeConfigPropertyToHclTerraform(struct?: AwsReplicationConfig.ComputeConfigPropertyOutputReference | AwsReplicationConfig.ComputeConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsReplicationConfigTimeoutsPropertyToTerraform(struct?: AwsReplicationConfig.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsReplicationConfigTimeoutsPropertyToHclTerraform(struct?: AwsReplicationConfig.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsReplicationConfig {
export interface ComputeConfigProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#availability_zone AwsReplicationConfig#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#dns_name_servers AwsReplicationConfig#dns_name_servers}
  */
  readonly dnsNameServers?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#kms_key_id AwsReplicationConfig#kms_key_id}
  */
  readonly kmsKeyId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#max_capacity_units AwsReplicationConfig#max_capacity_units}
  */
  readonly maxCapacityUnits?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#min_capacity_units AwsReplicationConfig#min_capacity_units}
  */
  readonly minCapacityUnits?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#multi_az AwsReplicationConfig#multi_az}
  */
  readonly multiAz?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#preferred_maintenance_window AwsReplicationConfig#preferred_maintenance_window}
  */
  readonly preferredMaintenanceWindow?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#replication_subnet_group_id AwsReplicationConfig#replication_subnet_group_id}
  */
  readonly replicationSubnetGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_replication_config#vpc_security_group_ids AwsReplicationConfig#vpc_security_group_ids}
  */
