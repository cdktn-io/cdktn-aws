...
export interface AwsS3EndpointConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsS3Endpoint.TimeoutsProperty;
}
...
*/
export class AwsS3Endpoint extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the AwsS3Endpoint to import
  * @param importFromId The id of the existing AwsS3Endpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_s3_endpoint#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsS3Endpoint to import is found
  */
  ...
  * @param options AwsS3EndpointConfig
  */
  public constructor(scope: Construct, id: string, config: AwsS3EndpointConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsS3Endpoint.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsS3Endpoint.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsS3EndpointTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsS3EndpointTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsS3Endpoint.TimeoutsProperty",
      },
    };
...
export function awsS3EndpointTimeoutsPropertyToTerraform(struct?: AwsS3Endpoint.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsS3EndpointTimeoutsPropertyToHclTerraform(struct?: AwsS3Endpoint.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsS3Endpoint {
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_s3_endpoint#create AwsS3Endpoint#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dms_s3_endpoint#delete AwsS3Endpoint#delete}
  */
