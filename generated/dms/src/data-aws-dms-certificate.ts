...
export interface DataAwsDmsCertificateConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsDmsCertificate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDmsCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/dms_certificate#import import section} in the documentation of this resource for the id to use
