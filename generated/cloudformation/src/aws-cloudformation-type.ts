...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsTypeConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#execution_role_arn AwsType#execution_role_arn}
  */
  readonly executionRoleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#id AwsType#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#region AwsType#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#schema_handler_package AwsType#schema_handler_package}
  */
  readonly schemaHandlerPackage: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#type AwsType#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#type_name AwsType#type_name}
  */
  readonly typeName: string;
  /**
  * logging_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#logging_config AwsType#logging_config}
  */
  readonly loggingConfig?: AwsType.LoggingConfigProperty;
}
...
*/
export class AwsType extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsType resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsType to import
  * @param importFromId The id of the existing AwsType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloudformation_type#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsType to import is found
  */
  ...
  * @param options AwsTypeConfig
  */
  public constructor(scope: Construct, id: string, config: AwsTypeConfig) {
    super(scope, id, {
  ...
  private _loggingConfig = new AwsType.LoggingConfigPropertyOutputReference(this, "logging_config");
  public get loggingConfig() {
    return this._loggingConfig;
  }
  public putLoggingConfig(value: AwsType.LoggingConfigProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      logging_config: awsTypeLoggingConfigPropertyToTerraform(this._loggingConfig.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      logging_config: {
        value: awsTypeLoggingConfigPropertyToHclTerraform(this._loggingConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsType.LoggingConfigPropertyList",
      },
    };
...
export function awsTypeLoggingConfigPropertyToTerraform(struct?: AwsType.LoggingConfigPropertyOutputReference | AwsType.LoggingConfigProperty): any {
...
export function awsTypeLoggingConfigPropertyToHclTerraform(struct?: AwsType.LoggingConfigPropertyOutputReference | AwsType.LoggingConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
