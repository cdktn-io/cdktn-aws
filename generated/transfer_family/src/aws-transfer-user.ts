...
export class AwsUser extends cdktn.TerraformResource {
  ...
  */
  ...
  private _homeDirectoryMappings = new AwsUser.HomeDirectoryMappingsPropertyList(this, "home_directory_mappings", false);
  public get homeDirectoryMappings() {
    return this._homeDirectoryMappings;
  }
  public putHomeDirectoryMappings(value: AwsUser.HomeDirectoryMappingsProperty[] | cdktn.IResolvable) {
  ...
  private _posixProfile = new AwsUser.PosixProfilePropertyOutputReference(this, "posix_profile");
  public get posixProfile() {
    return this._posixProfile;
  }
  public putPosixProfile(value: AwsUser.PosixProfileProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      home_directory_mappings: cdktn.listMapper(awsUserHomeDirectoryMappingsPropertyToTerraform, true)(this._homeDirectoryMappings.internalValue),
      posix_profile: awsUserPosixProfilePropertyToTerraform(this._posixProfile.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      home_directory_mappings: {
        value: cdktn.listMapperHcl(awsUserHomeDirectoryMappingsPropertyToHclTerraform, true)(this._homeDirectoryMappings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsUser.HomeDirectoryMappingsPropertyList",
      },
      posix_profile: {
        value: awsUserPosixProfilePropertyToHclTerraform(this._posixProfile.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsUser.PosixProfilePropertyList",
      },
      timeouts: {
...
export function awsUserHomeDirectoryMappingsPropertyToTerraform(struct?: AwsUser.HomeDirectoryMappingsProperty | cdktn.IResolvable): any {
...
export function awsUserHomeDirectoryMappingsPropertyToHclTerraform(struct?: AwsUser.HomeDirectoryMappingsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsUserPosixProfilePropertyToTerraform(struct?: AwsUser.PosixProfilePropertyOutputReference | AwsUser.PosixProfileProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsUserPosixProfilePropertyToHclTerraform(struct?: AwsUser.PosixProfilePropertyOutputReference | AwsUser.PosixProfileProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
