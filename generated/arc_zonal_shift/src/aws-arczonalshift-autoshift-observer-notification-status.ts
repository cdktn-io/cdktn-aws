...
*/
export class TfAutoshiftObserverNotificationStatus extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfAutoshiftObserverNotificationStatusConfig) {
    super(scope, id, {
