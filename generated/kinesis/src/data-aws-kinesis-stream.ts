...
export class DataAwsKinesisStream extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKinesisStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/kinesis_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _streamModeDetails = new DataAwsKinesisStream.StreamModeDetailsPropertyList(this, "stream_mode_details", false);
  ...
  private _warmThroughput = new DataAwsKinesisStream.WarmThroughputPropertyList(this, "warm_throughput", false);
...
export function dataAwsKinesisStreamStreamModeDetailsPropertyToTerraform(struct?: DataAwsKinesisStream.StreamModeDetailsProperty): any {
...
export function dataAwsKinesisStreamStreamModeDetailsPropertyToHclTerraform(struct?: DataAwsKinesisStream.StreamModeDetailsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsKinesisStreamWarmThroughputPropertyToTerraform(struct?: DataAwsKinesisStream.WarmThroughputProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsKinesisStreamWarmThroughputPropertyToHclTerraform(struct?: DataAwsKinesisStream.WarmThroughputProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsKinesisStream {
