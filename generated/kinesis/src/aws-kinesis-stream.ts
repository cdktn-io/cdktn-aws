...
export interface AwsStreamConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly streamModeDetails?: AwsStream.StreamModeDetailsProperty;
  /**
  * timeouts block
  *
...
export class AwsStream extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/kinesis_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _streamModeDetails = new AwsStream.StreamModeDetailsPropertyOutputReference(this, "stream_mode_details");
  public get streamModeDetails() {
    return this._streamModeDetails;
  }
  public putStreamModeDetails(value: AwsStream.StreamModeDetailsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stream_mode_details: awsStreamStreamModeDetailsPropertyToTerraform(this._streamModeDetails.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stream_mode_details: {
        value: awsStreamStreamModeDetailsPropertyToHclTerraform(this._streamModeDetails.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsStream.StreamModeDetailsPropertyList",
      },
      timeouts: {
...
export function awsStreamStreamModeDetailsPropertyToTerraform(struct?: AwsStream.StreamModeDetailsPropertyOutputReference | AwsStream.StreamModeDetailsProperty): any {
...
export function awsStreamStreamModeDetailsPropertyToHclTerraform(struct?: AwsStream.StreamModeDetailsPropertyOutputReference | AwsStream.StreamModeDetailsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export interface StreamModeDetailsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/kinesis_stream#stream_mode AwsStream#stream_mode}
  */
