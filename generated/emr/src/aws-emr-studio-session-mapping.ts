...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/emr_studio_session_mapping
...
*/
export class AwsStudioSessionMapping extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsStudioSessionMappingConfig) {
    super(scope, id, {
