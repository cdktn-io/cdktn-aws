...
*/
export class DataAwsSupportedInstanceTypes extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsSupportedInstanceTypesConfig) {
    super(scope, id, {
  ...
  private _supportedInstanceTypes = new DataAwsSupportedInstanceTypes.SupportedInstanceTypesPropertyList(this, "supported_instance_types", false);
...
export function dataAwsSupportedInstanceTypesSupportedInstanceTypesPropertyToTerraform(struct?: DataAwsSupportedInstanceTypes.SupportedInstanceTypesProperty): any {
...
export function dataAwsSupportedInstanceTypesSupportedInstanceTypesPropertyToHclTerraform(struct?: DataAwsSupportedInstanceTypes.SupportedInstanceTypesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsSupportedInstanceTypes {
