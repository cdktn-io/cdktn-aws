...
export interface DataAwsEmrSupportedInstanceTypesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAwsEmrSupportedInstanceTypes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEmrSupportedInstanceTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/emr_supported_instance_types#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _supportedInstanceTypes = new DataAwsEmrSupportedInstanceTypes.SupportedInstanceTypesPropertyList(this, "supported_instance_types", false);
...
export function dataAwsEmrSupportedInstanceTypesSupportedInstanceTypesPropertyToTerraform(struct?: DataAwsEmrSupportedInstanceTypes.SupportedInstanceTypesProperty): any {
...
export function dataAwsEmrSupportedInstanceTypesSupportedInstanceTypesPropertyToHclTerraform(struct?: DataAwsEmrSupportedInstanceTypes.SupportedInstanceTypesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsEmrSupportedInstanceTypes {
