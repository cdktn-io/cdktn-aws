...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_domain
...
export class AwsDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _records = new AwsDomain.RecordsPropertyList(this, "records", false);
  public get records() {
...
export function awsDomainRecordsPropertyToTerraform(struct?: AwsDomain.RecordsProperty): any {
...
export function awsDomainRecordsPropertyToHclTerraform(struct?: AwsDomain.RecordsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class RecordsPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RecordsProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: RecordsProperty | undefined) {
    if (value === undefined) {
...
export class RecordsPropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): RecordsPropertyOutputReference {
    return new RecordsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
