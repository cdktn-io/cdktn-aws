...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user
...
export interface AwsUserConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#city AwsUser#city}
  */
  readonly city?: string;
  /**
  * Company associated with the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#company AwsUser#company}
  */
  readonly company?: string;
  /**
  * Country where the user is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#country AwsUser#country}
  */
  readonly country?: string;
  /**
  * Department associated with the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#department AwsUser#department}
  */
  readonly department?: string;
  /**
  * Display name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#display_name AwsUser#display_name}
  */
  readonly displayName: string;
  /**
  * Primary email address used to register the user with WorkMail.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#email AwsUser#email}
  */
  readonly email: string;
  /**
  * First name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#first_name AwsUser#first_name}
  */
  readonly firstName?: string;
  /**
  * Whether to hide the user from the global address list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#hidden_from_global_address_list AwsUser#hidden_from_global_address_list}
  */
  readonly hiddenFromGlobalAddressList?: boolean | cdktn.IResolvable;
  /**
  * User ID from IAM Identity Center associated with the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#identity_provider_user_id AwsUser#identity_provider_user_id}
  */
  readonly identityProviderUserId?: string;
  /**
  * Initials of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#initials AwsUser#initials}
  */
  readonly initials?: string;
  /**
  * Job title of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#job_title AwsUser#job_title}
  */
  readonly jobTitle?: string;
  /**
  * Last name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#last_name AwsUser#last_name}
  */
  readonly lastName?: string;
  /**
  * Username of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#name AwsUser#name}
  */
  readonly name: string;
  /**
  * Office where the user is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#office AwsUser#office}
  */
  readonly office?: string;
  /**
  * Identifier of the WorkMail organization where the user is managed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#organization_id AwsUser#organization_id}
  */
  readonly organizationId: string;
  /**
  * Password to set for the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#password AwsUser#password}
  */
  readonly password?: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#region AwsUser#region}
  */
  readonly region?: string;
  /**
  * Street address of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#street AwsUser#street}
  */
  readonly street?: string;
  /**
  * Telephone number of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#telephone AwsUser#telephone}
  */
  readonly telephone?: string;
  /**
  * Role assigned to the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#user_role AwsUser#user_role}
  */
  readonly userRole?: string;
  /**
  * ZIP or postal code of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#zip_code AwsUser#zip_code}
  */
...
export class AwsUser extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/workmail_user#import import section} in the documentation of this resource for the id to use
