...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lightsail_lb_certificate_attachment
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsLightsailLbCertificateAttachmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsLightsailLbCertificateAttachment extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsLightsailLbCertificateAttachment resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsLightsailLbCertificateAttachment to import
  * @param importFromId The id of the existing AwsLightsailLbCertificateAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lightsail_lb_certificate_attachment#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsLightsailLbCertificateAttachment to import is found
  */
  ...
  * @param options AwsLightsailLbCertificateAttachmentConfig
  */
  public constructor(scope: Construct, id: string, config: AwsLightsailLbCertificateAttachmentConfig) {
    super(scope, id, {
