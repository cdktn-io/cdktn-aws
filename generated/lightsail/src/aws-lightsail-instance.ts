...
export interface AwsInstanceConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly addOn?: AwsInstance.AddOnProperty;
}
...
export class AwsInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lightsail_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _addOn = new AwsInstance.AddOnPropertyOutputReference(this, "add_on");
  public get addOn() {
    return this._addOn;
  }
  public putAddOn(value: AwsInstance.AddOnProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      add_on: awsInstanceAddOnPropertyToTerraform(this._addOn.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      add_on: {
        value: awsInstanceAddOnPropertyToHclTerraform(this._addOn.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsInstance.AddOnPropertyList",
      },
    };
...
export function awsInstanceAddOnPropertyToTerraform(struct?: AwsInstance.AddOnPropertyOutputReference | AwsInstance.AddOnProperty): any {
...
export function awsInstanceAddOnPropertyToHclTerraform(struct?: AwsInstance.AddOnPropertyOutputReference | AwsInstance.AddOnProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
