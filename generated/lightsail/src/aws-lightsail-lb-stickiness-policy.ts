...
*/
export class AwsLightsailLbStickinessPolicy extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsLightsailLbStickinessPolicyConfig) {
    super(scope, id, {
