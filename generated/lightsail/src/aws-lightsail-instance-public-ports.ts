...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lightsail_instance_public_ports
...
*/
export class AwsInstancePublicPorts extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsInstancePublicPortsConfig) {
    super(scope, id, {
  ...
  private _portInfo = new AwsInstancePublicPorts.PortInfoPropertyList(this, "port_info", true);
  public get portInfo() {
    return this._portInfo;
  }
  public putPortInfo(value: AwsInstancePublicPorts.PortInfoProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      port_info: cdktn.listMapper(awsInstancePublicPortsPortInfoPropertyToTerraform, true)(this._portInfo.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      port_info: {
        value: cdktn.listMapperHcl(awsInstancePublicPortsPortInfoPropertyToHclTerraform, true)(this._portInfo.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsInstancePublicPorts.PortInfoPropertyList",
      },
    };
...
export function awsInstancePublicPortsPortInfoPropertyToTerraform(struct?: AwsInstancePublicPorts.PortInfoProperty | cdktn.IResolvable): any {
  ...
  return {
    ...
    ipv6_cidrs: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.ipv6Cidrs),
...
export function awsInstancePublicPortsPortInfoPropertyToHclTerraform(struct?: AwsInstancePublicPorts.PortInfoProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsInstancePublicPorts {
