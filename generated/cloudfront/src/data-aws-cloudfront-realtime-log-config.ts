...
export interface DataAwsCloudfrontRealtimeLogConfigConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsCloudfrontRealtimeLogConfig extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudfrontRealtimeLogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/cloudfront_realtime_log_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _endpoint = new DataAwsCloudfrontRealtimeLogConfig.EndpointPropertyList(this, "endpoint", false);
  public get endpoint() {
...
export function dataAwsCloudfrontRealtimeLogConfigKinesisStreamConfigPropertyToTerraform(struct?: DataAwsCloudfrontRealtimeLogConfig.KinesisStreamConfigProperty): any {
...
export function dataAwsCloudfrontRealtimeLogConfigKinesisStreamConfigPropertyToHclTerraform(struct?: DataAwsCloudfrontRealtimeLogConfig.KinesisStreamConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsCloudfrontRealtimeLogConfigEndpointPropertyToTerraform(struct?: DataAwsCloudfrontRealtimeLogConfig.EndpointProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsCloudfrontRealtimeLogConfigEndpointPropertyToHclTerraform(struct?: DataAwsCloudfrontRealtimeLogConfig.EndpointProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsCloudfrontRealtimeLogConfig {
