...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/cloudfront_realtime_log_config
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface TfDataRealtimeLogConfigConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/cloudfront_realtime_log_config#id TfDataRealtimeLogConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/cloudfront_realtime_log_config#name TfDataRealtimeLogConfig#name}
  */
...
*/
export class TfDataRealtimeLogConfig extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataRealtimeLogConfig resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataRealtimeLogConfig to import
  * @param importFromId The id of the existing TfDataRealtimeLogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/cloudfront_realtime_log_config#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataRealtimeLogConfig to import is found
  */
  ...
  * @param options TfDataRealtimeLogConfigConfig
  */
  public constructor(scope: Construct, id: string, config: TfDataRealtimeLogConfigConfig) {
    super(scope, id, {
  ...
  private _endpoint = new TfDataRealtimeLogConfig.EndpointPropertyList(this, "endpoint", false);
  public get endpoint() {
...
export function tfDataRealtimeLogConfigKinesisStreamConfigPropertyToTerraform(struct?: TfDataRealtimeLogConfig.KinesisStreamConfigProperty): any {
...
export function tfDataRealtimeLogConfigKinesisStreamConfigPropertyToHclTerraform(struct?: TfDataRealtimeLogConfig.KinesisStreamConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataRealtimeLogConfigEndpointPropertyToTerraform(struct?: TfDataRealtimeLogConfig.EndpointProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataRealtimeLogConfigEndpointPropertyToHclTerraform(struct?: TfDataRealtimeLogConfig.EndpointProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfDataRealtimeLogConfig {
