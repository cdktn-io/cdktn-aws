...
*/
export class AwsMonitoringSubscription extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsMonitoringSubscriptionConfig) {
    super(scope, id, {
  ...
  private _monitoringSubscription = new AwsMonitoringSubscription.MonitoringSubscriptionPropertyOutputReference(this, "monitoring_subscription");
  public get monitoringSubscription() {
    return this._monitoringSubscription;
  }
  public putMonitoringSubscription(value: AwsMonitoringSubscription.MonitoringSubscriptionProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      monitoring_subscription: awsMonitoringSubscriptionMonitoringSubscriptionPropertyToTerraform(this._monitoringSubscription.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      monitoring_subscription: {
        value: awsMonitoringSubscriptionMonitoringSubscriptionPropertyToHclTerraform(this._monitoringSubscription.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsMonitoringSubscription.MonitoringSubscriptionPropertyList",
      },
    };
...
export function awsMonitoringSubscriptionRealtimeMetricsSubscriptionConfigPropertyToTerraform(struct?: AwsMonitoringSubscription.RealtimeMetricsSubscriptionConfigPropertyOutputReference | AwsMonitoringSubscription.RealtimeMetricsSubscriptionConfigProperty): any {
...
export function awsMonitoringSubscriptionRealtimeMetricsSubscriptionConfigPropertyToHclTerraform(struct?: AwsMonitoringSubscription.RealtimeMetricsSubscriptionConfigPropertyOutputReference | AwsMonitoringSubscription.RealtimeMetricsSubscriptionConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsMonitoringSubscriptionMonitoringSubscriptionPropertyToTerraform(struct?: AwsMonitoringSubscription.MonitoringSubscriptionPropertyOutputReference | AwsMonitoringSubscription.MonitoringSubscriptionProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    realtime_metrics_subscription_config: awsMonitoringSubscriptionRealtimeMetricsSubscriptionConfigPropertyToTerraform(struct!.realtimeMetricsSubscriptionConfig),
  }
}


export function awsMonitoringSubscriptionMonitoringSubscriptionPropertyToHclTerraform(struct?: AwsMonitoringSubscription.MonitoringSubscriptionPropertyOutputReference | AwsMonitoringSubscription.MonitoringSubscriptionProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    realtime_metrics_subscription_config: {
      value: awsMonitoringSubscriptionRealtimeMetricsSubscriptionConfigPropertyToHclTerraform(struct!.realtimeMetricsSubscriptionConfig),
      isBlock: true,
      type: "list",
...
export namespace AwsMonitoringSubscription {
