...
*/
export class DataTfOriginAccessControl extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataTfOriginAccessControlConfig) {
    super(scope, id, {
