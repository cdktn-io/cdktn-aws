...
*/
export class AwsAnycastIpList extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsAnycastIpListConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsAnycastIpList.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsAnycastIpList.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsAnycastIpListTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsAnycastIpListTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsAnycastIpList.TimeoutsProperty",
      },
    };
...
export function awsAnycastIpListTimeoutsPropertyToTerraform(struct?: AwsAnycastIpList.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsAnycastIpListTimeoutsPropertyToHclTerraform(struct?: AwsAnycastIpList.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsAnycastIpList {
