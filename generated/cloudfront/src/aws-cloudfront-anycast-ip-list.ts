...
*/
export class TfAnycastIpList extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfAnycastIpListConfig) {
    super(scope, id, {
  ...
  private _timeouts = new TfAnycastIpList.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: TfAnycastIpList.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: tfAnycastIpListTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: tfAnycastIpListTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "TfAnycastIpList.TimeoutsProperty",
      },
    };
...
export function tfAnycastIpListTimeoutsPropertyToTerraform(struct?: TfAnycastIpList.TimeoutsProperty | cdktn.IResolvable): any {
...
export function tfAnycastIpListTimeoutsPropertyToHclTerraform(struct?: TfAnycastIpList.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfAnycastIpList {
