...
export interface DataAwsWafIpsetConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsWafIpset extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafIpset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/waf_ipset#import import section} in the documentation of this resource for the id to use
