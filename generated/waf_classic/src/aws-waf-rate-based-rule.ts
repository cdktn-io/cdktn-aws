...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule
...
export interface AwsRateBasedRuleConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#id AwsRateBasedRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#metric_name AwsRateBasedRule#metric_name}
  */
  readonly metricName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#name AwsRateBasedRule#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#rate_key AwsRateBasedRule#rate_key}
  */
  readonly rateKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#rate_limit AwsRateBasedRule#rate_limit}
  */
  readonly rateLimit: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#tags AwsRateBasedRule#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#tags_all AwsRateBasedRule#tags_all}
  */
  readonly tagsAll?: { [key: string]: string };
  /**
  * predicates block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#predicates AwsRateBasedRule#predicates}
  */
  readonly predicates?: AwsRateBasedRule.PredicatesProperty[] | cdktn.IResolvable;
}
...
export class AwsRateBasedRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsRateBasedRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/waf_rate_based_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _predicates = new AwsRateBasedRule.PredicatesPropertyList(this, "predicates", true);
  public get predicates() {
    return this._predicates;
  }
  public putPredicates(value: AwsRateBasedRule.PredicatesProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      predicates: cdktn.listMapper(awsRateBasedRulePredicatesPropertyToTerraform, true)(this._predicates.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      predicates: {
        value: cdktn.listMapperHcl(awsRateBasedRulePredicatesPropertyToHclTerraform, true)(this._predicates.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsRateBasedRule.PredicatesPropertyList",
      },
    };
...
export function awsRateBasedRulePredicatesPropertyToTerraform(struct?: AwsRateBasedRule.PredicatesProperty | cdktn.IResolvable): any {
...
export function awsRateBasedRulePredicatesPropertyToHclTerraform(struct?: AwsRateBasedRule.PredicatesProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
