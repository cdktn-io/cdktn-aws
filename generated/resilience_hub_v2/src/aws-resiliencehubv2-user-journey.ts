...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/resiliencehubv2_user_journey
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsUserJourneyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsUserJourney extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsUserJourney resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsUserJourney to import
  * @param importFromId The id of the existing AwsUserJourney that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/resiliencehubv2_user_journey#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsUserJourney to import is found
  */
  ...
  * @param options AwsUserJourneyConfig
  */
  public constructor(scope: Construct, id: string, config: AwsUserJourneyConfig) {
    super(scope, id, {
