...
export class DataAwsBatchJobQueue extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBatchJobQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/batch_job_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _computeEnvironmentOrder = new DataAwsBatchJobQueue.ComputeEnvironmentOrderPropertyList(this, "compute_environment_order", false);
  ...
  private _jobStateTimeLimitAction = new DataAwsBatchJobQueue.JobStateTimeLimitActionPropertyList(this, "job_state_time_limit_action", false);
...
export function dataAwsBatchJobQueueComputeEnvironmentOrderPropertyToTerraform(struct?: DataAwsBatchJobQueue.ComputeEnvironmentOrderProperty): any {
...
export function dataAwsBatchJobQueueComputeEnvironmentOrderPropertyToHclTerraform(struct?: DataAwsBatchJobQueue.ComputeEnvironmentOrderProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsBatchJobQueueJobStateTimeLimitActionPropertyToTerraform(struct?: DataAwsBatchJobQueue.JobStateTimeLimitActionProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsBatchJobQueueJobStateTimeLimitActionPropertyToHclTerraform(struct?: DataAwsBatchJobQueue.JobStateTimeLimitActionProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsBatchJobQueue {
