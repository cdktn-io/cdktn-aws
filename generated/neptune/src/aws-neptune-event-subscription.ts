...
export interface AwsNeptuneEventSubscriptionConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsNeptuneEventSubscription.TimeoutsProperty;
}
...
*/
export class AwsNeptuneEventSubscription extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsNeptuneEventSubscription resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsNeptuneEventSubscription to import
  * @param importFromId The id of the existing AwsNeptuneEventSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/neptune_event_subscription#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsNeptuneEventSubscription to import is found
  */
  ...
  * @param options AwsNeptuneEventSubscriptionConfig
  */
  public constructor(scope: Construct, id: string, config: AwsNeptuneEventSubscriptionConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsNeptuneEventSubscription.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsNeptuneEventSubscription.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsNeptuneEventSubscriptionTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsNeptuneEventSubscriptionTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsNeptuneEventSubscription.TimeoutsProperty",
      },
    };
...
export function awsNeptuneEventSubscriptionTimeoutsPropertyToTerraform(struct?: AwsNeptuneEventSubscription.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsNeptuneEventSubscriptionTimeoutsPropertyToHclTerraform(struct?: AwsNeptuneEventSubscription.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsNeptuneEventSubscription {
