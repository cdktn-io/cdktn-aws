...
export class DataAwsOrderableDbInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrderableDbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/neptune_orderable_db_instance#import import section} in the documentation of this resource for the id to use
