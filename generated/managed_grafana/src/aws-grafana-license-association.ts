...
*/
export class AwsGrafanaLicenseAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsGrafanaLicenseAssociationConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsGrafanaLicenseAssociation.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsGrafanaLicenseAssociation.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsGrafanaLicenseAssociationTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsGrafanaLicenseAssociationTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsGrafanaLicenseAssociation.TimeoutsProperty",
      },
    };
...
export function awsGrafanaLicenseAssociationTimeoutsPropertyToTerraform(struct?: AwsGrafanaLicenseAssociation.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsGrafanaLicenseAssociationTimeoutsPropertyToHclTerraform(struct?: AwsGrafanaLicenseAssociation.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsGrafanaLicenseAssociation {
