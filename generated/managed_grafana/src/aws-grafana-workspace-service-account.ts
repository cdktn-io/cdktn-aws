...
*/
export class AwsGrafanaWorkspaceServiceAccount extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsGrafanaWorkspaceServiceAccountConfig) {
    super(scope, id, {
