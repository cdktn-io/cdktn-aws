...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/rekognition_collection
...
*/
export class AwsRekognitionCollection extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsRekognitionCollectionConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsRekognitionCollection.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsRekognitionCollection.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsRekognitionCollectionTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsRekognitionCollectionTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsRekognitionCollection.TimeoutsProperty",
      },
    };
...
export function awsRekognitionCollectionTimeoutsPropertyToTerraform(struct?: AwsRekognitionCollection.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsRekognitionCollectionTimeoutsPropertyToHclTerraform(struct?: AwsRekognitionCollection.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsRekognitionCollection {
