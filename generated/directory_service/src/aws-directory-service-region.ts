...
export interface AwsRegionConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly vpcSettings: AwsRegion.VpcSettingsProperty;
}
...
export class AwsRegion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/directory_service_region#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _vpcSettings = new AwsRegion.VpcSettingsPropertyOutputReference(this, "vpc_settings");
  public get vpcSettings() {
    return this._vpcSettings;
  }
  public putVpcSettings(value: AwsRegion.VpcSettingsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      vpc_settings: awsRegionVpcSettingsPropertyToTerraform(this._vpcSettings.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      vpc_settings: {
        value: awsRegionVpcSettingsPropertyToHclTerraform(this._vpcSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsRegion.VpcSettingsPropertyList",
      },
    };
...
export function awsRegionVpcSettingsPropertyToTerraform(struct?: AwsRegion.VpcSettingsPropertyOutputReference | AwsRegion.VpcSettingsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsRegionVpcSettingsPropertyToHclTerraform(struct?: AwsRegion.VpcSettingsPropertyOutputReference | AwsRegion.VpcSettingsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/directory_service_region#create AwsRegion#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/directory_service_region#delete AwsRegion#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/directory_service_region#update AwsRegion#update}
  */
