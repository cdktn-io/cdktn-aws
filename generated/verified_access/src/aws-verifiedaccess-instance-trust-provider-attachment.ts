...
*/
export class AwsVerifiedaccessInstanceTrustProviderAttachment extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsVerifiedaccessInstanceTrustProviderAttachmentConfig) {
    super(scope, id, {
