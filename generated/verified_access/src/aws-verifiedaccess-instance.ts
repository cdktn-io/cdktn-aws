...
export class AwsInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/verifiedaccess_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _verifiedAccessTrustProviders = new AwsInstance.VerifiedAccessTrustProvidersPropertyList(this, "verified_access_trust_providers", false);
...
export function awsInstanceVerifiedAccessTrustProvidersPropertyToTerraform(struct?: AwsInstance.VerifiedAccessTrustProvidersProperty): any {
...
export function awsInstanceVerifiedAccessTrustProvidersPropertyToHclTerraform(struct?: AwsInstance.VerifiedAccessTrustProvidersProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
