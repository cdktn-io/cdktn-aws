...
export class TfInstance extends cdktn.TerraformResource {
  ...
  */
  ...
  private _verifiedAccessTrustProviders = new TfInstance.VerifiedAccessTrustProvidersPropertyList(this, "verified_access_trust_providers", false);
...
export function tfInstanceVerifiedAccessTrustProvidersPropertyToTerraform(struct?: TfInstance.VerifiedAccessTrustProvidersProperty): any {
...
export function tfInstanceVerifiedAccessTrustProvidersPropertyToHclTerraform(struct?: TfInstance.VerifiedAccessTrustProvidersProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
