...
export interface AwsCeAnomalyMonitorConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsCeAnomalyMonitor extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsCeAnomalyMonitor resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsCeAnomalyMonitor to import
  * @param importFromId The id of the existing AwsCeAnomalyMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ce_anomaly_monitor#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCeAnomalyMonitor to import is found
  */
  ...
  * @param options AwsCeAnomalyMonitorConfig
  */
  public constructor(scope: Construct, id: string, config: AwsCeAnomalyMonitorConfig) {
    super(scope, id, {
