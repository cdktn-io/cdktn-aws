...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_resource_server
...
*/
export class AwsResourceServer extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsResourceServerConfig) {
    super(scope, id, {
  ...
  private _scope = new AwsResourceServer.ScopePropertyList(this, "scope", true);
  public get scope() {
    return this._scope;
  }
  public putScope(value: AwsResourceServer.ScopeProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      scope: cdktn.listMapper(awsResourceServerScopePropertyToTerraform, true)(this._scope.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      scope: {
        value: cdktn.listMapperHcl(awsResourceServerScopePropertyToHclTerraform, true)(this._scope.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsResourceServer.ScopePropertyList",
      },
    };
...
export function awsResourceServerScopePropertyToTerraform(struct?: AwsResourceServer.ScopeProperty | cdktn.IResolvable): any {
...
export function awsResourceServerScopePropertyToHclTerraform(struct?: AwsResourceServer.ScopeProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsResourceServer {
