...
export interface AwsCognitoManagedUserPoolClientConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly analyticsConfiguration?: AwsCognitoManagedUserPoolClient.AnalyticsConfigurationProperty[] | cdktn.IResolvable;
  /**
  ...
  */
  readonly refreshTokenRotation?: AwsCognitoManagedUserPoolClient.RefreshTokenRotationProperty[] | cdktn.IResolvable;
  /**
  ...
  */
  readonly tokenValidityUnits?: AwsCognitoManagedUserPoolClient.TokenValidityUnitsProperty[] | cdktn.IResolvable;
}
...
*/
export class AwsCognitoManagedUserPoolClient extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the AwsCognitoManagedUserPoolClient to import
  * @param importFromId The id of the existing AwsCognitoManagedUserPoolClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_managed_user_pool_client#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCognitoManagedUserPoolClient to import is found
  */
  ...
  * @param options AwsCognitoManagedUserPoolClientConfig
  */
  public constructor(scope: Construct, id: string, config: AwsCognitoManagedUserPoolClientConfig) {
    super(scope, id, {
  ...
  private _analyticsConfiguration = new AwsCognitoManagedUserPoolClient.AnalyticsConfigurationPropertyList(this, "analytics_configuration", false);
  public get analyticsConfiguration() {
    return this._analyticsConfiguration;
  }
  public putAnalyticsConfiguration(value: AwsCognitoManagedUserPoolClient.AnalyticsConfigurationProperty[] | cdktn.IResolvable) {
  ...
  private _refreshTokenRotation = new AwsCognitoManagedUserPoolClient.RefreshTokenRotationPropertyList(this, "refresh_token_rotation", false);
  public get refreshTokenRotation() {
    return this._refreshTokenRotation;
  }
  public putRefreshTokenRotation(value: AwsCognitoManagedUserPoolClient.RefreshTokenRotationProperty[] | cdktn.IResolvable) {
  ...
  private _tokenValidityUnits = new AwsCognitoManagedUserPoolClient.TokenValidityUnitsPropertyList(this, "token_validity_units", false);
  public get tokenValidityUnits() {
    return this._tokenValidityUnits;
  }
  public putTokenValidityUnits(value: AwsCognitoManagedUserPoolClient.TokenValidityUnitsProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      analytics_configuration: cdktn.listMapper(awsCognitoManagedUserPoolClientAnalyticsConfigurationPropertyToTerraform, true)(this._analyticsConfiguration.internalValue),
      refresh_token_rotation: cdktn.listMapper(awsCognitoManagedUserPoolClientRefreshTokenRotationPropertyToTerraform, true)(this._refreshTokenRotation.internalValue),
      token_validity_units: cdktn.listMapper(awsCognitoManagedUserPoolClientTokenValidityUnitsPropertyToTerraform, true)(this._tokenValidityUnits.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      analytics_configuration: {
        value: cdktn.listMapperHcl(awsCognitoManagedUserPoolClientAnalyticsConfigurationPropertyToHclTerraform, true)(this._analyticsConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsCognitoManagedUserPoolClient.AnalyticsConfigurationPropertyList",
      },
      refresh_token_rotation: {
        value: cdktn.listMapperHcl(awsCognitoManagedUserPoolClientRefreshTokenRotationPropertyToHclTerraform, true)(this._refreshTokenRotation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsCognitoManagedUserPoolClient.RefreshTokenRotationPropertyList",
      },
      token_validity_units: {
        value: cdktn.listMapperHcl(awsCognitoManagedUserPoolClientTokenValidityUnitsPropertyToHclTerraform, true)(this._tokenValidityUnits.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsCognitoManagedUserPoolClient.TokenValidityUnitsPropertyList",
      },
    };
...
export function awsCognitoManagedUserPoolClientAnalyticsConfigurationPropertyToTerraform(struct?: AwsCognitoManagedUserPoolClient.AnalyticsConfigurationProperty | cdktn.IResolvable): any {
...
export function awsCognitoManagedUserPoolClientAnalyticsConfigurationPropertyToHclTerraform(struct?: AwsCognitoManagedUserPoolClient.AnalyticsConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsCognitoManagedUserPoolClientRefreshTokenRotationPropertyToTerraform(struct?: AwsCognitoManagedUserPoolClient.RefreshTokenRotationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsCognitoManagedUserPoolClientRefreshTokenRotationPropertyToHclTerraform(struct?: AwsCognitoManagedUserPoolClient.RefreshTokenRotationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsCognitoManagedUserPoolClientTokenValidityUnitsPropertyToTerraform(struct?: AwsCognitoManagedUserPoolClient.TokenValidityUnitsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsCognitoManagedUserPoolClientTokenValidityUnitsPropertyToHclTerraform(struct?: AwsCognitoManagedUserPoolClient.TokenValidityUnitsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsCognitoManagedUserPoolClient {
export interface AnalyticsConfigurationProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_managed_user_pool_client#application_arn AwsCognitoManagedUserPoolClient#application_arn}
  */
  readonly applicationArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_managed_user_pool_client#application_id AwsCognitoManagedUserPoolClient#application_id}
  */
  readonly applicationId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_managed_user_pool_client#external_id AwsCognitoManagedUserPoolClient#external_id}
  */
  readonly externalId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_managed_user_pool_client#role_arn AwsCognitoManagedUserPoolClient#role_arn}
  */
  readonly roleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cognito_managed_user_pool_client#user_data_shared AwsCognitoManagedUserPoolClient#user_data_shared}
  */
