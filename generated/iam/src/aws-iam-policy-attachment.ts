...
export interface AwsIamPolicyAttachmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsIamPolicyAttachment extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsIamPolicyAttachment resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsIamPolicyAttachment to import
  * @param importFromId The id of the existing AwsIamPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_policy_attachment#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsIamPolicyAttachment to import is found
  */
  ...
  * @param options AwsIamPolicyAttachmentConfig
  */
  public constructor(scope: Construct, id: string, config: AwsIamPolicyAttachmentConfig) {
    super(scope, id, {
