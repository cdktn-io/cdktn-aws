...
*/
export class TfServiceSpecificCredential extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfServiceSpecificCredentialConfig) {
    super(scope, id, {
