...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsIamServiceSpecificCredentialConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#credential_age_days AwsIamServiceSpecificCredential#credential_age_days}
  */
  readonly credentialAgeDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#id AwsIamServiceSpecificCredential#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#service_name AwsIamServiceSpecificCredential#service_name}
  */
  readonly serviceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#status AwsIamServiceSpecificCredential#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#user_name AwsIamServiceSpecificCredential#user_name}
  */
...
*/
export class AwsIamServiceSpecificCredential extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsIamServiceSpecificCredential resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsIamServiceSpecificCredential to import
  * @param importFromId The id of the existing AwsIamServiceSpecificCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsIamServiceSpecificCredential to import is found
  */
  ...
  * @param options AwsIamServiceSpecificCredentialConfig
  */
  public constructor(scope: Construct, id: string, config: AwsIamServiceSpecificCredentialConfig) {
    super(scope, id, {
