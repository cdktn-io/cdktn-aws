...
export interface AwsServiceSpecificCredentialConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#credential_age_days AwsServiceSpecificCredential#credential_age_days}
  */
  readonly credentialAgeDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#id AwsServiceSpecificCredential#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#service_name AwsServiceSpecificCredential#service_name}
  */
  readonly serviceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#status AwsServiceSpecificCredential#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#user_name AwsServiceSpecificCredential#user_name}
  */
...
*/
export class AwsServiceSpecificCredential extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsServiceSpecificCredential resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsServiceSpecificCredential to import
  * @param importFromId The id of the existing AwsServiceSpecificCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_service_specific_credential#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsServiceSpecificCredential to import is found
  */
  ...
  * @param options AwsServiceSpecificCredentialConfig
  */
  public constructor(scope: Construct, id: string, config: AwsServiceSpecificCredentialConfig) {
    super(scope, id, {
