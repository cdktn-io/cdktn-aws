...
export interface AwsIamAccessKeyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsIamAccessKey extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsIamAccessKey resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsIamAccessKey to import
  * @param importFromId The id of the existing AwsIamAccessKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_access_key#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsIamAccessKey to import is found
  */
  ...
  * @param options AwsIamAccessKeyConfig
  */
  public constructor(scope: Construct, id: string, config: AwsIamAccessKeyConfig) {
    super(scope, id, {
