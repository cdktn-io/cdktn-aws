...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_openid_connect_provider
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsIamOpenidConnectProviderConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsIamOpenidConnectProvider extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsIamOpenidConnectProvider resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsIamOpenidConnectProvider to import
  * @param importFromId The id of the existing AwsIamOpenidConnectProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_openid_connect_provider#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsIamOpenidConnectProvider to import is found
  */
  ...
  * @param options AwsIamOpenidConnectProviderConfig
  */
  public constructor(scope: Construct, id: string, config: AwsIamOpenidConnectProviderConfig) {
    super(scope, id, {
