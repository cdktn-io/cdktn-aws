...
export interface DataAwsIamRolePolicyAttachmentsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/iam_role_policy_attachments#path_prefix DataAwsIamRolePolicyAttachments#path_prefix}
  */
  readonly pathPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/iam_role_policy_attachments#role_name DataAwsIamRolePolicyAttachments#role_name}
  */
...
export class DataAwsIamRolePolicyAttachments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamRolePolicyAttachments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/iam_role_policy_attachments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _attachedPolicies = new DataAwsIamRolePolicyAttachments.AttachedPoliciesPropertyList(this, "attached_policies", false);
...
export function dataAwsIamRolePolicyAttachmentsAttachedPoliciesPropertyToTerraform(struct?: DataAwsIamRolePolicyAttachments.AttachedPoliciesProperty): any {
...
export function dataAwsIamRolePolicyAttachmentsAttachedPoliciesPropertyToHclTerraform(struct?: DataAwsIamRolePolicyAttachments.AttachedPoliciesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsIamRolePolicyAttachments {
