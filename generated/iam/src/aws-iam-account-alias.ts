...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_account_alias
...
*/
export class AwsAccountAlias extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsAccountAliasConfig) {
    super(scope, id, {
