...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_group_membership
...
export class AwsGroupMembership extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iam_group_membership aws_iam_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
