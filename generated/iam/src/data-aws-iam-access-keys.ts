...
*/
export class DataAwsAccessKeys extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsAccessKeysConfig) {
    super(scope, id, {
  ...
  private _accessKeys = new DataAwsAccessKeys.AccessKeysPropertyList(this, "access_keys", true);
...
export function dataAwsAccessKeysAccessKeysPropertyToTerraform(struct?: DataAwsAccessKeys.AccessKeysProperty): any {
...
export function dataAwsAccessKeysAccessKeysPropertyToHclTerraform(struct?: DataAwsAccessKeys.AccessKeysProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsAccessKeys {
