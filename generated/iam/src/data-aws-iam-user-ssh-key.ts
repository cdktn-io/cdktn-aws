...
export interface DataTfUserSshKeyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataTfUserSshKey extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataTfUserSshKey resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataTfUserSshKey to import
  * @param importFromId The id of the existing DataTfUserSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/iam_user_ssh_key#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataTfUserSshKey to import is found
  */
  ...
  * @param options DataTfUserSshKeyConfig
  */
  public constructor(scope: Construct, id: string, config: DataTfUserSshKeyConfig) {
    super(scope, id, {
