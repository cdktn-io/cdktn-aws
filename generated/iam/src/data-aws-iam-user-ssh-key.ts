...
export interface DataAwsUserSshKeyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsUserSshKey extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsUserSshKey resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsUserSshKey to import
  * @param importFromId The id of the existing DataAwsUserSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/iam_user_ssh_key#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsUserSshKey to import is found
  */
  ...
  * @param options DataAwsUserSshKeyConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsUserSshKeyConfig) {
    super(scope, id, {
