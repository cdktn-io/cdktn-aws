...
export interface AwsCloud9EnvironmentMembershipConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsCloud9EnvironmentMembership extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsCloud9EnvironmentMembership resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsCloud9EnvironmentMembership to import
  * @param importFromId The id of the existing AwsCloud9EnvironmentMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/cloud9_environment_membership#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCloud9EnvironmentMembership to import is found
  */
  ...
  * @param options AwsCloud9EnvironmentMembershipConfig
  */
  public constructor(scope: Construct, id: string, config: AwsCloud9EnvironmentMembershipConfig) {
    super(scope, id, {
