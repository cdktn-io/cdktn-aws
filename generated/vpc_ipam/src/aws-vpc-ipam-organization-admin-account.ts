...
export interface TfOrganizationAdminAccountConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_ipam_organization_admin_account#delegated_admin_account_id TfOrganizationAdminAccount#delegated_admin_account_id}
  */
  readonly delegatedAdminAccountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_ipam_organization_admin_account#id TfOrganizationAdminAccount#id}
  *
...
export class TfOrganizationAdminAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TfOrganizationAdminAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_ipam_organization_admin_account#import import section} in the documentation of this resource for the id to use
