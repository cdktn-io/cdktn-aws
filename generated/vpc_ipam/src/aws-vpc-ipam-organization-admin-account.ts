...
*/
export class AwsVpcIpamOrganizationAdminAccount extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsVpcIpamOrganizationAdminAccountConfig) {
    super(scope, id, {
