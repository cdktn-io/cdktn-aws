...
export class AwsOrganizationAdminAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsOrganizationAdminAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_ipam_organization_admin_account#import import section} in the documentation of this resource for the id to use
