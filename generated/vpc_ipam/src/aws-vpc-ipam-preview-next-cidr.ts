...
export interface AwsVpcIpamPreviewNextCidrConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsVpcIpamPreviewNextCidr extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsVpcIpamPreviewNextCidr resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsVpcIpamPreviewNextCidr to import
  * @param importFromId The id of the existing AwsVpcIpamPreviewNextCidr that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_ipam_preview_next_cidr#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsVpcIpamPreviewNextCidr to import is found
  */
  ...
  * @param options AwsVpcIpamPreviewNextCidrConfig
  */
  public constructor(scope: Construct, id: string, config: AwsVpcIpamPreviewNextCidrConfig) {
    super(scope, id, {
