...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_ipam_pool
...
export class AwsPool extends cdktn.TerraformResource {
  ...
  */
  ...
  private _sourceResource = new AwsPool.SourceResourcePropertyOutputReference(this, "source_resource");
  public get sourceResource() {
    return this._sourceResource;
  }
  public putSourceResource(value: AwsPool.SourceResourceProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      source_resource: awsPoolSourceResourcePropertyToTerraform(this._sourceResource.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      source_resource: {
        value: awsPoolSourceResourcePropertyToHclTerraform(this._sourceResource.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsPool.SourceResourcePropertyList",
      },
      timeouts: {
...
export function awsPoolSourceResourcePropertyToTerraform(struct?: AwsPool.SourceResourcePropertyOutputReference | AwsPool.SourceResourceProperty): any {
...
export function awsPoolSourceResourcePropertyToHclTerraform(struct?: AwsPool.SourceResourcePropertyOutputReference | AwsPool.SourceResourceProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
