...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/vpc_ipam
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataAwsVpcIpamConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsVpcIpam extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcIpam that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/vpc_ipam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _operatingRegions = new DataAwsVpcIpam.OperatingRegionsPropertyList(this, "operating_regions", false);
...
export function dataAwsVpcIpamOperatingRegionsPropertyToTerraform(struct?: DataAwsVpcIpam.OperatingRegionsProperty): any {
...
export function dataAwsVpcIpamOperatingRegionsPropertyToHclTerraform(struct?: DataAwsVpcIpam.OperatingRegionsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsVpcIpam {
