...
export class DataAwsArcregionswitchRoute53HealthChecks extends cdktn.TerraformDataSource {
  ...
  */
  ...
  private _healthChecks = new DataAwsArcregionswitchRoute53HealthChecks.HealthChecksPropertyList(this, "health_checks", false);
...
export function dataAwsArcregionswitchRoute53HealthChecksHealthChecksPropertyToTerraform(struct?: DataAwsArcregionswitchRoute53HealthChecks.HealthChecksProperty): any {
...
export function dataAwsArcregionswitchRoute53HealthChecksHealthChecksPropertyToHclTerraform(struct?: DataAwsArcregionswitchRoute53HealthChecks.HealthChecksProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsArcregionswitchRoute53HealthChecks {
