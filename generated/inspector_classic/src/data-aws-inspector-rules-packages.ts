...
export interface DataAwsInspectorRulesPackagesConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsInspectorRulesPackages extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsInspectorRulesPackages that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/inspector_rules_packages#import import section} in the documentation of this resource for the id to use
