...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/savingsplans_savings_plan
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataAwsSavingsPlanConfig extends cdktn.TerraformMetaArguments {
  /**
  * The ID of the Savings Plan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/savingsplans_savings_plan#savings_plan_id DataAwsSavingsPlan#savings_plan_id}
  */
...
*/
export class DataAwsSavingsPlan extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsSavingsPlan resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsSavingsPlan to import
  * @param importFromId The id of the existing DataAwsSavingsPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/savingsplans_savings_plan#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsSavingsPlan to import is found
  */
  ...
  * @param options DataAwsSavingsPlanConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsSavingsPlanConfig) {
    super(scope, id, {
