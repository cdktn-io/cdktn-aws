...
export interface AwsTelemetryRuleForOrganizationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#region AwsTelemetryRuleForOrganization#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#rule_name AwsTelemetryRuleForOrganization#rule_name}
  */
  readonly ruleName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#tags AwsTelemetryRuleForOrganization#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#rule AwsTelemetryRuleForOrganization#rule}
  */
  readonly rule?: AwsTelemetryRuleForOrganization.RuleProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#timeouts AwsTelemetryRuleForOrganization#timeouts}
  */
  readonly timeouts?: AwsTelemetryRuleForOrganization.TimeoutsProperty;
}
...
*/
export class AwsTelemetryRuleForOrganization extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsTelemetryRuleForOrganization resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsTelemetryRuleForOrganization to import
  * @param importFromId The id of the existing AwsTelemetryRuleForOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsTelemetryRuleForOrganization to import is found
  */
  ...
  * @param options AwsTelemetryRuleForOrganizationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsTelemetryRuleForOrganizationConfig) {
    super(scope, id, {
  ...
  private _rule = new AwsTelemetryRuleForOrganization.RulePropertyList(this, "rule", false);
  public get rule() {
    return this._rule;
  }
  public putRule(value: AwsTelemetryRuleForOrganization.RuleProperty[] | cdktn.IResolvable) {
  ...
  private _timeouts = new AwsTelemetryRuleForOrganization.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsTelemetryRuleForOrganization.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rule: cdktn.listMapper(awsTelemetryRuleForOrganizationRulePropertyToTerraform, true)(this._rule.internalValue),
      timeouts: awsTelemetryRuleForOrganizationTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rule: {
        value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationRulePropertyToHclTerraform, true)(this._rule.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsTelemetryRuleForOrganization.RulePropertyList",
      },
      timeouts: {
        value: awsTelemetryRuleForOrganizationTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsTelemetryRuleForOrganization.TimeoutsProperty",
      },
    };
...
export function awsTelemetryRuleForOrganizationFieldSelectorsPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.FieldSelectorsProperty | cdktn.IResolvable): any {
...
export function awsTelemetryRuleForOrganizationFieldSelectorsPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.FieldSelectorsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationAdvancedEventSelectorsPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.AdvancedEventSelectorsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    field_selectors: cdktn.listMapper(awsTelemetryRuleForOrganizationFieldSelectorsPropertyToTerraform, true)(struct!.fieldSelectors),
  }
}


export function awsTelemetryRuleForOrganizationAdvancedEventSelectorsPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.AdvancedEventSelectorsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    field_selectors: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationFieldSelectorsPropertyToHclTerraform, true)(struct!.fieldSelectors),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationCloudtrailParametersPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.CloudtrailParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    advanced_event_selectors: cdktn.listMapper(awsTelemetryRuleForOrganizationAdvancedEventSelectorsPropertyToTerraform, true)(struct!.advancedEventSelectors),
  }
}


export function awsTelemetryRuleForOrganizationCloudtrailParametersPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.CloudtrailParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    advanced_event_selectors: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationAdvancedEventSelectorsPropertyToHclTerraform, true)(struct!.advancedEventSelectors),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationElbLoadBalancerLoggingParametersPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.ElbLoadBalancerLoggingParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationElbLoadBalancerLoggingParametersPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.ElbLoadBalancerLoggingParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationLogDeliveryParametersPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.LogDeliveryParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationLogDeliveryParametersPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.LogDeliveryParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationMskMonitoringParametersPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.MskMonitoringParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationMskMonitoringParametersPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.MskMonitoringParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationVpcFlowLogParametersPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.VpcFlowLogParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationVpcFlowLogParametersPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.VpcFlowLogParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationActionConditionPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.ActionConditionProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationActionConditionPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.ActionConditionProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationLabelNameConditionPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.LabelNameConditionProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationLabelNameConditionPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.LabelNameConditionProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationConditionsPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.ConditionsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    action_condition: cdktn.listMapper(awsTelemetryRuleForOrganizationActionConditionPropertyToTerraform, true)(struct!.actionCondition),
    label_name_condition: cdktn.listMapper(awsTelemetryRuleForOrganizationLabelNameConditionPropertyToTerraform, true)(struct!.labelNameCondition),
  }
}


export function awsTelemetryRuleForOrganizationConditionsPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.ConditionsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    action_condition: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationActionConditionPropertyToHclTerraform, true)(struct!.actionCondition),
      isBlock: true,
      type: "list",
      storageClassType: "ActionConditionPropertyList",
    },
    label_name_condition: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationLabelNameConditionPropertyToHclTerraform, true)(struct!.labelNameCondition),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationFiltersPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.FiltersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    conditions: cdktn.listMapper(awsTelemetryRuleForOrganizationConditionsPropertyToTerraform, true)(struct!.conditions),
  }
}


export function awsTelemetryRuleForOrganizationFiltersPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.FiltersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    conditions: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationConditionsPropertyToHclTerraform, true)(struct!.conditions),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationLoggingFilterPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.LoggingFilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    filters: cdktn.listMapper(awsTelemetryRuleForOrganizationFiltersPropertyToTerraform, true)(struct!.filters),
  }
}


export function awsTelemetryRuleForOrganizationLoggingFilterPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.LoggingFilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    filters: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationFiltersPropertyToHclTerraform, true)(struct!.filters),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationSingleHeaderPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.SingleHeaderProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationSingleHeaderPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.SingleHeaderProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationRedactedFieldsPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.RedactedFieldsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    single_header: cdktn.listMapper(awsTelemetryRuleForOrganizationSingleHeaderPropertyToTerraform, true)(struct!.singleHeader),
  }
}


export function awsTelemetryRuleForOrganizationRedactedFieldsPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.RedactedFieldsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    single_header: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationSingleHeaderPropertyToHclTerraform, true)(struct!.singleHeader),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationWafLoggingParametersPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.WafLoggingParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    logging_filter: cdktn.listMapper(awsTelemetryRuleForOrganizationLoggingFilterPropertyToTerraform, true)(struct!.loggingFilter),
    redacted_fields: cdktn.listMapper(awsTelemetryRuleForOrganizationRedactedFieldsPropertyToTerraform, true)(struct!.redactedFields),
  }
}


export function awsTelemetryRuleForOrganizationWafLoggingParametersPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.WafLoggingParametersProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    logging_filter: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationLoggingFilterPropertyToHclTerraform, true)(struct!.loggingFilter),
      isBlock: true,
      type: "list",
      storageClassType: "LoggingFilterPropertyList",
    },
    redacted_fields: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationRedactedFieldsPropertyToHclTerraform, true)(struct!.redactedFields),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationDestinationConfigurationPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.DestinationConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    cloudtrail_parameters: cdktn.listMapper(awsTelemetryRuleForOrganizationCloudtrailParametersPropertyToTerraform, true)(struct!.cloudtrailParameters),
    elb_load_balancer_logging_parameters: cdktn.listMapper(awsTelemetryRuleForOrganizationElbLoadBalancerLoggingParametersPropertyToTerraform, true)(struct!.elbLoadBalancerLoggingParameters),
    log_delivery_parameters: cdktn.listMapper(awsTelemetryRuleForOrganizationLogDeliveryParametersPropertyToTerraform, true)(struct!.logDeliveryParameters),
    msk_monitoring_parameters: cdktn.listMapper(awsTelemetryRuleForOrganizationMskMonitoringParametersPropertyToTerraform, true)(struct!.mskMonitoringParameters),
    vpc_flow_log_parameters: cdktn.listMapper(awsTelemetryRuleForOrganizationVpcFlowLogParametersPropertyToTerraform, true)(struct!.vpcFlowLogParameters),
    waf_logging_parameters: cdktn.listMapper(awsTelemetryRuleForOrganizationWafLoggingParametersPropertyToTerraform, true)(struct!.wafLoggingParameters),
  }
}


export function awsTelemetryRuleForOrganizationDestinationConfigurationPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.DestinationConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    cloudtrail_parameters: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationCloudtrailParametersPropertyToHclTerraform, true)(struct!.cloudtrailParameters),
      isBlock: true,
      type: "list",
      storageClassType: "CloudtrailParametersPropertyList",
    },
    elb_load_balancer_logging_parameters: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationElbLoadBalancerLoggingParametersPropertyToHclTerraform, true)(struct!.elbLoadBalancerLoggingParameters),
      isBlock: true,
      type: "list",
      storageClassType: "ElbLoadBalancerLoggingParametersPropertyList",
    },
    log_delivery_parameters: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationLogDeliveryParametersPropertyToHclTerraform, true)(struct!.logDeliveryParameters),
      isBlock: true,
      type: "list",
      storageClassType: "LogDeliveryParametersPropertyList",
    },
    msk_monitoring_parameters: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationMskMonitoringParametersPropertyToHclTerraform, true)(struct!.mskMonitoringParameters),
      isBlock: true,
      type: "list",
      storageClassType: "MskMonitoringParametersPropertyList",
    },
    vpc_flow_log_parameters: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationVpcFlowLogParametersPropertyToHclTerraform, true)(struct!.vpcFlowLogParameters),
      isBlock: true,
      type: "list",
      storageClassType: "VpcFlowLogParametersPropertyList",
    },
    waf_logging_parameters: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationWafLoggingParametersPropertyToHclTerraform, true)(struct!.wafLoggingParameters),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationRulePropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.RuleProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    destination_configuration: cdktn.listMapper(awsTelemetryRuleForOrganizationDestinationConfigurationPropertyToTerraform, true)(struct!.destinationConfiguration),
  }
}


export function awsTelemetryRuleForOrganizationRulePropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.RuleProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    destination_configuration: {
      value: cdktn.listMapperHcl(awsTelemetryRuleForOrganizationDestinationConfigurationPropertyToHclTerraform, true)(struct!.destinationConfiguration),
      isBlock: true,
      type: "list",
...
export function awsTelemetryRuleForOrganizationTimeoutsPropertyToTerraform(struct?: AwsTelemetryRuleForOrganization.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTelemetryRuleForOrganizationTimeoutsPropertyToHclTerraform(struct?: AwsTelemetryRuleForOrganization.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsTelemetryRuleForOrganization {
...
export interface CloudtrailParametersProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#advanced_event_selectors AwsTelemetryRuleForOrganization#advanced_event_selectors}
  */
...
export interface ElbLoadBalancerLoggingParametersProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#field_delimiter AwsTelemetryRuleForOrganization#field_delimiter}
  */
  readonly fieldDelimiter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#output_format AwsTelemetryRuleForOrganization#output_format}
  */
...
export interface LogDeliveryParametersProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#log_types AwsTelemetryRuleForOrganization#log_types}
  */
...
export interface MskMonitoringParametersProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#enhanced_monitoring AwsTelemetryRuleForOrganization#enhanced_monitoring}
  */
...
export interface ActionConditionProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#action AwsTelemetryRuleForOrganization#action}
  */
...
export interface LabelNameConditionProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#label_name AwsTelemetryRuleForOrganization#label_name}
  */
...
export interface ConditionsProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#action_condition AwsTelemetryRuleForOrganization#action_condition}
  */
  readonly actionCondition?: ActionConditionProperty[] | cdktn.IResolvable;
  /**
  * label_name_condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#label_name_condition AwsTelemetryRuleForOrganization#label_name_condition}
  */
...
export interface RedactedFieldsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#method AwsTelemetryRuleForOrganization#method}
  */
  readonly method?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#query_string AwsTelemetryRuleForOrganization#query_string}
  */
  readonly queryString?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#uri_path AwsTelemetryRuleForOrganization#uri_path}
  */
  readonly uriPath?: string;
  /**
  * single_header block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#single_header AwsTelemetryRuleForOrganization#single_header}
  */
...
export interface TimeoutsProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#create AwsTelemetryRuleForOrganization#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#delete AwsTelemetryRuleForOrganization#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_rule_for_organization#update AwsTelemetryRuleForOrganization#update}
  */
