...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/observabilityadmin_telemetry_evaluation_for_organization
...
*/
export class AwsObservabilityadminTelemetryEvaluationForOrganization extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aws_observabilityadmin_telemetry_evaluation_for_organization";
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsObservabilityadminTelemetryEvaluationForOrganizationConfig = {}) {
    super(scope, id, {
  ...
  private _timeouts = new AwsObservabilityadminTelemetryEvaluationForOrganization.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsObservabilityadminTelemetryEvaluationForOrganization.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsObservabilityadminTelemetryEvaluationForOrganizationTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsObservabilityadminTelemetryEvaluationForOrganizationTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsObservabilityadminTelemetryEvaluationForOrganization.TimeoutsProperty",
      },
    };
...
export function awsObservabilityadminTelemetryEvaluationForOrganizationTimeoutsPropertyToTerraform(struct?: AwsObservabilityadminTelemetryEvaluationForOrganization.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsObservabilityadminTelemetryEvaluationForOrganizationTimeoutsPropertyToHclTerraform(struct?: AwsObservabilityadminTelemetryEvaluationForOrganization.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsObservabilityadminTelemetryEvaluationForOrganization {
