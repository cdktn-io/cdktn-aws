...
export interface AwsEc2TransitGatewayConnectPeerConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsEc2TransitGatewayConnectPeer.TimeoutsProperty;
}
...
*/
export class AwsEc2TransitGatewayConnectPeer extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsEc2TransitGatewayConnectPeer resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsEc2TransitGatewayConnectPeer to import
  * @param importFromId The id of the existing AwsEc2TransitGatewayConnectPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_transit_gateway_connect_peer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsEc2TransitGatewayConnectPeer to import is found
  */
  ...
  * @param options AwsEc2TransitGatewayConnectPeerConfig
  */
  public constructor(scope: Construct, id: string, config: AwsEc2TransitGatewayConnectPeerConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsEc2TransitGatewayConnectPeer.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsEc2TransitGatewayConnectPeer.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsEc2TransitGatewayConnectPeerTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsEc2TransitGatewayConnectPeerTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsEc2TransitGatewayConnectPeer.TimeoutsProperty",
      },
    };
...
export function awsEc2TransitGatewayConnectPeerTimeoutsPropertyToTerraform(struct?: AwsEc2TransitGatewayConnectPeer.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsEc2TransitGatewayConnectPeerTimeoutsPropertyToHclTerraform(struct?: AwsEc2TransitGatewayConnectPeer.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsEc2TransitGatewayConnectPeer {
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_transit_gateway_connect_peer#create AwsEc2TransitGatewayConnectPeer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_transit_gateway_connect_peer#delete AwsEc2TransitGatewayConnectPeer#delete}
  */
