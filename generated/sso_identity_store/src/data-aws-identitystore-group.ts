...
export class DataAwsGroup extends cdktn.TerraformDataSource {
  ...
  */
  ...
  private _externalIds = new DataAwsGroup.ExternalIdsPropertyList(this, "external_ids", false);
  ...
  private _alternateIdentifier = new DataAwsGroup.AlternateIdentifierPropertyOutputReference(this, "alternate_identifier");
  public get alternateIdentifier() {
    return this._alternateIdentifier;
  }
  public putAlternateIdentifier(value: DataAwsGroup.AlternateIdentifierProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      alternate_identifier: dataAwsGroupAlternateIdentifierPropertyToTerraform(this._alternateIdentifier.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      alternate_identifier: {
        value: dataAwsGroupAlternateIdentifierPropertyToHclTerraform(this._alternateIdentifier.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataAwsGroup.AlternateIdentifierPropertyList",
      },
    };
...
export function dataAwsGroupExternalIdsPropertyToTerraform(struct?: DataAwsGroup.ExternalIdsProperty): any {
...
export function dataAwsGroupExternalIdsPropertyToHclTerraform(struct?: DataAwsGroup.ExternalIdsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsGroupExternalIdPropertyToTerraform(struct?: DataAwsGroup.ExternalIdPropertyOutputReference | DataAwsGroup.ExternalIdProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsGroupExternalIdPropertyToHclTerraform(struct?: DataAwsGroup.ExternalIdPropertyOutputReference | DataAwsGroup.ExternalIdProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsGroupUniqueAttributePropertyToTerraform(struct?: DataAwsGroup.UniqueAttributePropertyOutputReference | DataAwsGroup.UniqueAttributeProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsGroupUniqueAttributePropertyToHclTerraform(struct?: DataAwsGroup.UniqueAttributePropertyOutputReference | DataAwsGroup.UniqueAttributeProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsGroupAlternateIdentifierPropertyToTerraform(struct?: DataAwsGroup.AlternateIdentifierPropertyOutputReference | DataAwsGroup.AlternateIdentifierProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    external_id: dataAwsGroupExternalIdPropertyToTerraform(struct!.externalId),
    unique_attribute: dataAwsGroupUniqueAttributePropertyToTerraform(struct!.uniqueAttribute),
  }
}


export function dataAwsGroupAlternateIdentifierPropertyToHclTerraform(struct?: DataAwsGroup.AlternateIdentifierPropertyOutputReference | DataAwsGroup.AlternateIdentifierProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    external_id: {
      value: dataAwsGroupExternalIdPropertyToHclTerraform(struct!.externalId),
      isBlock: true,
      type: "list",
      storageClassType: "ExternalIdPropertyList",
    },
    unique_attribute: {
      value: dataAwsGroupUniqueAttributePropertyToHclTerraform(struct!.uniqueAttribute),
      isBlock: true,
      type: "list",
