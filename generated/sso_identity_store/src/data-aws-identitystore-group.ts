...
export interface DataTfGroupConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/identitystore_group#group_id DataTfGroup#group_id}
  */
  readonly groupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/identitystore_group#id DataTfGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/identitystore_group#identity_store_id DataTfGroup#identity_store_id}
  */
  readonly identityStoreId: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/identitystore_group#region DataTfGroup#region}
  */
  readonly region?: string;
  /**
  * alternate_identifier block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/identitystore_group#alternate_identifier DataTfGroup#alternate_identifier}
  */
  readonly alternateIdentifier?: DataTfGroup.AlternateIdentifierProperty;
}
...
export class DataTfGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTfGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/identitystore_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _externalIds = new DataTfGroup.ExternalIdsPropertyList(this, "external_ids", false);
  ...
  private _alternateIdentifier = new DataTfGroup.AlternateIdentifierPropertyOutputReference(this, "alternate_identifier");
  public get alternateIdentifier() {
    return this._alternateIdentifier;
  }
  public putAlternateIdentifier(value: DataTfGroup.AlternateIdentifierProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      alternate_identifier: dataTfGroupAlternateIdentifierPropertyToTerraform(this._alternateIdentifier.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      alternate_identifier: {
        value: dataTfGroupAlternateIdentifierPropertyToHclTerraform(this._alternateIdentifier.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataTfGroup.AlternateIdentifierPropertyList",
      },
    };
...
export function dataTfGroupExternalIdsPropertyToTerraform(struct?: DataTfGroup.ExternalIdsProperty): any {
...
export function dataTfGroupExternalIdsPropertyToHclTerraform(struct?: DataTfGroup.ExternalIdsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfGroupExternalIdPropertyToTerraform(struct?: DataTfGroup.ExternalIdPropertyOutputReference | DataTfGroup.ExternalIdProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfGroupExternalIdPropertyToHclTerraform(struct?: DataTfGroup.ExternalIdPropertyOutputReference | DataTfGroup.ExternalIdProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfGroupUniqueAttributePropertyToTerraform(struct?: DataTfGroup.UniqueAttributePropertyOutputReference | DataTfGroup.UniqueAttributeProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfGroupUniqueAttributePropertyToHclTerraform(struct?: DataTfGroup.UniqueAttributePropertyOutputReference | DataTfGroup.UniqueAttributeProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataTfGroupAlternateIdentifierPropertyToTerraform(struct?: DataTfGroup.AlternateIdentifierPropertyOutputReference | DataTfGroup.AlternateIdentifierProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    external_id: dataTfGroupExternalIdPropertyToTerraform(struct!.externalId),
    unique_attribute: dataTfGroupUniqueAttributePropertyToTerraform(struct!.uniqueAttribute),
  }
}


export function dataTfGroupAlternateIdentifierPropertyToHclTerraform(struct?: DataTfGroup.AlternateIdentifierPropertyOutputReference | DataTfGroup.AlternateIdentifierProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    external_id: {
      value: dataTfGroupExternalIdPropertyToHclTerraform(struct!.externalId),
      isBlock: true,
      type: "list",
      storageClassType: "ExternalIdPropertyList",
    },
    unique_attribute: {
      value: dataTfGroupUniqueAttributePropertyToHclTerraform(struct!.uniqueAttribute),
      isBlock: true,
      type: "list",
...
export interface ExternalIdProperty {
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/identitystore_group#issuer DataTfGroup#issuer}
  */
