...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/codepipeline_webhook
...
*/
export class AwsCodepipelineWebhook extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsCodepipelineWebhookConfig) {
    super(scope, id, {
  ...
  private _authenticationConfiguration = new AwsCodepipelineWebhook.AuthenticationConfigurationPropertyOutputReference(this, "authentication_configuration");
  public get authenticationConfiguration() {
    return this._authenticationConfiguration;
  }
  public putAuthenticationConfiguration(value: AwsCodepipelineWebhook.AuthenticationConfigurationProperty) {
  ...
  private _filter = new AwsCodepipelineWebhook.FilterPropertyList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: AwsCodepipelineWebhook.FilterProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      authentication_configuration: awsCodepipelineWebhookAuthenticationConfigurationPropertyToTerraform(this._authenticationConfiguration.internalValue),
      filter: cdktn.listMapper(awsCodepipelineWebhookFilterPropertyToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      authentication_configuration: {
        value: awsCodepipelineWebhookAuthenticationConfigurationPropertyToHclTerraform(this._authenticationConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsCodepipelineWebhook.AuthenticationConfigurationPropertyList",
      },
      filter: {
        value: cdktn.listMapperHcl(awsCodepipelineWebhookFilterPropertyToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsCodepipelineWebhook.FilterPropertyList",
      },
    };
...
export function awsCodepipelineWebhookAuthenticationConfigurationPropertyToTerraform(struct?: AwsCodepipelineWebhook.AuthenticationConfigurationPropertyOutputReference | AwsCodepipelineWebhook.AuthenticationConfigurationProperty): any {
...
export function awsCodepipelineWebhookAuthenticationConfigurationPropertyToHclTerraform(struct?: AwsCodepipelineWebhook.AuthenticationConfigurationPropertyOutputReference | AwsCodepipelineWebhook.AuthenticationConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsCodepipelineWebhookFilterPropertyToTerraform(struct?: AwsCodepipelineWebhook.FilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsCodepipelineWebhookFilterPropertyToHclTerraform(struct?: AwsCodepipelineWebhook.FilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsCodepipelineWebhook {
