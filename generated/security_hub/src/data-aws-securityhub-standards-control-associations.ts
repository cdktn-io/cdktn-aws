...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/securityhub_standards_control_associations
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface TfDataStandardsControlAssociationsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/securityhub_standards_control_associations#region TfDataStandardsControlAssociations#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/securityhub_standards_control_associations#security_control_id TfDataStandardsControlAssociations#security_control_id}
  */
...
*/
export class TfDataStandardsControlAssociations extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataStandardsControlAssociations resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataStandardsControlAssociations to import
  * @param importFromId The id of the existing TfDataStandardsControlAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/securityhub_standards_control_associations#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataStandardsControlAssociations to import is found
  */
  ...
  * @param options TfDataStandardsControlAssociationsConfig
  */
  public constructor(scope: Construct, id: string, config: TfDataStandardsControlAssociationsConfig) {
    super(scope, id, {
  ...
  private _standardsControlAssociations = new TfDataStandardsControlAssociations.StandardsControlAssociationsPropertyList(this, "standards_control_associations", false);
...
export function tfDataStandardsControlAssociationsStandardsControlAssociationsPropertyToTerraform(struct?: TfDataStandardsControlAssociations.StandardsControlAssociationsProperty): any {
...
export function tfDataStandardsControlAssociationsStandardsControlAssociationsPropertyToHclTerraform(struct?: TfDataStandardsControlAssociations.StandardsControlAssociationsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfDataStandardsControlAssociations {
...
export class StandardsControlAssociationsPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): StandardsControlAssociationsProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: StandardsControlAssociationsProperty | undefined) {
    if (value === undefined) {
...
export class StandardsControlAssociationsPropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): StandardsControlAssociationsPropertyOutputReference {
    return new StandardsControlAssociationsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
