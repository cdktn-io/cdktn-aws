...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/securityhub_feature_v2
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsFeatureV2Config extends cdktn.TerraformMetaArguments {
  /**
  * The name of the opt-in feature to enable. Valid values: NETWORK_SCANNING.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/securityhub_feature_v2#feature_name AwsFeatureV2#feature_name}
  */
  readonly featureName: string;
  /**
  * The current enablement status of the feature. Valid values: ENABLED, DISABLED.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/securityhub_feature_v2#feature_status AwsFeatureV2#feature_status}
  */
  readonly featureStatus: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/securityhub_feature_v2#region AwsFeatureV2#region}
  */
...
*/
export class AwsFeatureV2 extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsFeatureV2 resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsFeatureV2 to import
  * @param importFromId The id of the existing AwsFeatureV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/securityhub_feature_v2#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsFeatureV2 to import is found
  */
  ...
  * @param options AwsFeatureV2Config
  */
  public constructor(scope: Construct, id: string, config: AwsFeatureV2Config) {
    super(scope, id, {
