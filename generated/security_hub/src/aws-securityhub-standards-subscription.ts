...
*/
export class AwsSecurityhubStandardsSubscription extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsSecurityhubStandardsSubscriptionConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsSecurityhubStandardsSubscription.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsSecurityhubStandardsSubscription.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsSecurityhubStandardsSubscriptionTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsSecurityhubStandardsSubscriptionTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsSecurityhubStandardsSubscription.TimeoutsProperty",
      },
    };
...
export function awsSecurityhubStandardsSubscriptionTimeoutsPropertyToTerraform(struct?: AwsSecurityhubStandardsSubscription.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsSecurityhubStandardsSubscriptionTimeoutsPropertyToHclTerraform(struct?: AwsSecurityhubStandardsSubscription.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsSecurityhubStandardsSubscription {
