...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/chime_voice_connector_termination_credentials
...
*/
export class AwsChimeVoiceConnectorTerminationCredentials extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsChimeVoiceConnectorTerminationCredentialsConfig) {
    super(scope, id, {
  ...
  private _credentials = new AwsChimeVoiceConnectorTerminationCredentials.CredentialsPropertyList(this, "credentials", true);
  public get credentials() {
    return this._credentials;
  }
  public putCredentials(value: AwsChimeVoiceConnectorTerminationCredentials.CredentialsProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      credentials: cdktn.listMapper(awsChimeVoiceConnectorTerminationCredentialsCredentialsPropertyToTerraform, true)(this._credentials.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      credentials: {
        value: cdktn.listMapperHcl(awsChimeVoiceConnectorTerminationCredentialsCredentialsPropertyToHclTerraform, true)(this._credentials.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsChimeVoiceConnectorTerminationCredentials.CredentialsPropertyList",
      },
    };
...
export function awsChimeVoiceConnectorTerminationCredentialsCredentialsPropertyToTerraform(struct?: AwsChimeVoiceConnectorTerminationCredentials.CredentialsProperty | cdktn.IResolvable): any {
...
export function awsChimeVoiceConnectorTerminationCredentialsCredentialsPropertyToHclTerraform(struct?: AwsChimeVoiceConnectorTerminationCredentials.CredentialsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsChimeVoiceConnectorTerminationCredentials {
...
export class CredentialsPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CredentialsProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: CredentialsProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class CredentialsPropertyList extends cdktn.ComplexList {
  public internalValue? : CredentialsProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): CredentialsPropertyOutputReference {
    return new CredentialsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
