...
*/
export class AwsVoiceConnectorLogging extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsVoiceConnectorLoggingConfig) {
    super(scope, id, {
