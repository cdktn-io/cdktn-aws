...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/chime_voice_connector_termination
...
*/
export class AwsVoiceConnectorTermination extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsVoiceConnectorTerminationConfig) {
    super(scope, id, {
