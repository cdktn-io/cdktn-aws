...
export interface AwsLexv2ModelsBotLocaleConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsLexv2ModelsBotLocale.TimeoutsProperty;
  /**
  ...
  */
  readonly voiceSettings?: AwsLexv2ModelsBotLocale.VoiceSettingsProperty[] | cdktn.IResolvable;
}
...
*/
export class AwsLexv2ModelsBotLocale extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsLexv2ModelsBotLocale resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsLexv2ModelsBotLocale to import
  * @param importFromId The id of the existing AwsLexv2ModelsBotLocale that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lexv2models_bot_locale#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsLexv2ModelsBotLocale to import is found
  */
  ...
  * @param options AwsLexv2ModelsBotLocaleConfig
  */
  public constructor(scope: Construct, id: string, config: AwsLexv2ModelsBotLocaleConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsLexv2ModelsBotLocale.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsLexv2ModelsBotLocale.TimeoutsProperty) {
  ...
  private _voiceSettings = new AwsLexv2ModelsBotLocale.VoiceSettingsPropertyList(this, "voice_settings", false);
  public get voiceSettings() {
    return this._voiceSettings;
  }
  public putVoiceSettings(value: AwsLexv2ModelsBotLocale.VoiceSettingsProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsLexv2ModelsBotLocaleTimeoutsPropertyToTerraform(this._timeouts.internalValue),
      voice_settings: cdktn.listMapper(awsLexv2ModelsBotLocaleVoiceSettingsPropertyToTerraform, true)(this._voiceSettings.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsLexv2ModelsBotLocaleTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsLexv2ModelsBotLocale.TimeoutsProperty",
      },
      voice_settings: {
        value: cdktn.listMapperHcl(awsLexv2ModelsBotLocaleVoiceSettingsPropertyToHclTerraform, true)(this._voiceSettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsLexv2ModelsBotLocale.VoiceSettingsPropertyList",
      },
    };
...
export function awsLexv2ModelsBotLocaleTimeoutsPropertyToTerraform(struct?: AwsLexv2ModelsBotLocale.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsLexv2ModelsBotLocaleTimeoutsPropertyToHclTerraform(struct?: AwsLexv2ModelsBotLocale.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsLexv2ModelsBotLocaleVoiceSettingsPropertyToTerraform(struct?: AwsLexv2ModelsBotLocale.VoiceSettingsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsLexv2ModelsBotLocaleVoiceSettingsPropertyToHclTerraform(struct?: AwsLexv2ModelsBotLocale.VoiceSettingsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsLexv2ModelsBotLocale {
export interface TimeoutsProperty {
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lexv2models_bot_locale#create AwsLexv2ModelsBotLocale#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lexv2models_bot_locale#delete AwsLexv2ModelsBotLocale#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lexv2models_bot_locale#update AwsLexv2ModelsBotLocale#update}
  */
...
export class VoiceSettingsPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): VoiceSettingsProperty | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: VoiceSettingsProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class VoiceSettingsPropertyList extends cdktn.ComplexList {
  public internalValue? : VoiceSettingsProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): VoiceSettingsPropertyOutputReference {
    return new VoiceSettingsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
