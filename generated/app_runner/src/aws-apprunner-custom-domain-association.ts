...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apprunner_custom_domain_association
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsCustomDomainAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsCustomDomainAssociation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsCustomDomainAssociation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsCustomDomainAssociation to import
  * @param importFromId The id of the existing AwsCustomDomainAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apprunner_custom_domain_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsCustomDomainAssociation to import is found
  */
  ...
  * @param options AwsCustomDomainAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsCustomDomainAssociationConfig) {
    super(scope, id, {
  ...
  private _certificateValidationRecords = new AwsCustomDomainAssociation.CertificateValidationRecordsPropertyList(this, "certificate_validation_records", true);
...
export function awsCustomDomainAssociationCertificateValidationRecordsPropertyToTerraform(struct?: AwsCustomDomainAssociation.CertificateValidationRecordsProperty): any {
...
export function awsCustomDomainAssociationCertificateValidationRecordsPropertyToHclTerraform(struct?: AwsCustomDomainAssociation.CertificateValidationRecordsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsCustomDomainAssociation {
...
export class CertificateValidationRecordsPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CertificateValidationRecordsProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CertificateValidationRecordsProperty | undefined) {
    if (value === undefined) {
...
export class CertificateValidationRecordsPropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): CertificateValidationRecordsPropertyOutputReference {
    return new CertificateValidationRecordsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
