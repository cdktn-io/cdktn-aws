...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/apprunner_deployment
...
*/
export class AwsApprunnerDeployment extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsApprunnerDeploymentConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsApprunnerDeployment.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsApprunnerDeployment.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsApprunnerDeploymentTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsApprunnerDeploymentTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsApprunnerDeployment.TimeoutsProperty",
      },
    };
...
export function awsApprunnerDeploymentTimeoutsPropertyToTerraform(struct?: AwsApprunnerDeployment.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsApprunnerDeploymentTimeoutsPropertyToHclTerraform(struct?: AwsApprunnerDeployment.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsApprunnerDeployment {
