...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ssmincidents_response_plan
...
export class SsmAutomationPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SsmAutomationProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: SsmAutomationProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _dynamicParameters = new cdktn.StringMap(this, "dynamic_parameters");
...
export class NotificationTargetPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NotificationTargetProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: NotificationTargetProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class IncidentTemplatePropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _incidentTags = new cdktn.StringMap(this, "incident_tags");
...
export class IncidentTemplatePropertyList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): IncidentTemplatePropertyOutputReference {
    return new IncidentTemplatePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
