...
export class DataAwsCognitoIdentityPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCognitoIdentityPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/cognito_identity_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _cognitoIdentityProviders = new DataAwsCognitoIdentityPool.CognitoIdentityProvidersPropertyList(this, "cognito_identity_providers", true);
...
export function dataAwsCognitoIdentityPoolCognitoIdentityProvidersPropertyToTerraform(struct?: DataAwsCognitoIdentityPool.CognitoIdentityProvidersProperty): any {
...
export function dataAwsCognitoIdentityPoolCognitoIdentityProvidersPropertyToHclTerraform(struct?: DataAwsCognitoIdentityPool.CognitoIdentityProvidersProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsCognitoIdentityPool {
