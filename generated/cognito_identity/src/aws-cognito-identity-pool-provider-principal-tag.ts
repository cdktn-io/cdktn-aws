...
*/
export class TfPoolProviderPrincipalTag extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfPoolProviderPrincipalTagConfig) {
    super(scope, id, {
