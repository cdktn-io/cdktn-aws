...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/elasticache_reserved_cache_node
...
*/
export class AwsReservedCacheNode extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsReservedCacheNodeConfig) {
    super(scope, id, {
  ...
  private _recurringCharges = new AwsReservedCacheNode.RecurringChargesPropertyList(this, "recurring_charges", false);
  ...
  private _timeouts = new AwsReservedCacheNode.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsReservedCacheNode.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsReservedCacheNodeTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsReservedCacheNodeTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsReservedCacheNode.TimeoutsProperty",
      },
    };
...
export function awsReservedCacheNodeRecurringChargesPropertyToTerraform(struct?: AwsReservedCacheNode.RecurringChargesProperty): any {
...
export function awsReservedCacheNodeRecurringChargesPropertyToHclTerraform(struct?: AwsReservedCacheNode.RecurringChargesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsReservedCacheNodeTimeoutsPropertyToTerraform(struct?: AwsReservedCacheNode.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsReservedCacheNodeTimeoutsPropertyToHclTerraform(struct?: AwsReservedCacheNode.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsReservedCacheNode {
