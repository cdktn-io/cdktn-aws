...
*/
export class DataAwsServiceUpdates extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsServiceUpdatesConfig = {}) {
    super(scope, id, {
  ...
  private _serviceUpdates = new DataAwsServiceUpdates.ServiceUpdatesPropertyList(this, "service_updates", false);
...
export function dataAwsServiceUpdatesServiceUpdatesPropertyToTerraform(struct?: DataAwsServiceUpdates.ServiceUpdatesProperty): any {
...
export function dataAwsServiceUpdatesServiceUpdatesPropertyToHclTerraform(struct?: DataAwsServiceUpdates.ServiceUpdatesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsServiceUpdates {
