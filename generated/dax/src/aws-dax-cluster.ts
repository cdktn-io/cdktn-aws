...
export interface AwsClusterConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly serverSideEncryption?: AwsCluster.ServerSideEncryptionProperty;
  /**
  * timeouts block
  *
...
export class AwsCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dax_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _nodes = new AwsCluster.NodesPropertyList(this, "nodes", false);
  public get nodes() {
    return this._nodes;
  }
  ...
  private _serverSideEncryption = new AwsCluster.ServerSideEncryptionPropertyOutputReference(this, "server_side_encryption");
  public get serverSideEncryption() {
    return this._serverSideEncryption;
  }
  public putServerSideEncryption(value: AwsCluster.ServerSideEncryptionProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      server_side_encryption: awsClusterServerSideEncryptionPropertyToTerraform(this._serverSideEncryption.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      server_side_encryption: {
        value: awsClusterServerSideEncryptionPropertyToHclTerraform(this._serverSideEncryption.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsCluster.ServerSideEncryptionPropertyList",
      },
      timeouts: {
...
export function awsClusterServerSideEncryptionPropertyToTerraform(struct?: AwsCluster.ServerSideEncryptionPropertyOutputReference | AwsCluster.ServerSideEncryptionProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsClusterServerSideEncryptionPropertyToHclTerraform(struct?: AwsCluster.ServerSideEncryptionPropertyOutputReference | AwsCluster.ServerSideEncryptionProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export interface ServerSideEncryptionProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dax_cluster#enabled AwsCluster#enabled}
  */
...
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dax_cluster#create AwsCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dax_cluster#delete AwsCluster#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dax_cluster#update AwsCluster#update}
  */
