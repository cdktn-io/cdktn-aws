...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/efs_access_point
...
export interface DataAwsEfsAccessPointConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/efs_access_point#access_point_id DataAwsEfsAccessPoint#access_point_id}
  */
  readonly accessPointId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/efs_access_point#id DataAwsEfsAccessPoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/efs_access_point#region DataAwsEfsAccessPoint#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/efs_access_point#tags DataAwsEfsAccessPoint#tags}
  */
...
export class DataAwsEfsAccessPoint extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEfsAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/efs_access_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _posixUser = new DataAwsEfsAccessPoint.PosixUserPropertyList(this, "posix_user", false);
  ...
  private _rootDirectory = new DataAwsEfsAccessPoint.RootDirectoryPropertyList(this, "root_directory", false);
...
export function dataAwsEfsAccessPointPosixUserPropertyToTerraform(struct?: DataAwsEfsAccessPoint.PosixUserProperty): any {
...
export function dataAwsEfsAccessPointPosixUserPropertyToHclTerraform(struct?: DataAwsEfsAccessPoint.PosixUserProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEfsAccessPointCreationInfoPropertyToTerraform(struct?: DataAwsEfsAccessPoint.CreationInfoProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEfsAccessPointCreationInfoPropertyToHclTerraform(struct?: DataAwsEfsAccessPoint.CreationInfoProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEfsAccessPointRootDirectoryPropertyToTerraform(struct?: DataAwsEfsAccessPoint.RootDirectoryProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEfsAccessPointRootDirectoryPropertyToHclTerraform(struct?: DataAwsEfsAccessPoint.RootDirectoryProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsEfsAccessPoint {
...
export class CreationInfoPropertyList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): CreationInfoPropertyOutputReference {
    return new CreationInfoPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class RootDirectoryPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _creationInfo = new CreationInfoPropertyList(this, "creation_info", false);
