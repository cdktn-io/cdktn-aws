...
export interface AwsAppfabricAppAuthorizationConnectionConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly authRequest?: AwsAppfabricAppAuthorizationConnection.AuthRequestProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: AwsAppfabricAppAuthorizationConnection.TimeoutsProperty;
}
...
*/
export class AwsAppfabricAppAuthorizationConnection extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsAppfabricAppAuthorizationConnection resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsAppfabricAppAuthorizationConnection to import
  * @param importFromId The id of the existing AwsAppfabricAppAuthorizationConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appfabric_app_authorization_connection#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsAppfabricAppAuthorizationConnection to import is found
  */
  ...
  * @param options AwsAppfabricAppAuthorizationConnectionConfig
  */
  public constructor(scope: Construct, id: string, config: AwsAppfabricAppAuthorizationConnectionConfig) {
    super(scope, id, {
  ...
  private _tenant = new AwsAppfabricAppAuthorizationConnection.TenantPropertyList(this, "tenant", false);
  public get tenant() {
    return this._tenant;
  }

  // auth_request - computed: false, optional: true, required: false
  private _authRequest = new AwsAppfabricAppAuthorizationConnection.AuthRequestPropertyList(this, "auth_request", false);
  public get authRequest() {
    return this._authRequest;
  }
  public putAuthRequest(value: AwsAppfabricAppAuthorizationConnection.AuthRequestProperty[] | cdktn.IResolvable) {
  ...
  private _timeouts = new AwsAppfabricAppAuthorizationConnection.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsAppfabricAppAuthorizationConnection.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      auth_request: cdktn.listMapper(awsAppfabricAppAuthorizationConnectionAuthRequestPropertyToTerraform, true)(this._authRequest.internalValue),
      timeouts: awsAppfabricAppAuthorizationConnectionTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      auth_request: {
        value: cdktn.listMapperHcl(awsAppfabricAppAuthorizationConnectionAuthRequestPropertyToHclTerraform, true)(this._authRequest.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsAppfabricAppAuthorizationConnection.AuthRequestPropertyList",
      },
      timeouts: {
        value: awsAppfabricAppAuthorizationConnectionTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsAppfabricAppAuthorizationConnection.TimeoutsProperty",
      },
    };
...
export function awsAppfabricAppAuthorizationConnectionTenantPropertyToTerraform(struct?: AwsAppfabricAppAuthorizationConnection.TenantProperty): any {
...
export function awsAppfabricAppAuthorizationConnectionTenantPropertyToHclTerraform(struct?: AwsAppfabricAppAuthorizationConnection.TenantProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsAppfabricAppAuthorizationConnectionAuthRequestPropertyToTerraform(struct?: AwsAppfabricAppAuthorizationConnection.AuthRequestProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsAppfabricAppAuthorizationConnectionAuthRequestPropertyToHclTerraform(struct?: AwsAppfabricAppAuthorizationConnection.AuthRequestProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsAppfabricAppAuthorizationConnectionTimeoutsPropertyToTerraform(struct?: AwsAppfabricAppAuthorizationConnection.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsAppfabricAppAuthorizationConnectionTimeoutsPropertyToHclTerraform(struct?: AwsAppfabricAppAuthorizationConnection.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsAppfabricAppAuthorizationConnection {
...
export interface TimeoutsProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appfabric_app_authorization_connection#create AwsAppfabricAppAuthorizationConnection#create}
  */
