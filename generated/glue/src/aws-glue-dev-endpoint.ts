...
export interface AwsDevEndpointConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsDevEndpoint extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsDevEndpoint resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsDevEndpoint to import
  * @param importFromId The id of the existing AwsDevEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/glue_dev_endpoint#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDevEndpoint to import is found
  */
  ...
  * @param options AwsDevEndpointConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDevEndpointConfig) {
    super(scope, id, {
