...
export interface AwsGlueDevEndpointConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsGlueDevEndpoint extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsGlueDevEndpoint resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsGlueDevEndpoint to import
  * @param importFromId The id of the existing AwsGlueDevEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/glue_dev_endpoint#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsGlueDevEndpoint to import is found
  */
  ...
  * @param options AwsGlueDevEndpointConfig
  */
  public constructor(scope: Construct, id: string, config: AwsGlueDevEndpointConfig) {
    super(scope, id, {
