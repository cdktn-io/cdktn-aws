...
export interface AwsGlueWorkflowConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsGlueWorkflow extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsGlueWorkflow resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsGlueWorkflow to import
  * @param importFromId The id of the existing AwsGlueWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/glue_workflow#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsGlueWorkflow to import is found
  */
  ...
  * @param options AwsGlueWorkflowConfig = {}
  */
  public constructor(scope: Construct, id: string, config: AwsGlueWorkflowConfig = {}) {
    super(scope, id, {
