...
export class DataAwsWorkspace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/workspaces_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _workspaceProperties = new DataAwsWorkspace.WorkspacePropertiesPropertyList(this, "workspace_properties", false);
...
export function dataAwsWorkspaceWorkspacePropertiesPropertyToTerraform(struct?: DataAwsWorkspace.WorkspacePropertiesProperty): any {
...
export function dataAwsWorkspaceWorkspacePropertiesPropertyToHclTerraform(struct?: DataAwsWorkspace.WorkspacePropertiesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsWorkspace {
