...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/wafv2_regex_pattern_set
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsWafv2RegexPatternSetConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly regularExpression?: AwsWafv2RegexPatternSet.RegularExpressionProperty[] | cdktn.IResolvable;
}
...
*/
export class AwsWafv2RegexPatternSet extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsWafv2RegexPatternSet resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsWafv2RegexPatternSet to import
  * @param importFromId The id of the existing AwsWafv2RegexPatternSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/wafv2_regex_pattern_set#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsWafv2RegexPatternSet to import is found
  */
  ...
  * @param options AwsWafv2RegexPatternSetConfig
  */
  public constructor(scope: Construct, id: string, config: AwsWafv2RegexPatternSetConfig) {
    super(scope, id, {
  ...
  private _regularExpression = new AwsWafv2RegexPatternSet.RegularExpressionPropertyList(this, "regular_expression", true);
  public get regularExpression() {
    return this._regularExpression;
  }
  public putRegularExpression(value: AwsWafv2RegexPatternSet.RegularExpressionProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      regular_expression: cdktn.listMapper(awsWafv2RegexPatternSetRegularExpressionPropertyToTerraform, true)(this._regularExpression.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      regular_expression: {
        value: cdktn.listMapperHcl(awsWafv2RegexPatternSetRegularExpressionPropertyToHclTerraform, true)(this._regularExpression.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AwsWafv2RegexPatternSet.RegularExpressionPropertyList",
      },
    };
...
export function awsWafv2RegexPatternSetRegularExpressionPropertyToTerraform(struct?: AwsWafv2RegexPatternSet.RegularExpressionProperty | cdktn.IResolvable): any {
...
export function awsWafv2RegexPatternSetRegularExpressionPropertyToHclTerraform(struct?: AwsWafv2RegexPatternSet.RegularExpressionProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsWafv2RegexPatternSet {
export interface RegularExpressionProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/wafv2_regex_pattern_set#regex_string AwsWafv2RegexPatternSet#regex_string}
  */
  readonly regexString: string;
}
export class RegularExpressionPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RegularExpressionProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: RegularExpressionProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class RegularExpressionPropertyList extends cdktn.ComplexList {
  public internalValue? : RegularExpressionProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): RegularExpressionPropertyOutputReference {
    return new RegularExpressionPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
