...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/auditmanager_assessment_report
...
*/
export class AwsAuditmanagerAssessmentReport extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsAuditmanagerAssessmentReportConfig) {
    super(scope, id, {
