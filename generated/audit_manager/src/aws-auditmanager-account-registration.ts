...
*/
export class AwsAuditmanagerAccountRegistration extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsAuditmanagerAccountRegistrationConfig = {}) {
    super(scope, id, {
