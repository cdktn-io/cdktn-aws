...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/networkmanager_transit_gateway_peering
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsTransitGatewayPeeringConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsTransitGatewayPeering.TimeoutsProperty;
}
...
*/
export class AwsTransitGatewayPeering extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsTransitGatewayPeering resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsTransitGatewayPeering to import
  * @param importFromId The id of the existing AwsTransitGatewayPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/networkmanager_transit_gateway_peering#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsTransitGatewayPeering to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/networkmanager_transit_gateway_peering aws_networkmanager_transit_gateway_peering} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AwsTransitGatewayPeeringConfig
  */
  public constructor(scope: Construct, id: string, config: AwsTransitGatewayPeeringConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsTransitGatewayPeering.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsTransitGatewayPeering.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsTransitGatewayPeeringTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsTransitGatewayPeeringTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsTransitGatewayPeering.TimeoutsProperty",
      },
    };
...
export function awsTransitGatewayPeeringTimeoutsPropertyToTerraform(struct?: AwsTransitGatewayPeering.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsTransitGatewayPeeringTimeoutsPropertyToHclTerraform(struct?: AwsTransitGatewayPeering.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsTransitGatewayPeering {
