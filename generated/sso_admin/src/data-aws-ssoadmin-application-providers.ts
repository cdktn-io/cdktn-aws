...
export interface TfDataApplicationProvidersConfig extends cdktn.TerraformMetaArguments {
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ssoadmin_application_providers#region TfDataApplicationProviders#region}
  */
...
*/
export class TfDataApplicationProviders extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataApplicationProviders resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataApplicationProviders to import
  * @param importFromId The id of the existing TfDataApplicationProviders that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ssoadmin_application_providers#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataApplicationProviders to import is found
  */
  ...
  * @param options TfDataApplicationProvidersConfig = {}
  */
  public constructor(scope: Construct, id: string, config: TfDataApplicationProvidersConfig = {}) {
    super(scope, id, {
  ...
  private _applicationProviders = new TfDataApplicationProviders.ApplicationProvidersPropertyList(this, "application_providers", false);
...
export function tfDataApplicationProvidersDisplayDataPropertyToTerraform(struct?: TfDataApplicationProviders.DisplayDataProperty): any {
...
export function tfDataApplicationProvidersDisplayDataPropertyToHclTerraform(struct?: TfDataApplicationProviders.DisplayDataProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataApplicationProvidersApplicationProvidersPropertyToTerraform(struct?: TfDataApplicationProviders.ApplicationProvidersProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataApplicationProvidersApplicationProvidersPropertyToHclTerraform(struct?: TfDataApplicationProviders.ApplicationProvidersProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfDataApplicationProviders {
