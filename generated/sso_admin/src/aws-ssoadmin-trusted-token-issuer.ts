...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsTrustedTokenIssuerConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#client_token AwsTrustedTokenIssuer#client_token}
  */
  readonly clientToken?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#instance_arn AwsTrustedTokenIssuer#instance_arn}
  */
  readonly instanceArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#name AwsTrustedTokenIssuer#name}
  */
  readonly name: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#region AwsTrustedTokenIssuer#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#tags AwsTrustedTokenIssuer#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#trusted_token_issuer_type AwsTrustedTokenIssuer#trusted_token_issuer_type}
  */
  readonly trustedTokenIssuerType: string;
  /**
  * trusted_token_issuer_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#trusted_token_issuer_configuration AwsTrustedTokenIssuer#trusted_token_issuer_configuration}
  */
  readonly trustedTokenIssuerConfiguration?: AwsTrustedTokenIssuer.TrustedTokenIssuerConfigurationProperty[] | cdktn.IResolvable;
}
...
*/
export class AwsTrustedTokenIssuer extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsTrustedTokenIssuer resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsTrustedTokenIssuer to import
  * @param importFromId The id of the existing AwsTrustedTokenIssuer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ssoadmin_trusted_token_issuer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsTrustedTokenIssuer to import is found
  */
  ...
  * @param options AwsTrustedTokenIssuerConfig
  */
  public constructor(scope: Construct, id: string, config: AwsTrustedTokenIssuerConfig) {
    super(scope, id, {
  ...
  private _trustedTokenIssuerConfiguration = new AwsTrustedTokenIssuer.TrustedTokenIssuerConfigurationPropertyList(this, "trusted_token_issuer_configuration", false);
  public get trustedTokenIssuerConfiguration() {
    return this._trustedTokenIssuerConfiguration;
  }
  public putTrustedTokenIssuerConfiguration(value: AwsTrustedTokenIssuer.TrustedTokenIssuerConfigurationProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      trusted_token_issuer_configuration: cdktn.listMapper(awsTrustedTokenIssuerTrustedTokenIssuerConfigurationPropertyToTerraform, true)(this._trustedTokenIssuerConfiguration.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      trusted_token_issuer_configuration: {
        value: cdktn.listMapperHcl(awsTrustedTokenIssuerTrustedTokenIssuerConfigurationPropertyToHclTerraform, true)(this._trustedTokenIssuerConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsTrustedTokenIssuer.TrustedTokenIssuerConfigurationPropertyList",
      },
    };
...
export function awsTrustedTokenIssuerOidcJwtConfigurationPropertyToTerraform(struct?: AwsTrustedTokenIssuer.OidcJwtConfigurationProperty | cdktn.IResolvable): any {
...
export function awsTrustedTokenIssuerOidcJwtConfigurationPropertyToHclTerraform(struct?: AwsTrustedTokenIssuer.OidcJwtConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsTrustedTokenIssuerTrustedTokenIssuerConfigurationPropertyToTerraform(struct?: AwsTrustedTokenIssuer.TrustedTokenIssuerConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    oidc_jwt_configuration: cdktn.listMapper(awsTrustedTokenIssuerOidcJwtConfigurationPropertyToTerraform, true)(struct!.oidcJwtConfiguration),
  }
}


export function awsTrustedTokenIssuerTrustedTokenIssuerConfigurationPropertyToHclTerraform(struct?: AwsTrustedTokenIssuer.TrustedTokenIssuerConfigurationProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    oidc_jwt_configuration: {
      value: cdktn.listMapperHcl(awsTrustedTokenIssuerOidcJwtConfigurationPropertyToHclTerraform, true)(struct!.oidcJwtConfiguration),
      isBlock: true,
      type: "list",
...
export namespace AwsTrustedTokenIssuer {
...
export class OidcJwtConfigurationPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OidcJwtConfigurationProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: OidcJwtConfigurationProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class OidcJwtConfigurationPropertyList extends cdktn.ComplexList {
  public internalValue? : OidcJwtConfigurationProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): OidcJwtConfigurationPropertyOutputReference {
    return new OidcJwtConfigurationPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface TrustedTokenIssuerConfigurationProperty {
  /**
...
export class TrustedTokenIssuerConfigurationPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): TrustedTokenIssuerConfigurationProperty | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: TrustedTokenIssuerConfigurationProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _oidcJwtConfiguration = new OidcJwtConfigurationPropertyList(this, "oidc_jwt_configuration", false);
  public get oidcJwtConfiguration() {
    return this._oidcJwtConfiguration;
  }
  public putOidcJwtConfiguration(value: OidcJwtConfigurationProperty[] | cdktn.IResolvable) {
...
export class TrustedTokenIssuerConfigurationPropertyList extends cdktn.ComplexList {
  public internalValue? : TrustedTokenIssuerConfigurationProperty[] | cdktn.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): TrustedTokenIssuerConfigurationPropertyOutputReference {
    return new TrustedTokenIssuerConfigurationPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
