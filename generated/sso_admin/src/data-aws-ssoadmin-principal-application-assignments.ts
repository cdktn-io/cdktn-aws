...
*/
export class DataAwsPrincipalApplicationAssignments extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsPrincipalApplicationAssignmentsConfig) {
    super(scope, id, {
  ...
  private _applicationAssignments = new DataAwsPrincipalApplicationAssignments.ApplicationAssignmentsPropertyList(this, "application_assignments", false);
  public get applicationAssignments() {
    return this._applicationAssignments;
  }
  public putApplicationAssignments(value: DataAwsPrincipalApplicationAssignments.ApplicationAssignmentsProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      application_assignments: cdktn.listMapper(dataAwsPrincipalApplicationAssignmentsApplicationAssignmentsPropertyToTerraform, true)(this._applicationAssignments.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      application_assignments: {
        value: cdktn.listMapperHcl(dataAwsPrincipalApplicationAssignmentsApplicationAssignmentsPropertyToHclTerraform, true)(this._applicationAssignments.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataAwsPrincipalApplicationAssignments.ApplicationAssignmentsPropertyList",
      },
    };
...
export function dataAwsPrincipalApplicationAssignmentsApplicationAssignmentsPropertyToTerraform(struct?: DataAwsPrincipalApplicationAssignments.ApplicationAssignmentsProperty | cdktn.IResolvable): any {
...
export function dataAwsPrincipalApplicationAssignmentsApplicationAssignmentsPropertyToHclTerraform(struct?: DataAwsPrincipalApplicationAssignments.ApplicationAssignmentsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsPrincipalApplicationAssignments {
