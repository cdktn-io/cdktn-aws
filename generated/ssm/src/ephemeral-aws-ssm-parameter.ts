...
export interface EphemeralAwsParameterConfig extends cdktn.TerraformEphemeralMetaArguments {
  /**
...
*/
export class EphemeralAwsParameter extends cdktn.TerraformEphemeralResource {
  ...
  * @param options EphemeralAwsParameterConfig
  */
  public constructor(scope: Construct, id: string, config: EphemeralAwsParameterConfig) {
    super(scope, id, {
