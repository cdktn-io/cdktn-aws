...
*/
export class AwsDynamodbKinesisStreamingDestination extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsDynamodbKinesisStreamingDestinationConfig) {
    super(scope, id, {
