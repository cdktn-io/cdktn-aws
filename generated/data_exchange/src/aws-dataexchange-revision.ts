...
export interface TfRevisionConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfRevision extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfRevision resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfRevision to import
  * @param importFromId The id of the existing TfRevision that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dataexchange_revision#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfRevision to import is found
  */
  ...
  * @param options TfRevisionConfig
  */
  public constructor(scope: Construct, id: string, config: TfRevisionConfig) {
    super(scope, id, {
