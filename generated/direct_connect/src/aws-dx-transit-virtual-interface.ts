...
export interface AwsTransitVirtualInterfaceConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsTransitVirtualInterface.TimeoutsProperty;
}
...
*/
export class AwsTransitVirtualInterface extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsTransitVirtualInterface resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsTransitVirtualInterface to import
  * @param importFromId The id of the existing AwsTransitVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_transit_virtual_interface#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsTransitVirtualInterface to import is found
  */
  ...
  * @param options AwsTransitVirtualInterfaceConfig
  */
  public constructor(scope: Construct, id: string, config: AwsTransitVirtualInterfaceConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsTransitVirtualInterface.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsTransitVirtualInterface.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsTransitVirtualInterfaceTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsTransitVirtualInterfaceTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsTransitVirtualInterface.TimeoutsProperty",
      },
    };
...
export function awsTransitVirtualInterfaceTimeoutsPropertyToTerraform(struct?: AwsTransitVirtualInterface.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsTransitVirtualInterfaceTimeoutsPropertyToHclTerraform(struct?: AwsTransitVirtualInterface.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsTransitVirtualInterface {
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_transit_virtual_interface#create AwsTransitVirtualInterface#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_transit_virtual_interface#delete AwsTransitVirtualInterface#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_transit_virtual_interface#update AwsTransitVirtualInterface#update}
  */
