...
export interface DataAwsDxRouterConfigurationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsDxRouterConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDxRouterConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/dx_router_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _router = new DataAwsDxRouterConfiguration.RouterPropertyList(this, "router", false);
  public get router() {
    return this._router;
  }
...
export function dataAwsDxRouterConfigurationRouterPropertyToTerraform(struct?: DataAwsDxRouterConfiguration.RouterProperty): any {
...
export function dataAwsDxRouterConfigurationRouterPropertyToHclTerraform(struct?: DataAwsDxRouterConfiguration.RouterProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsDxRouterConfiguration {
