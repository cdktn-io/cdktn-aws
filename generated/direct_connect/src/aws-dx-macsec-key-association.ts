...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_macsec_key_association
...
*/
export class AwsMacsecKeyAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsMacsecKeyAssociationConfig) {
    super(scope, id, {
