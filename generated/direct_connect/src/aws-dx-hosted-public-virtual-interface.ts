...
export interface AwsDxHostedPublicVirtualInterfaceConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsDxHostedPublicVirtualInterface.TimeoutsProperty;
}
...
*/
export class AwsDxHostedPublicVirtualInterface extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the AwsDxHostedPublicVirtualInterface to import
  * @param importFromId The id of the existing AwsDxHostedPublicVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_hosted_public_virtual_interface#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDxHostedPublicVirtualInterface to import is found
  */
  ...
  * @param options AwsDxHostedPublicVirtualInterfaceConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDxHostedPublicVirtualInterfaceConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsDxHostedPublicVirtualInterface.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsDxHostedPublicVirtualInterface.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsDxHostedPublicVirtualInterfaceTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsDxHostedPublicVirtualInterfaceTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsDxHostedPublicVirtualInterface.TimeoutsProperty",
      },
    };
...
export function awsDxHostedPublicVirtualInterfaceTimeoutsPropertyToTerraform(struct?: AwsDxHostedPublicVirtualInterface.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsDxHostedPublicVirtualInterfaceTimeoutsPropertyToHclTerraform(struct?: AwsDxHostedPublicVirtualInterface.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsDxHostedPublicVirtualInterface {
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_hosted_public_virtual_interface#create AwsDxHostedPublicVirtualInterface#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/dx_hosted_public_virtual_interface#delete AwsDxHostedPublicVirtualInterface#delete}
  */
