...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iot_thing_group_membership
...
*/
export class AwsThingGroupMembership extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsThingGroupMembershipConfig) {
    super(scope, id, {
  ...
  public set overrideDynamicGroup(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      override_dynamic_group: cdktn.booleanToTerraform(this._overrideDynamicGroup),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      override_dynamic_group: {
        value: cdktn.booleanToHclTerraform(this._overrideDynamicGroup),
        isBlock: false,
        type: "simple",
