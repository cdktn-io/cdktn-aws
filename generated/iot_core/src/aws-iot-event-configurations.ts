...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/iot_event_configurations
...
*/
export class AwsIotEventConfigurations extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsIotEventConfigurationsConfig) {
    super(scope, id, {
