...
export interface AwsXrayIndexingRuleConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_indexing_rule#name AwsXrayIndexingRule#name}
  */
  readonly name: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_indexing_rule#region AwsXrayIndexingRule#region}
  */
  readonly region?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_indexing_rule#rule AwsXrayIndexingRule#rule}
  */
  readonly rule?: AwsXrayIndexingRule.RuleProperty[] | cdktn.IResolvable;
}
...
*/
export class AwsXrayIndexingRule extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsXrayIndexingRule resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsXrayIndexingRule to import
  * @param importFromId The id of the existing AwsXrayIndexingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_indexing_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsXrayIndexingRule to import is found
  */
  ...
  * @param options AwsXrayIndexingRuleConfig
  */
  public constructor(scope: Construct, id: string, config: AwsXrayIndexingRuleConfig) {
    super(scope, id, {
  ...
  private _rule = new AwsXrayIndexingRule.RulePropertyList(this, "rule", false);
  public get rule() {
    return this._rule;
  }
  public putRule(value: AwsXrayIndexingRule.RuleProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rule: cdktn.listMapper(awsXrayIndexingRuleRulePropertyToTerraform, true)(this._rule.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rule: {
        value: cdktn.listMapperHcl(awsXrayIndexingRuleRulePropertyToHclTerraform, true)(this._rule.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsXrayIndexingRule.RulePropertyList",
      },
    };
...
export function awsXrayIndexingRuleProbabilisticPropertyToTerraform(struct?: AwsXrayIndexingRule.ProbabilisticProperty | cdktn.IResolvable): any {
...
export function awsXrayIndexingRuleProbabilisticPropertyToHclTerraform(struct?: AwsXrayIndexingRule.ProbabilisticProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsXrayIndexingRuleRulePropertyToTerraform(struct?: AwsXrayIndexingRule.RuleProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    probabilistic: cdktn.listMapper(awsXrayIndexingRuleProbabilisticPropertyToTerraform, true)(struct!.probabilistic),
  }
}


export function awsXrayIndexingRuleRulePropertyToHclTerraform(struct?: AwsXrayIndexingRule.RuleProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    probabilistic: {
      value: cdktn.listMapperHcl(awsXrayIndexingRuleProbabilisticPropertyToHclTerraform, true)(struct!.probabilistic),
      isBlock: true,
      type: "list",
...
export namespace AwsXrayIndexingRule {
export interface ProbabilisticProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_indexing_rule#desired_sampling_percentage AwsXrayIndexingRule#desired_sampling_percentage}
  */
...
export interface RuleProperty {
  ...
  * probabilistic block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_indexing_rule#probabilistic AwsXrayIndexingRule#probabilistic}
  */
