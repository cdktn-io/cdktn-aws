...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsXrayGroupConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#filter_expression AwsXrayGroup#filter_expression}
  */
  readonly filterExpression: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#group_name AwsXrayGroup#group_name}
  */
  readonly groupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#id AwsXrayGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#region AwsXrayGroup#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#tags AwsXrayGroup#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#tags_all AwsXrayGroup#tags_all}
  */
  readonly tagsAll?: { [key: string]: string };
  /**
  * insights_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#insights_configuration AwsXrayGroup#insights_configuration}
  */
  readonly insightsConfiguration?: AwsXrayGroup.InsightsConfigurationProperty;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group aws_xray_group}
*/
export class AwsXrayGroup extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsXrayGroup resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsXrayGroup to import
  * @param importFromId The id of the existing AwsXrayGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/xray_group#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsXrayGroup to import is found
  */
  ...
  * @param options AwsXrayGroupConfig
  */
  public constructor(scope: Construct, id: string, config: AwsXrayGroupConfig) {
    super(scope, id, {
  ...
  private _insightsConfiguration = new AwsXrayGroup.InsightsConfigurationPropertyOutputReference(this, "insights_configuration");
  public get insightsConfiguration() {
    return this._insightsConfiguration;
  }
  public putInsightsConfiguration(value: AwsXrayGroup.InsightsConfigurationProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      insights_configuration: awsXrayGroupInsightsConfigurationPropertyToTerraform(this._insightsConfiguration.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      insights_configuration: {
        value: awsXrayGroupInsightsConfigurationPropertyToHclTerraform(this._insightsConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsXrayGroup.InsightsConfigurationPropertyList",
      },
    };
...
export function awsXrayGroupInsightsConfigurationPropertyToTerraform(struct?: AwsXrayGroup.InsightsConfigurationPropertyOutputReference | AwsXrayGroup.InsightsConfigurationProperty): any {
...
export function awsXrayGroupInsightsConfigurationPropertyToHclTerraform(struct?: AwsXrayGroup.InsightsConfigurationPropertyOutputReference | AwsXrayGroup.InsightsConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class InsightsConfigurationPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): InsightsConfigurationProperty | undefined {
  ...
  public set internalValue(value: InsightsConfigurationProperty | undefined) {
    if (value === undefined) {
