...
export interface DataAwsPrometheusWorkspacesConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsPrometheusWorkspaces extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsPrometheusWorkspaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/prometheus_workspaces#import import section} in the documentation of this resource for the id to use
