...
export interface AwsSourceCredentialConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsSourceCredential extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsSourceCredential resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsSourceCredential to import
  * @param importFromId The id of the existing AwsSourceCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/codebuild_source_credential#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsSourceCredential to import is found
  */
  ...
  * @param options AwsSourceCredentialConfig
  */
  public constructor(scope: Construct, id: string, config: AwsSourceCredentialConfig) {
    super(scope, id, {
