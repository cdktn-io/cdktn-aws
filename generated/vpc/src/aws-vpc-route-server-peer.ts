...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_route_server_peer
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsVpcRouteServerPeerConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly bgpOptions?: AwsVpcRouteServerPeer.BgpOptionsProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: AwsVpcRouteServerPeer.TimeoutsProperty;
}
...
*/
export class AwsVpcRouteServerPeer extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsVpcRouteServerPeer resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsVpcRouteServerPeer to import
  * @param importFromId The id of the existing AwsVpcRouteServerPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_route_server_peer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsVpcRouteServerPeer to import is found
  */
  ...
  * @param options AwsVpcRouteServerPeerConfig
  */
  public constructor(scope: Construct, id: string, config: AwsVpcRouteServerPeerConfig) {
    super(scope, id, {
  ...
  private _bgpOptions = new AwsVpcRouteServerPeer.BgpOptionsPropertyList(this, "bgp_options", false);
  public get bgpOptions() {
    return this._bgpOptions;
  }
  public putBgpOptions(value: AwsVpcRouteServerPeer.BgpOptionsProperty[] | cdktn.IResolvable) {
  ...
  private _timeouts = new AwsVpcRouteServerPeer.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsVpcRouteServerPeer.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      bgp_options: cdktn.listMapper(awsVpcRouteServerPeerBgpOptionsPropertyToTerraform, true)(this._bgpOptions.internalValue),
      timeouts: awsVpcRouteServerPeerTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      bgp_options: {
        value: cdktn.listMapperHcl(awsVpcRouteServerPeerBgpOptionsPropertyToHclTerraform, true)(this._bgpOptions.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsVpcRouteServerPeer.BgpOptionsPropertyList",
      },
      timeouts: {
        value: awsVpcRouteServerPeerTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsVpcRouteServerPeer.TimeoutsProperty",
      },
    };
...
export function awsVpcRouteServerPeerBgpOptionsPropertyToTerraform(struct?: AwsVpcRouteServerPeer.BgpOptionsProperty | cdktn.IResolvable): any {
...
export function awsVpcRouteServerPeerBgpOptionsPropertyToHclTerraform(struct?: AwsVpcRouteServerPeer.BgpOptionsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsVpcRouteServerPeerTimeoutsPropertyToTerraform(struct?: AwsVpcRouteServerPeer.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsVpcRouteServerPeerTimeoutsPropertyToHclTerraform(struct?: AwsVpcRouteServerPeer.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsVpcRouteServerPeer {
...
export class BgpOptionsPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BgpOptionsProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: BgpOptionsProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class BgpOptionsPropertyList extends cdktn.ComplexList {
  public internalValue? : BgpOptionsProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): BgpOptionsPropertyOutputReference {
    return new BgpOptionsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface TimeoutsProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_route_server_peer#create AwsVpcRouteServerPeer#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_route_server_peer#delete AwsVpcRouteServerPeer#delete}
  */
