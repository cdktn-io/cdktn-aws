...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ec2_traffic_mirror_filter_rule
...
export class DestinationPortRangePropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DestinationPortRangeProperty | undefined {
  ...
  public set internalValue(value: DestinationPortRangeProperty | undefined) {
    if (value === undefined) {
...
export class SourcePortRangePropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SourcePortRangeProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._fromPort !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: SourcePortRangeProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._fromPort = undefined;
      this._toPort = undefined;
