...
export interface AwsEndpointRouteTableAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsEndpointRouteTableAssociation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsEndpointRouteTableAssociation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsEndpointRouteTableAssociation to import
  * @param importFromId The id of the existing AwsEndpointRouteTableAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_endpoint_route_table_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsEndpointRouteTableAssociation to import is found
  */
  ...
  * @param options AwsEndpointRouteTableAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsEndpointRouteTableAssociationConfig) {
    super(scope, id, {
