...
export interface AwsEndpointConnectionNotificationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsEndpointConnectionNotification extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsEndpointConnectionNotification resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsEndpointConnectionNotification to import
  * @param importFromId The id of the existing AwsEndpointConnectionNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/vpc_endpoint_connection_notification#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsEndpointConnectionNotification to import is found
  */
  ...
  * @param options AwsEndpointConnectionNotificationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsEndpointConnectionNotificationConfig) {
    super(scope, id, {
