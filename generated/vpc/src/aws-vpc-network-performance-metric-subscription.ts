...
*/
export class AwsVpcNetworkPerformanceMetricSubscription extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsVpcNetworkPerformanceMetricSubscriptionConfig) {
    super(scope, id, {
