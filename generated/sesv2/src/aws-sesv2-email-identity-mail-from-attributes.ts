...
export interface TfEmailIdentityMailFromAttributesConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfEmailIdentityMailFromAttributes extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfEmailIdentityMailFromAttributes resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfEmailIdentityMailFromAttributes to import
  * @param importFromId The id of the existing TfEmailIdentityMailFromAttributes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sesv2_email_identity_mail_from_attributes#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfEmailIdentityMailFromAttributes to import is found
  */
  ...
  * @param options TfEmailIdentityMailFromAttributesConfig
  */
  public constructor(scope: Construct, id: string, config: TfEmailIdentityMailFromAttributesConfig) {
    super(scope, id, {
