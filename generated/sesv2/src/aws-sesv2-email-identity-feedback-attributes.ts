...
*/
export class TfEmailIdentityFeedbackAttributes extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: TfEmailIdentityFeedbackAttributesConfig) {
    super(scope, id, {
