...
*/
export class AwsSesv2TenantResourceAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsSesv2TenantResourceAssociationConfig) {
    super(scope, id, {
