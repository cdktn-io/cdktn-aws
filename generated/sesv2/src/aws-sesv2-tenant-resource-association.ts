...
export interface TfTenantResourceAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfTenantResourceAssociation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfTenantResourceAssociation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfTenantResourceAssociation to import
  * @param importFromId The id of the existing TfTenantResourceAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sesv2_tenant_resource_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfTenantResourceAssociation to import is found
  */
  ...
  * @param options TfTenantResourceAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: TfTenantResourceAssociationConfig) {
    super(scope, id, {
