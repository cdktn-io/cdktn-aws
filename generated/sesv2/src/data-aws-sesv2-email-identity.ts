...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataAwsEmailIdentityConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#email_identity DataAwsEmailIdentity#email_identity}
  */
  readonly emailIdentity: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#id DataAwsEmailIdentity#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#region DataAwsEmailIdentity#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#tags DataAwsEmailIdentity#tags}
  */
...
*/
export class DataAwsEmailIdentity extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsEmailIdentity resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsEmailIdentity to import
  * @param importFromId The id of the existing DataAwsEmailIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsEmailIdentity to import is found
  */
  ...
  * @param options DataAwsEmailIdentityConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsEmailIdentityConfig) {
    super(scope, id, {
  ...
  private _dkimSigningAttributes = new DataAwsEmailIdentity.DkimSigningAttributesPropertyList(this, "dkim_signing_attributes", false);
...
export function dataAwsEmailIdentityDkimSigningAttributesPropertyToTerraform(struct?: DataAwsEmailIdentity.DkimSigningAttributesProperty): any {
...
export function dataAwsEmailIdentityDkimSigningAttributesPropertyToHclTerraform(struct?: DataAwsEmailIdentity.DkimSigningAttributesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsEmailIdentity {
...
export class DkimSigningAttributesPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DkimSigningAttributesProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DkimSigningAttributesProperty | undefined) {
    if (value === undefined) {
...
export class DkimSigningAttributesPropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DkimSigningAttributesPropertyOutputReference {
    return new DkimSigningAttributesPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
