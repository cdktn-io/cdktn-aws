...
export interface TfDataEmailIdentityConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#email_identity TfDataEmailIdentity#email_identity}
  */
  readonly emailIdentity: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#id TfDataEmailIdentity#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#region TfDataEmailIdentity#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#tags TfDataEmailIdentity#tags}
  */
...
*/
export class TfDataEmailIdentity extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataEmailIdentity resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataEmailIdentity to import
  * @param importFromId The id of the existing TfDataEmailIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sesv2_email_identity#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataEmailIdentity to import is found
  */
  ...
  * @param options TfDataEmailIdentityConfig
  */
  public constructor(scope: Construct, id: string, config: TfDataEmailIdentityConfig) {
    super(scope, id, {
  ...
  private _dkimSigningAttributes = new TfDataEmailIdentity.DkimSigningAttributesPropertyList(this, "dkim_signing_attributes", false);
...
export function tfDataEmailIdentityDkimSigningAttributesPropertyToTerraform(struct?: TfDataEmailIdentity.DkimSigningAttributesProperty): any {
...
export function tfDataEmailIdentityDkimSigningAttributesPropertyToHclTerraform(struct?: TfDataEmailIdentity.DkimSigningAttributesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfDataEmailIdentity {
