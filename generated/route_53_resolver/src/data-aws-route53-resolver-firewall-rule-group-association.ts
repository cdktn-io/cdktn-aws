...
*/
export class DataAwsResolverFirewallRuleGroupAssociation extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsResolverFirewallRuleGroupAssociationConfig) {
    super(scope, id, {
