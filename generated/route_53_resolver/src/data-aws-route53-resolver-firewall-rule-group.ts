...
export interface DataAwsRoute53ResolverFirewallRuleGroupConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsRoute53ResolverFirewallRuleGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRoute53ResolverFirewallRuleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/route53_resolver_firewall_rule_group#import import section} in the documentation of this resource for the id to use
