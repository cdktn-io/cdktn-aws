...
*/
export class DataTfOutpostInstanceTypes extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataTfOutpostInstanceTypesConfig) {
    super(scope, id, {
