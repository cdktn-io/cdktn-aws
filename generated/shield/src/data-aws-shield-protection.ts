...
export interface DataAwsProtectionConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsProtection extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsProtection resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsProtection to import
  * @param importFromId The id of the existing DataAwsProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/shield_protection#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsProtection to import is found
  */
  ...
  * @param options DataAwsProtectionConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAwsProtectionConfig = {}) {
    super(scope, id, {
