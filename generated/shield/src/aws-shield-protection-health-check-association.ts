...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/shield_protection_health_check_association
...
*/
export class AwsProtectionHealthCheckAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsProtectionHealthCheckAssociationConfig) {
    super(scope, id, {
