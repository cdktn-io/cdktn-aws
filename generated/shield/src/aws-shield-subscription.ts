...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/shield_subscription
...
*/
export class AwsShieldSubscription extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsShieldSubscriptionConfig = {}) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      auto_renew: cdktn.stringToTerraform(this._autoRenew),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      auto_renew: {
        value: cdktn.stringToHclTerraform(this._autoRenew),
        isBlock: false,
        type: "simple",
