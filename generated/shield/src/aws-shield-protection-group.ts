...
export interface TfProtectionGroupConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfProtectionGroup extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfProtectionGroup resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfProtectionGroup to import
  * @param importFromId The id of the existing TfProtectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/shield_protection_group#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfProtectionGroup to import is found
  */
  ...
  * @param options TfProtectionGroupConfig
  */
  public constructor(scope: Construct, id: string, config: TfProtectionGroupConfig) {
    super(scope, id, {
