...
export interface AwsProtectionGroupConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsProtectionGroup extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsProtectionGroup resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsProtectionGroup to import
  * @param importFromId The id of the existing AwsProtectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/shield_protection_group#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsProtectionGroup to import is found
  */
  ...
  * @param options AwsProtectionGroupConfig
  */
  public constructor(scope: Construct, id: string, config: AwsProtectionGroupConfig) {
    super(scope, id, {
