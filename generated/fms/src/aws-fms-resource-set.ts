...
export interface AwsResourceSetConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly resourceSet?: AwsResourceSet.ResourceSetProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
...
export class AwsResourceSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsResourceSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/fms_resource_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _resourceSet = new AwsResourceSet.ResourceSetPropertyList(this, "resource_set", false);
  public get resourceSet() {
    return this._resourceSet;
  }
  public putResourceSet(value: AwsResourceSet.ResourceSetProperty[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      resource_set: cdktn.listMapper(awsResourceSetResourceSetPropertyToTerraform, true)(this._resourceSet.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      resource_set: {
        value: cdktn.listMapperHcl(awsResourceSetResourceSetPropertyToHclTerraform, true)(this._resourceSet.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsResourceSet.ResourceSetPropertyList",
      },
      timeouts: {
...
export function awsResourceSetResourceSetPropertyToTerraform(struct?: AwsResourceSet.ResourceSetProperty | cdktn.IResolvable): any {
...
export function awsResourceSetResourceSetPropertyToHclTerraform(struct?: AwsResourceSet.ResourceSetProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export interface TimeoutsProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/fms_resource_set#create AwsResourceSet#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/fms_resource_set#delete AwsResourceSet#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/fms_resource_set#update AwsResourceSet#update}
  */
