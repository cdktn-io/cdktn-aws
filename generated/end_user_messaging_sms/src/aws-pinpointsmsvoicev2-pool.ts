...
*/
export class AwsPinpointsmsvoicev2Pool extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsPinpointsmsvoicev2PoolConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsPinpointsmsvoicev2Pool.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsPinpointsmsvoicev2Pool.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsPinpointsmsvoicev2PoolTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsPinpointsmsvoicev2PoolTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsPinpointsmsvoicev2Pool.TimeoutsProperty",
      },
    };
...
export function awsPinpointsmsvoicev2PoolTimeoutsPropertyToTerraform(struct?: AwsPinpointsmsvoicev2Pool.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsPinpointsmsvoicev2PoolTimeoutsPropertyToHclTerraform(struct?: AwsPinpointsmsvoicev2Pool.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsPinpointsmsvoicev2Pool {
