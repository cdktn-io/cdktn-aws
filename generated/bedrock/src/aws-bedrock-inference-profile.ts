...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/bedrock_inference_profile
...
export class ModelSourcePropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ModelSourceProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ModelSourceProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ModelSourcePropertyList extends cdktn.ComplexList {
  public internalValue? : ModelSourceProperty[] | cdktn.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ModelSourcePropertyOutputReference {
    return new ModelSourcePropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
