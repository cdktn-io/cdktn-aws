...
export interface DataAwsApiGatewayAuthorizerConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsApiGatewayAuthorizer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApiGatewayAuthorizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_authorizer#import import section} in the documentation of this resource for the id to use
