...
*/
export class AwsApiGatewayRestApiPut extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsApiGatewayRestApiPutConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsApiGatewayRestApiPut.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsApiGatewayRestApiPut.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsApiGatewayRestApiPutTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsApiGatewayRestApiPutTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsApiGatewayRestApiPut.TimeoutsProperty",
      },
    };
...
export function awsApiGatewayRestApiPutTimeoutsPropertyToTerraform(struct?: AwsApiGatewayRestApiPut.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsApiGatewayRestApiPutTimeoutsPropertyToHclTerraform(struct?: AwsApiGatewayRestApiPut.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsApiGatewayRestApiPut {
