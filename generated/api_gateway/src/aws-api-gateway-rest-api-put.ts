...
export interface AwsRestApiPutConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: AwsRestApiPut.TimeoutsProperty;
}
...
*/
export class AwsRestApiPut extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsRestApiPut resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsRestApiPut to import
  * @param importFromId The id of the existing AwsRestApiPut that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/api_gateway_rest_api_put#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsRestApiPut to import is found
  */
  ...
  * @param options AwsRestApiPutConfig
  */
  public constructor(scope: Construct, id: string, config: AwsRestApiPutConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AwsRestApiPut.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsRestApiPut.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsRestApiPutTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsRestApiPutTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsRestApiPut.TimeoutsProperty",
      },
    };
...
export function awsRestApiPutTimeoutsPropertyToTerraform(struct?: AwsRestApiPut.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsRestApiPutTimeoutsPropertyToHclTerraform(struct?: AwsRestApiPut.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsRestApiPut {
export interface TimeoutsProperty {
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/api_gateway_rest_api_put#create AwsRestApiPut#create}
  */
