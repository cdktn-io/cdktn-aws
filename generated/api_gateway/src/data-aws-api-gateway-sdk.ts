...
export interface DataAwsSdkConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsSdk extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsSdk resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsSdk to import
  * @param importFromId The id of the existing DataAwsSdk that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_sdk#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsSdk to import is found
  */
  ...
  * @param options DataAwsSdkConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsSdkConfig) {
    super(scope, id, {
