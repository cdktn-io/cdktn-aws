...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_domain_name
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataAwsApiGatewayDomainNameConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsApiGatewayDomainName extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApiGatewayDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_domain_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _endpointConfiguration = new DataAwsApiGatewayDomainName.EndpointConfigurationPropertyList(this, "endpoint_configuration", false);
...
export function dataAwsApiGatewayDomainNameEndpointConfigurationPropertyToTerraform(struct?: DataAwsApiGatewayDomainName.EndpointConfigurationProperty): any {
...
export function dataAwsApiGatewayDomainNameEndpointConfigurationPropertyToHclTerraform(struct?: DataAwsApiGatewayDomainName.EndpointConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsApiGatewayDomainName {
