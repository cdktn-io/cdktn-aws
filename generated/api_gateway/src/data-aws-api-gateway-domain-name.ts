...
*/
export class DataAwsDomainName extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsDomainNameConfig) {
    super(scope, id, {
  ...
  private _endpointConfiguration = new DataAwsDomainName.EndpointConfigurationPropertyList(this, "endpoint_configuration", false);
...
export function dataAwsDomainNameEndpointConfigurationPropertyToTerraform(struct?: DataAwsDomainName.EndpointConfigurationProperty): any {
...
export function dataAwsDomainNameEndpointConfigurationPropertyToHclTerraform(struct?: DataAwsDomainName.EndpointConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsDomainName {
