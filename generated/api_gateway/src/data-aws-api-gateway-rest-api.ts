...
export interface DataAwsApiGatewayRestApiConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_rest_api#id DataAwsApiGatewayRestApi#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_rest_api#name DataAwsApiGatewayRestApi#name}
  */
  readonly name: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_rest_api#region DataAwsApiGatewayRestApi#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_rest_api#tags DataAwsApiGatewayRestApi#tags}
  */
...
export class DataAwsApiGatewayRestApi extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApiGatewayRestApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/api_gateway_rest_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _endpointConfiguration = new DataAwsApiGatewayRestApi.EndpointConfigurationPropertyList(this, "endpoint_configuration", false);
...
export function dataAwsApiGatewayRestApiEndpointConfigurationPropertyToTerraform(struct?: DataAwsApiGatewayRestApi.EndpointConfigurationProperty): any {
...
export function dataAwsApiGatewayRestApiEndpointConfigurationPropertyToHclTerraform(struct?: DataAwsApiGatewayRestApi.EndpointConfigurationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsApiGatewayRestApi {
