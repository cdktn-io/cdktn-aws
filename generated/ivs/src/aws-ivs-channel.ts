...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ivs_channel
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsIvsChannelConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class AwsIvsChannel extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsIvsChannel resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsIvsChannel to import
  * @param importFromId The id of the existing AwsIvsChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ivs_channel#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsIvsChannel to import is found
  */
  ...
  * @param options AwsIvsChannelConfig = {}
  */
  public constructor(scope: Construct, id: string, config: AwsIvsChannelConfig = {}) {
    super(scope, id, {
  ...
  private _timeouts = new AwsIvsChannel.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsIvsChannel.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: awsIvsChannelTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: awsIvsChannelTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsIvsChannel.TimeoutsProperty",
      },
    };
...
export function awsIvsChannelTimeoutsPropertyToTerraform(struct?: AwsIvsChannel.TimeoutsProperty | cdktn.IResolvable): any {
...
export function awsIvsChannelTimeoutsPropertyToHclTerraform(struct?: AwsIvsChannel.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsIvsChannel {
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ivs_channel#create AwsIvsChannel#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ivs_channel#delete AwsIvsChannel#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/ivs_channel#update AwsIvsChannel#update}
  */
