...
export class DataAwsServicecatalogappregistryAttributeGroupAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsServicecatalogappregistryAttributeGroupAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/servicecatalogappregistry_attribute_group_associations#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsServicecatalogappregistryAttributeGroupAssociationsConfig = {}) {
    super(scope, id, {
