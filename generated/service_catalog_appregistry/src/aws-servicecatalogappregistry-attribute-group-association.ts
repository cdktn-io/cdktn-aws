...
*/
export class AwsAttributeGroupAssociation extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsAttributeGroupAssociationConfig) {
    super(scope, id, {
