...
export interface AwsServicecatalogappregistryAttributeGroupAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsServicecatalogappregistryAttributeGroupAssociation extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsServicecatalogappregistryAttributeGroupAssociation resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsServicecatalogappregistryAttributeGroupAssociation to import
  * @param importFromId The id of the existing AwsServicecatalogappregistryAttributeGroupAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/servicecatalogappregistry_attribute_group_association#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsServicecatalogappregistryAttributeGroupAssociation to import is found
  */
  ...
  * @param options AwsServicecatalogappregistryAttributeGroupAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsServicecatalogappregistryAttributeGroupAssociationConfig) {
    super(scope, id, {
