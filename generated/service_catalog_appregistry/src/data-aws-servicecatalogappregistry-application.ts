...
export class DataAwsServicecatalogappregistryApplication extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsServicecatalogappregistryApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/servicecatalogappregistry_application#import import section} in the documentation of this resource for the id to use
