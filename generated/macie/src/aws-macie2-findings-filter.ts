...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/macie2_findings_filter
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsMacie2FindingsFilterConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly findingCriteria: AwsMacie2FindingsFilter.FindingCriteriaProperty;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: AwsMacie2FindingsFilter.TimeoutsProperty;
}
...
*/
export class AwsMacie2FindingsFilter extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsMacie2FindingsFilter resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsMacie2FindingsFilter to import
  * @param importFromId The id of the existing AwsMacie2FindingsFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/macie2_findings_filter#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsMacie2FindingsFilter to import is found
  */
  ...
  * @param options AwsMacie2FindingsFilterConfig
  */
  public constructor(scope: Construct, id: string, config: AwsMacie2FindingsFilterConfig) {
    super(scope, id, {
  ...
  private _findingCriteria = new AwsMacie2FindingsFilter.FindingCriteriaPropertyOutputReference(this, "finding_criteria");
  public get findingCriteria() {
    return this._findingCriteria;
  }
  public putFindingCriteria(value: AwsMacie2FindingsFilter.FindingCriteriaProperty) {
  ...
  private _timeouts = new AwsMacie2FindingsFilter.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AwsMacie2FindingsFilter.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      finding_criteria: awsMacie2FindingsFilterFindingCriteriaPropertyToTerraform(this._findingCriteria.internalValue),
      timeouts: awsMacie2FindingsFilterTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      finding_criteria: {
        value: awsMacie2FindingsFilterFindingCriteriaPropertyToHclTerraform(this._findingCriteria.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsMacie2FindingsFilter.FindingCriteriaPropertyList",
      },
      timeouts: {
        value: awsMacie2FindingsFilterTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AwsMacie2FindingsFilter.TimeoutsProperty",
      },
    };
...
export function awsMacie2FindingsFilterCriterionPropertyToTerraform(struct?: AwsMacie2FindingsFilter.CriterionProperty | cdktn.IResolvable): any {
...
export function awsMacie2FindingsFilterCriterionPropertyToHclTerraform(struct?: AwsMacie2FindingsFilter.CriterionProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsMacie2FindingsFilterFindingCriteriaPropertyToTerraform(struct?: AwsMacie2FindingsFilter.FindingCriteriaPropertyOutputReference | AwsMacie2FindingsFilter.FindingCriteriaProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    criterion: cdktn.listMapper(awsMacie2FindingsFilterCriterionPropertyToTerraform, true)(struct!.criterion),
  }
}


export function awsMacie2FindingsFilterFindingCriteriaPropertyToHclTerraform(struct?: AwsMacie2FindingsFilter.FindingCriteriaPropertyOutputReference | AwsMacie2FindingsFilter.FindingCriteriaProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    criterion: {
      value: cdktn.listMapperHcl(awsMacie2FindingsFilterCriterionPropertyToHclTerraform, true)(struct!.criterion),
      isBlock: true,
      type: "set",
...
export function awsMacie2FindingsFilterTimeoutsPropertyToTerraform(struct?: AwsMacie2FindingsFilter.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function awsMacie2FindingsFilterTimeoutsPropertyToHclTerraform(struct?: AwsMacie2FindingsFilter.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsMacie2FindingsFilter {
...
export class CriterionPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CriterionProperty | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: CriterionProperty | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class CriterionPropertyList extends cdktn.ComplexList {
  public internalValue? : CriterionProperty[] | cdktn.IResolvable
  ...
  */
  public get(index: number): CriterionPropertyOutputReference {
    return new CriterionPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface FindingCriteriaProperty {
  ...
  * criterion block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/macie2_findings_filter#criterion AwsMacie2FindingsFilter#criterion}
  */
...
export class FindingCriteriaPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FindingCriteriaProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: FindingCriteriaProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _criterion = new CriterionPropertyList(this, "criterion", true);
  public get criterion() {
    return this._criterion;
  }
  public putCriterion(value: CriterionProperty[] | cdktn.IResolvable) {
...
export interface TimeoutsProperty {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/macie2_findings_filter#create AwsMacie2FindingsFilter#create}
  */
