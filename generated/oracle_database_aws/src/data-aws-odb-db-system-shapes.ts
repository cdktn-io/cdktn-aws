...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_system_shapes
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataAwsDbSystemShapesConfig extends cdktn.TerraformMetaArguments {
  /**
  * The physical ID of the AZ, for example, use1-az4. This ID persists across accounts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_system_shapes#availability_zone_id DataAwsDbSystemShapes#availability_zone_id}
  */
  readonly availabilityZoneId?: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_system_shapes#region DataAwsDbSystemShapes#region}
  */
...
*/
export class DataAwsDbSystemShapes extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsDbSystemShapes resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsDbSystemShapes to import
  * @param importFromId The id of the existing DataAwsDbSystemShapes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_system_shapes#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsDbSystemShapes to import is found
  */
  ...
  * @param options DataAwsDbSystemShapesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAwsDbSystemShapesConfig = {}) {
    super(scope, id, {
  ...
  private _dbSystemShapes = new DataAwsDbSystemShapes.DbSystemShapesPropertyList(this, "db_system_shapes", false);
...
export function dataAwsDbSystemShapesDbSystemShapesPropertyToTerraform(struct?: DataAwsDbSystemShapes.DbSystemShapesProperty): any {
...
export function dataAwsDbSystemShapesDbSystemShapesPropertyToHclTerraform(struct?: DataAwsDbSystemShapes.DbSystemShapesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsDbSystemShapes {
...
export class DbSystemShapesPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DbSystemShapesProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DbSystemShapesProperty | undefined) {
    if (value === undefined) {
...
export class DbSystemShapesPropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DbSystemShapesPropertyOutputReference {
    return new DbSystemShapesPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
