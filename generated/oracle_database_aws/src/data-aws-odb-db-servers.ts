...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_servers
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataAwsDbServersConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsDbServers extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAwsDbServers resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAwsDbServers to import
  * @param importFromId The id of the existing DataAwsDbServers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_servers#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsDbServers to import is found
  */
  ...
  * @param options DataAwsDbServersConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsDbServersConfig) {
    super(scope, id, {
  ...
  private _dbServers = new DataAwsDbServers.DbServersPropertyList(this, "db_servers", false);
...
export function dataAwsDbServersDbServerPatchingDetailsPropertyToTerraform(struct?: DataAwsDbServers.DbServerPatchingDetailsProperty): any {
...
export function dataAwsDbServersDbServerPatchingDetailsPropertyToHclTerraform(struct?: DataAwsDbServers.DbServerPatchingDetailsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsDbServersDbServersPropertyToTerraform(struct?: DataAwsDbServers.DbServersProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsDbServersDbServersPropertyToHclTerraform(struct?: DataAwsDbServers.DbServersProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsDbServers {
...
export class DbServerPatchingDetailsPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DbServerPatchingDetailsProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DbServerPatchingDetailsProperty | undefined) {
    if (value === undefined) {
...
export class DbServerPatchingDetailsPropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DbServerPatchingDetailsPropertyOutputReference {
    return new DbServerPatchingDetailsPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DbServersProperty {
}
export class DbServersPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DbServersProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DbServersProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _dbServerPatchingDetails = new DbServerPatchingDetailsPropertyList(this, "db_server_patching_details", false);
...
export class DbServersPropertyList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DbServersPropertyOutputReference {
    return new DbServersPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
