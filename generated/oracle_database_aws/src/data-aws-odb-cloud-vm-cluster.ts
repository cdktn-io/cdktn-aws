...
export interface TfDataCloudVmClusterConfig extends cdktn.TerraformMetaArguments {
  /**
  * The unique identifier of the VM cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_cloud_vm_cluster#id TfDataCloudVmCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_cloud_vm_cluster#region TfDataCloudVmCluster#region}
  */
...
*/
export class TfDataCloudVmCluster extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataCloudVmCluster resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataCloudVmCluster to import
  * @param importFromId The id of the existing TfDataCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataCloudVmCluster to import is found
  */
  ...
  * @param options TfDataCloudVmClusterConfig
  */
  public constructor(scope: Construct, id: string, config: TfDataCloudVmClusterConfig) {
    super(scope, id, {
  ...
  private _dataCollectionOptions = new TfDataCloudVmCluster.DataCollectionOptionsPropertyList(this, "data_collection_options", false);
  ...
  private _iormConfigCache = new TfDataCloudVmCluster.IormConfigCachePropertyList(this, "iorm_config_cache", false);
...
export function tfDataCloudVmClusterDataCollectionOptionsPropertyToTerraform(struct?: TfDataCloudVmCluster.DataCollectionOptionsProperty): any {
...
export function tfDataCloudVmClusterDataCollectionOptionsPropertyToHclTerraform(struct?: TfDataCloudVmCluster.DataCollectionOptionsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataCloudVmClusterDbPlansPropertyToTerraform(struct?: TfDataCloudVmCluster.DbPlansProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataCloudVmClusterDbPlansPropertyToHclTerraform(struct?: TfDataCloudVmCluster.DbPlansProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataCloudVmClusterIormConfigCachePropertyToTerraform(struct?: TfDataCloudVmCluster.IormConfigCacheProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function tfDataCloudVmClusterIormConfigCachePropertyToHclTerraform(struct?: TfDataCloudVmCluster.IormConfigCacheProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfDataCloudVmCluster {
