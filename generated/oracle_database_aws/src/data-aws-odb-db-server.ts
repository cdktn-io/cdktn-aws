...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_server
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface TfDataDbServerConfig extends cdktn.TerraformMetaArguments {
  /**
  * The identifier of the database server to retrieve information about.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_server#cloud_exadata_infrastructure_id TfDataDbServer#cloud_exadata_infrastructure_id}
  */
  readonly cloudExadataInfrastructureId: string;
  /**
  * The identifier of the the database server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_server#id TfDataDbServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_server#region TfDataDbServer#region}
  */
...
*/
export class TfDataDbServer extends cdktn.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aws_odb_db_server";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTN code for importing a TfDataDbServer resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfDataDbServer to import
  * @param importFromId The id of the existing TfDataDbServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_db_server#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfDataDbServer to import is found
  */
  ...
  * @param options TfDataDbServerConfig
  */
  public constructor(scope: Construct, id: string, config: TfDataDbServerConfig) {
    super(scope, id, {
  ...
  private _dbServerPatchingDetails = new TfDataDbServer.DbServerPatchingDetailsPropertyList(this, "db_server_patching_details", false);
...
export function tfDataDbServerDbServerPatchingDetailsPropertyToTerraform(struct?: TfDataDbServer.DbServerPatchingDetailsProperty): any {
...
export function tfDataDbServerDbServerPatchingDetailsPropertyToHclTerraform(struct?: TfDataDbServer.DbServerPatchingDetailsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace TfDataDbServer {
