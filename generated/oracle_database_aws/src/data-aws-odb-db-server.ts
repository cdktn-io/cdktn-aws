...
*/
export class DataAwsDbServer extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsDbServerConfig) {
    super(scope, id, {
  ...
  private _dbServerPatchingDetails = new DataAwsDbServer.DbServerPatchingDetailsPropertyList(this, "db_server_patching_details", false);
...
export function dataAwsDbServerDbServerPatchingDetailsPropertyToTerraform(struct?: DataAwsDbServer.DbServerPatchingDetailsProperty): any {
...
export function dataAwsDbServerDbServerPatchingDetailsPropertyToHclTerraform(struct?: DataAwsDbServer.DbServerPatchingDetailsProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsDbServer {
