...
export interface DataTfNetworksConfig extends cdktn.TerraformMetaArguments {
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_networks#region DataTfNetworks#region}
  */
...
*/
export class DataTfNetworks extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataTfNetworks resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataTfNetworks to import
  * @param importFromId The id of the existing DataTfNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/odb_networks#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataTfNetworks to import is found
  */
  ...
  * @param options DataTfNetworksConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataTfNetworksConfig = {}) {
    super(scope, id, {
  ...
  private _odbNetworks = new DataTfNetworks.OdbNetworksPropertyList(this, "odb_networks", false);
...
export function dataTfNetworksOdbNetworksPropertyToTerraform(struct?: DataTfNetworks.OdbNetworksProperty): any {
...
export function dataTfNetworksOdbNetworksPropertyToHclTerraform(struct?: DataTfNetworks.OdbNetworksProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataTfNetworks {
