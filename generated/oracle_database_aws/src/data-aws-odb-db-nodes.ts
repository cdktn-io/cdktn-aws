...
*/
export class DataAwsDbNodes extends cdktn.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAwsDbNodesConfig) {
    super(scope, id, {
  ...
  private _dbNodes = new DataAwsDbNodes.DbNodesPropertyList(this, "db_nodes", false);
  public get dbNodes() {
...
export function dataAwsDbNodesDbNodesPropertyToTerraform(struct?: DataAwsDbNodes.DbNodesProperty): any {
...
export function dataAwsDbNodesDbNodesPropertyToHclTerraform(struct?: DataAwsDbNodes.DbNodesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsDbNodes {
...
export class DbNodesPropertyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DbNodesProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DbNodesProperty | undefined) {
    if (value === undefined) {
...
export class DbNodesPropertyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DbNodesPropertyOutputReference {
    return new DbNodesPropertyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
}
