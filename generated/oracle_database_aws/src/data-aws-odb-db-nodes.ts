...
export class DataAwsOdbDbNodes extends cdktn.TerraformDataSource {
  ...
  */
  ...
  private _dbNodes = new DataAwsOdbDbNodes.DbNodesPropertyList(this, "db_nodes", false);
  public get dbNodes() {
...
export function dataAwsOdbDbNodesDbNodesPropertyToTerraform(struct?: DataAwsOdbDbNodes.DbNodesProperty): any {
...
export function dataAwsOdbDbNodesDbNodesPropertyToHclTerraform(struct?: DataAwsOdbDbNodes.DbNodesProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsOdbDbNodes {
