...
export interface DataAwsSagemakerPrebuiltEcrImageConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataAwsSagemakerPrebuiltEcrImage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSagemakerPrebuiltEcrImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/sagemaker_prebuilt_ecr_image#import import section} in the documentation of this resource for the id to use
