...
export interface AwsMlflowTrackingServerConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#artifact_store_uri AwsMlflowTrackingServer#artifact_store_uri}
  */
  readonly artifactStoreUri: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#automatic_model_registration AwsMlflowTrackingServer#automatic_model_registration}
  */
  readonly automaticModelRegistration?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#id AwsMlflowTrackingServer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#mlflow_version AwsMlflowTrackingServer#mlflow_version}
  */
  readonly mlflowVersion?: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#region AwsMlflowTrackingServer#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#role_arn AwsMlflowTrackingServer#role_arn}
  */
  readonly roleArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#tags AwsMlflowTrackingServer#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#tags_all AwsMlflowTrackingServer#tags_all}
  */
  readonly tagsAll?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#tracking_server_name AwsMlflowTrackingServer#tracking_server_name}
  */
  readonly trackingServerName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#tracking_server_size AwsMlflowTrackingServer#tracking_server_size}
  */
  readonly trackingServerSize?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#weekly_maintenance_window_start AwsMlflowTrackingServer#weekly_maintenance_window_start}
  */
...
*/
export class AwsMlflowTrackingServer extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsMlflowTrackingServer resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsMlflowTrackingServer to import
  * @param importFromId The id of the existing AwsMlflowTrackingServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sagemaker_mlflow_tracking_server#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsMlflowTrackingServer to import is found
  */
  ...
  * @param options AwsMlflowTrackingServerConfig
  */
  public constructor(scope: Construct, id: string, config: AwsMlflowTrackingServerConfig) {
    super(scope, id, {
