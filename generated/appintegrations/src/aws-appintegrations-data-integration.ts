...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appintegrations_data_integration
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface AwsDataIntegrationConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly scheduleConfig: AwsDataIntegration.ScheduleConfigProperty;
}
...
*/
export class AwsDataIntegration extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsDataIntegration resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsDataIntegration to import
  * @param importFromId The id of the existing AwsDataIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appintegrations_data_integration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsDataIntegration to import is found
  */
  ...
  * @param options AwsDataIntegrationConfig
  */
  public constructor(scope: Construct, id: string, config: AwsDataIntegrationConfig) {
    super(scope, id, {
  ...
  private _scheduleConfig = new AwsDataIntegration.ScheduleConfigPropertyOutputReference(this, "schedule_config");
  public get scheduleConfig() {
    return this._scheduleConfig;
  }
  public putScheduleConfig(value: AwsDataIntegration.ScheduleConfigProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      schedule_config: awsDataIntegrationScheduleConfigPropertyToTerraform(this._scheduleConfig.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      schedule_config: {
        value: awsDataIntegrationScheduleConfigPropertyToHclTerraform(this._scheduleConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsDataIntegration.ScheduleConfigPropertyList",
      },
    };
...
export function awsDataIntegrationScheduleConfigPropertyToTerraform(struct?: AwsDataIntegration.ScheduleConfigPropertyOutputReference | AwsDataIntegration.ScheduleConfigProperty): any {
...
export function awsDataIntegrationScheduleConfigPropertyToHclTerraform(struct?: AwsDataIntegration.ScheduleConfigPropertyOutputReference | AwsDataIntegration.ScheduleConfigProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsDataIntegration {
