...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/gamelift_build
...
*/
export class AwsGameliftBuild extends cdktn.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: AwsGameliftBuildConfig) {
    super(scope, id, {
  ...
  private _storageLocation = new AwsGameliftBuild.StorageLocationPropertyOutputReference(this, "storage_location");
  public get storageLocation() {
    return this._storageLocation;
  }
  public putStorageLocation(value: AwsGameliftBuild.StorageLocationProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      storage_location: awsGameliftBuildStorageLocationPropertyToTerraform(this._storageLocation.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      storage_location: {
        value: awsGameliftBuildStorageLocationPropertyToHclTerraform(this._storageLocation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AwsGameliftBuild.StorageLocationPropertyList",
      },
    };
...
export function awsGameliftBuildStorageLocationPropertyToTerraform(struct?: AwsGameliftBuild.StorageLocationPropertyOutputReference | AwsGameliftBuild.StorageLocationProperty): any {
...
export function awsGameliftBuildStorageLocationPropertyToHclTerraform(struct?: AwsGameliftBuild.StorageLocationPropertyOutputReference | AwsGameliftBuild.StorageLocationProperty): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace AwsGameliftBuild {
