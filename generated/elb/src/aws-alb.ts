...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/alb
...
export class AwsAlb extends cdktn.TerraformResource {
  ...
  */
  ...
  public set secondaryIpsAutoAssignedPerSubnet(value: number) {
    this._secondaryIpsAutoAssignedPerSubnet = value;
  }
  public resetSecondaryIpsAutoAssignedPerSubnet() {
    this._secondaryIpsAutoAssignedPerSubnet = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get secondaryIpsAutoAssignedPerSubnetInput() {
  ...
  public resetHealthCheckLogs() {
    this._healthCheckLogs.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get healthCheckLogsInput() {
    return this._healthCheckLogs.internalValue;
  }
  ...
  public resetIpamPools() {
    this._ipamPools.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ipamPoolsInput() {
    return this._ipamPools.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      enable_prefix_for_ipv6_source_nat: cdktn.stringToTerraform(this._enablePrefixForIpv6SourceNat),
...
export class MinimumLoadBalancerCapacityPropertyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): MinimumLoadBalancerCapacityProperty | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: MinimumLoadBalancerCapacityProperty | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
