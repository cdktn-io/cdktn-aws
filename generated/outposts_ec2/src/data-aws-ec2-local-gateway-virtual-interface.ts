...
export interface DataAwsEc2LocalGatewayVirtualInterfaceConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly filter?: DataAwsEc2LocalGatewayVirtualInterface.FilterProperty[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: DataAwsEc2LocalGatewayVirtualInterface.TimeoutsProperty;
}
...
*/
export class DataAwsEc2LocalGatewayVirtualInterface extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2LocalGatewayVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/ec2_local_gateway_virtual_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _filter = new DataAwsEc2LocalGatewayVirtualInterface.FilterPropertyList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataAwsEc2LocalGatewayVirtualInterface.FilterProperty[] | cdktn.IResolvable) {
  ...
  private _timeouts = new DataAwsEc2LocalGatewayVirtualInterface.TimeoutsPropertyOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAwsEc2LocalGatewayVirtualInterface.TimeoutsProperty) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktn.listMapper(dataAwsEc2LocalGatewayVirtualInterfaceFilterPropertyToTerraform, true)(this._filter.internalValue),
      timeouts: dataAwsEc2LocalGatewayVirtualInterfaceTimeoutsPropertyToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktn.listMapperHcl(dataAwsEc2LocalGatewayVirtualInterfaceFilterPropertyToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataAwsEc2LocalGatewayVirtualInterface.FilterPropertyList",
      },
      timeouts: {
        value: dataAwsEc2LocalGatewayVirtualInterfaceTimeoutsPropertyToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAwsEc2LocalGatewayVirtualInterface.TimeoutsProperty",
      },
    };
...
export function dataAwsEc2LocalGatewayVirtualInterfaceFilterPropertyToTerraform(struct?: DataAwsEc2LocalGatewayVirtualInterface.FilterProperty | cdktn.IResolvable): any {
...
export function dataAwsEc2LocalGatewayVirtualInterfaceFilterPropertyToHclTerraform(struct?: DataAwsEc2LocalGatewayVirtualInterface.FilterProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEc2LocalGatewayVirtualInterfaceTimeoutsPropertyToTerraform(struct?: DataAwsEc2LocalGatewayVirtualInterface.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEc2LocalGatewayVirtualInterfaceTimeoutsPropertyToHclTerraform(struct?: DataAwsEc2LocalGatewayVirtualInterface.TimeoutsProperty | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export namespace DataAwsEc2LocalGatewayVirtualInterface {
