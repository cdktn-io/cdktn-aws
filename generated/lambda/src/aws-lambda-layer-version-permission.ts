...
export interface AwsLambdaLayerVersionPermissionConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class AwsLambdaLayerVersionPermission extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AwsLambdaLayerVersionPermission resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AwsLambdaLayerVersionPermission to import
  * @param importFromId The id of the existing AwsLambdaLayerVersionPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lambda_layer_version_permission#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AwsLambdaLayerVersionPermission to import is found
  */
  ...
  * @param options AwsLambdaLayerVersionPermissionConfig
  */
  public constructor(scope: Construct, id: string, config: AwsLambdaLayerVersionPermissionConfig) {
    super(scope, id, {
