...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/lambda_runtime_management_config
...
*/
export class AwsLambdaRuntimeManagementConfig extends cdktn.TerraformResource {
    ...
    */
    public constructor(scope: Construct, id: string, config: AwsLambdaRuntimeManagementConfigConfig) {
        super(scope, id, {
    ...
    protected synthesizeAttributes(): { [name: string]: any } {
        return {
            ...
            runtime_version_arn: cdktn.stringToTerraform(this._runtimeVersionArn),
            update_runtime_on: cdktn.stringToTerraform(this._updateRuntimeOn),
        };
    }
    ...
    protected synthesizeHclAttributes(): { [name: string]: any } {
        const attrs = {
            ...
            runtime_version_arn: {
                value: cdktn.stringToHclTerraform(this._runtimeVersionArn),
                isBlock: false,
                type: "simple",
                storageClassType: "string",
            },
            update_runtime_on: {
                value: cdktn.stringToHclTerraform(this._updateRuntimeOn),
                isBlock: false,
                type: "simple",
                storageClassType: "string",
            },
