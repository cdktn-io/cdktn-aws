...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/lambda_layer_version
// generated from terraform resource schema — do not edit by hand

import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataTfLayerVersionConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataTfLayerVersion extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataTfLayerVersion resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataTfLayerVersion to import
  * @param importFromId The id of the existing DataTfLayerVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/lambda_layer_version#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataTfLayerVersion to import is found
  */
  ...
  * @param options DataTfLayerVersionConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataTfLayerVersionConfig = {}) {
    super(scope, id, {
