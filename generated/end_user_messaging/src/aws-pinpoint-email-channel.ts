...
export interface TfEmailChannelConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TfEmailChannel extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a TfEmailChannel resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TfEmailChannel to import
  * @param importFromId The id of the existing TfEmailChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/pinpoint_email_channel#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TfEmailChannel to import is found
  */
  ...
  * @param options TfEmailChannelConfig
  */
  public constructor(scope: Construct, id: string, config: TfEmailChannelConfig) {
    super(scope, id, {
