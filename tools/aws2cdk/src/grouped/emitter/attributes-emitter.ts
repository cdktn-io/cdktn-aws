...
// Adapted from src/vendored/cdktn/emitter/attributes-emitter.ts — see tools/aws2cdk/README.md.
...
// custom-defaults.ts (a static `aws.*`-keyed map with nothing to adapt — awscc never matches it).
...
import { CUSTOM_DEFAULTS } from "../../vendored/cdktn/custom-defaults";
